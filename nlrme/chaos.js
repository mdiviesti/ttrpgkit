var chaos = ["1d10 of caster's fingers turn to stone",
    ...
    "1d100% of caster's body turns to iron for that many rounds", "1d12 ducklings identify the caster as their mother",
    "1d4 of caster's fingers move from his left hand to his right hand",
    "1d4 of caster's limbs are as durable as steel", "1d4 of caster's limbs are covered in fish scales",
    "1d4 of caster's limbs are invisible", "1d8 of caster's primary orifices seal shut",
    "3d10 harmless lumps as big as walnuts cover the caster's body", "3d10 quarts of olive oil pour from caster's ears",
    ...
    "A large haystack falls from the sky onto caster", "A large oak sprouts from one of the caster's pockets",
    ...
    "A skeleton mimics caster, exactly duplicating his movements", "A small fountain wells up in the caster's home",
    ...
    "After each spell, caster appears to be decomposing", "After each spell, caster appears to be made of pure ice",
    "After each spell, caster appears to be utterly insane", "After each spell, caster applauds himself",
    ...
    "After each spell, caster dances like a honeybee", "After each spell, caster experiences a burning sensation",
    ...
    "After each spell, caster feels distractingly hungry", "After each spell, caster feels overwhelmingly dizzy",
    "After each spell, caster feels transcendent euphoria",
    "After each spell, caster forgets everyone's name for one hour",
    "After each spell, caster forgets his name for one hour", "After each spell, caster glows with infernal radiance",
    ...
    "After each spell, caster is 60% likely to flap his arms", "After each spell, caster is afraid of his own name",
    ...
    "After each spell, caster is matte black for 1d4 rounds", "After each spell, caster is suddenly facing True North",
    ...
    "After each spell, caster polymorphs very briefly", "After each spell, caster reeks of alcohol for 2d6 rounds",
    "After each spell, caster salivates copiously", "After each spell, caster seems withdrawn and despondent",
    ...
    "After each spell, caster shrinks by 10d10% for 1d4 rounds", "After each spell, caster shrinks by 50%",
    "After each spell, caster smells strongly of turpentine",
    "After each spell, caster suffers brief visions of carnage",
    "After each spell, caster suffers disorienting vertigo", "After each spell, caster thinks that he's drowning",
    "After each spell, caster thinks that his clothes are on fire",
    "After each spell, caster trumpets like an elephant", "After each spell, caster vanishes very briefly vanishes",
    "After each spell, caster's clothes age 1d100 years ", "After each spell, caster's clothes billow with green smoke",
    "After each spell, caster's eyes briefly double in size", "After each spell, caster's face looks 50 years older",
    "After each spell, caster's feet are covered with ash", "After each spell, caster's hair grows two inches",
    "After each spell, caster's hands display classic stigmata", "After each spell, caster's hands steam wildly",
    "After each spell, caster's head turns 360° at the neck, unharmed",
    "After each spell, caster's head turns invisible for 1d4 rounds", "After each spell, caster's heart pounds audibly",
    ...
    "After each spell, gravity briefly doubles for the caster", "After each spell, he giggles for 1d4-1 rounds",
    ...
    "All holy symbols within 100 yards bear the caster's image", "All of caster's clothing is colored safety orange",
    "All of caster's clothing is permanently moist", "All of caster's enemies with 100 yards vanish until dawn",
    "All of caster's fingers are as long as his middle finger", "All of caster's fingers are clear like glass",
    "All of caster's fingers double in thickness", "All of caster's fingers migrate to one hand",
    "All of caster's monetary wealth appears atop the nearest mountain",
    "All of caster's monetary wealth is revealed to be counterfeit", "All of caster's possessions age 1d1000 years",
    ...
    "Any coins in caster's possession are gold-plated", "Any coins in caster's possession become copper pieces",
    ...
    "Any creature Summoned by caster emerges from his mouth", "Any creatures Summoned near caster are invisible to him",
    ...
    "Any fires set by caster make those near it appear to be undead", "Any fires set by caster produce no heat",
    "Any fires set by caster produce no smoke", "Any fires set by caster whisper vague threats against him",
    "Any food now carried by caster combusts", "Any food now carried by caster is 10X as nutritious",
    "Any food now carried by caster is fused into glass",
    "Any food now carried by caster is sealed in airtight tin cans",
    "Any food now carried by caster is toxic to Dwarves", "Any food now carried by caster smells like carrion",
    "Any food now carried by caster turns to ice", "Any food now carried by caster turns to iron",
    ...
    "Any magical scrolls now carried by caster turn to steel", "Any metal object carried by caster is 90% transparent",
    ...
    "Anyone related to caster by blood is invisible to him", "Anyone slain by caster becomes invisible upon death",
    ...
    "Before each spell, caster must bark like a dog for 2d6 seconds", "Before each spell, caster must bite a gold coin",
    ...
    "Before each spell, caster must claim to be invincible", "Before each spell, caster must clear his throat loudly",
    "Before each spell, caster must confess an embarrassing secret",
    "Before each spell, caster must confess that he's a charlatan", "Before each spell, caster must crack his knuckles",
    ...
    "Before each spell, caster must ingest a pinch of dust", "Before each spell, caster must insult a close friend",
    ...
    "Before each spell, caster must touch liquid water", "Before each spell, caster must trace a circle in the air",
    ...
    "Caster accidentally creates a virulent plague in his workshop", "Caster accuses his nearest ally of murdering him",
    ...
    "Caster addresses everyone he knows by his own name", "Caster adopts a habit of nightly self-flagellation",
    "Caster adopts a universally obscene gesture as his trademark",
    "Caster adopts bizarre rituals concerning the preparation of food", "Caster adopts fastidious standards of hygiene",
    ...
    "Caster ages one year per mile that he travels away from this spot", "Caster always appears healthy and wealthy",
    "Caster always appears sickly and destitute", "Caster always feels as if the temperature is what it is right now",
    ...
    "Caster ate two or three pounds of apple seeds this morning", "Caster attempts to drink every potion he sees",
    "Caster attracts undead in any town he enters", "Caster attracts zealous sycophants wherever he goes",
    ...
    "Caster bears the birthmark of the lineage of powerful kings", "Caster becomes disturbingly frenetic until sunset",
    ...
    "Caster becomes lost if he enters a cave by himself", "Caster becomes lost if he enters a forest by himself",
    "Caster becomes powerfully addicted to necromantic magic", "Caster becomes powerfully addicted to Chaos Bursts",
    "Caster becomes tightly stuck to the next chair in which he sits",
    "Caster becomes unconscious when he becomes invisible", "Caster becomes violently ill if he eats near a fire",
    "Caster becomes visibly anxious at the sight of holy water", "Caster begins aging backwards, one year per round",
    "Caster begins growing one inch per week", "Caster begins his conversations with an insulting comment",
    ...
    "Caster can always sense his location relative to this location", "Caster can appear to be 50% fatter at will",
    "Caster can appraise gems by tasting them", "Caster can ask three questions of the next tree he touches",
    ...
    "Caster can be injured but not killed by any male creature", "Caster can be injured by fire, but it can't kill him",
    ...
    "Caster can cause one creature near him to turn to iron", "Caster can cause one nearby person to age 1d10 years",
    "Caster can change the size of his ears at will", "Caster can conjure apples out of thin air, one at a time",
    "Caster can control any undead skeletons now within 100 yards", "Caster can detach either of his hands at will",
    "Caster can detach his head easily but dies if he does so", "Caster can detect non-magical fire within 500 yards",
    "Caster can detect the nearest potable water at will",
    "Caster can detect the presence of elementals within 100 yards", "Caster can detect True East at will",
    "Caster can discern a person's age by touching him", "Caster can discern a tree's age by touching it",
    "Caster can discern whether people are really unconscious",
    "Caster can discern which spells a magic user has memorized", "Caster can disgorge a pound of sawdust once per day",
    "Caster can double his spells' range if he's carrying no metal",
    "Caster can double his weight for up to 1d4 rounds per day",
    "Caster can drink only from a golden bowl worth 100 gold pieces", "Caster can easily walk on ice while barefoot",
    ...
    "Caster can hurl a baseball-sized object beyond the horizon", "Caster can identify any kind of fungus on sight",
    "Caster can ignite twigs by sticking them in his mouth",
    "Caster can ignore any spell cast on him but is 80% likely to die", "Caster can induce ravenous hunger in others",
    ...
    "Caster can magically create edible but non-nourishing food", "Caster can make his ears resemble noses at will",
    ...
    "Caster can never again come within one mile of his home", "Caster can no longer use charged magic items",
    "Caster can only digest food that is spoiled or rotting",
    "Caster can only use electrical magic while standing in water", "Caster can only wear one shoe at a time",
    "Caster can open his mouth as wide as he is tall", "Caster can pass his right arm through up to six inches of wood",
    "Caster can reattach his own limbs if they're severed", "Caster can recall his own birth with perfect clarity",
    "Caster can remove his tongue and replace it at will", "Caster can remove one eye and replace it at will",
    "Caster can remove or negate one curse", "Caster can resemble a decaying zombie at will",
    "Caster can retract his feet into his ankles at will", "Caster can retract his fingers into his palms at will",
    "Caster can retract his nose into his face at will", "Caster can scale walls like a monkey while unencumbered",
    "Caster can see in total darkness if he has a banana in his pocket",
    "Caster can see secret doors easily but can't see normal doors", "Caster can see through fire",
    ...
    "Caster can seen in total darkness for 1d4 days", "Caster can sense intelligent weapons within 10 yards",
    "Caster can sense people who've been affected by Chaos Bursts",
    "Caster can speak but can't engage in actual conversations",
    "Caster can speak in a whisper to anyone in his line of sight", "Caster can speak in any of 2d4 voices at will",
    ...
    "Caster can Summon but not control a powerful, malevolent entity", "Caster can Summon up to 1d10 pigeons per month",
    "Caster can survive at the bottom of the sea for 1d4 minutes",
    "Caster can survive in the depths of space, if he can get there",
    "Caster can survive one fall of up to twenty miles", "Caster can taste foods simply by touching them",
    ...
    "Caster can teleport into the nearest hollow tree, once", "Caster can teleport up to fifty feet once per day",
    ...
    "Caster can turn 360° at the waist without harm", "Caster can turn ethereal at will but can't revert for 3d8 days",
    "Caster can turn his arms to wood for up to 1d6 rounds per day", "Caster can turn his bones invisible at will",
    ...
    "Caster can turn invisible while he holds his breath", "Caster can turn invisible while naked and motionless",
    ...
    "Caster can't attack anyone more than 20 feet away from him", "Caster can't be beheaded",
    "Caster can't be blinded or dazzled by sunlight", "Caster can't be burned by magical fire for 1d4 hours",
    "Caster can't be burned by steam or scalding water", "Caster can't be Charmed by anyone of the opposite sex",
    "Caster can't be crushed by any weight of stone", "Caster can't be cut by any blade until he casts his next spell",
    "Caster can't be cut by glass", "Caster can't be cut by non-magical blades for 1d4 days",
    "Caster can't be harmed by any member of the royal family", "Caster can't be harmed by loud, non-magical sound",
    "Caster can't be harmed by refined metals for 1d4 hours",
    "Caster can't be harmed while he stands where he is right now", "Caster can't be killed by anyone of his own race",
    "Caster can't be overwhelmed by foul odors", "Caster can't be seen through glass or ice",
    "Caster can't be strangled", "Caster can't breathe for 4d6 rounds",
    "Caster can't bring his left hand within 18 inches of his head",
    "Caster can't carry anything larger than his own head", "Caster can't carry anything made entirely of metal",
    ...
    "Caster can't cast force-based spells (Wall of Force, etc.)", "Caster can't cast magic on anyone not wearing armor",
    "Caster can't cast magic on anyone while they're eating",
    "Caster can't cast magic unless he's within sight of a tree", "Caster can't cast magic upon himself for 1d4 weeks",
    "Caster can't create magical walls or barriers", "Caster can't create normal or magical fire for 1d4 days",
    ...
    "Caster can't cross moving water while wearing magical rings", "Caster can't cross moving water without assistance",
    "Caster can't determine when he's hungry or thirsty", "Caster can't eat any cooked meat",
    "Caster can't eat any food that doesn't contain a handful of soil",
    "Caster can't eat any food that he himself didn't prepare", "Caster can't eat any salted or cured meat",
    "Caster can't eat while at full hit points", "Caster can't employ magical means of improving his Armor Class",
    ...
    "Caster can't lift both feet from the ground at the same time", "Caster can't move his arms for 1d4 turns",
    ...
    "Caster can't open any door that has a hinge made of metal", "Caster can't open any door that opens toward him",
    "Caster can't open any door unless his hair is wet", "Caster can't open any door while anyone is watching",
    "Caster can't quite be certain that he really exists", "Caster can't remember the last 2d12+12 hours",
    "Caster can't remove any magical armor that he's now wearing", "Caster can't remove his hands from his pockets",
    "Caster can't run while his eyes are open", "Caster can't see any extra-planar creatures for one year ",
    "Caster can't see through glass, ice, diamond, or the like", "Caster can't sleep indoors while it's raining",
    "Caster can't sleep more than 1d4 hours at a time", "Caster can't sleep until he shaves his head bald",
    ...
    "Caster can't speak for one hour if he's wearing clothes", "Caster can't speak in anything less than a full shout",
    ...
    "Caster can't speak unless he first turns in a circle", "Caster can't speak unless he's brandishing a weapon",
    "Caster can't speak unless he's carrying at least one gold coin",
    "Caster can't speak unless his thumbs are touching",
    "Caster can't speak until he's removed 1d10 articles of clothing", "Caster can't speak while holding a weapon",
    "Caster can't stand with both feet on the ground at the same time", "Caster can't stop talking for 6d12 hours",
    "Caster can't tolerate the presence of wet ink", "Caster can't touch food with his hands",
    "Caster can't use any blade longer than his forearm",
    "Caster can't use any magic until someone cuts him with a blade", "Caster can't use magic between sunrise and noon",
    ...
    "Caster can't use magic items for one turn after casting a spell", "Caster can't use magic items that contain gold",
    "Caster can't use magic items until sunrise", "Caster can't use magic items while at full hit points",
    ...
    "Caster can't use magic until he eats a pound of feathers", "Caster can't use magic until sunset tomorrow",
    "Caster can't use magic while sitting", "Caster can't use magic within 1d4 miles of this spot for 5d6 days",
    "Caster can't use missile weapons for one week", "Caster can't use non-magical blades for 1d6 days",
    "Caster can't use the spell Dispel Magic", "Caster can't use the spell that triggered this Burst for one year",
    "Caster can't use weapons that contain wood", "Caster can't wake without assistance",
    "Caster can't walk (run, etc.) while wearing a magic ring", "Caster can't wear magical rings",
    ...
    "Caster claims to be able to command dragons to do his bidding", "Caster claims to be immune to inorganic poisons",
    "Caster claims to be the offspring of a god and a mortal", "Caster claims to have begotten a child with a god",
    "Caster claims to have committed logically impossible acts", "Caster claims to have created the universe",
    "Caster claims to have invented the Fireball spell", "Caster combusts instantly if he's stabbed by a silver dagger",
    ...
    "Caster comes into possession of a three-legged pony", "Caster comes into possession of an apparently magical lamp",
    ...
    "Caster compulsively hordes some kind of small, worthless item", "Caster confesses to every crime he hears about",
    ...
    "Caster continues to age normally but can't die of old age", "Caster coughs violently in the presence of undead",
    "Caster craves moss", "Caster craves wood like a termite",
    "Caster cries like a baby whenever he's hungry or can't sleep",
    "Caster cries like a baby whenever he's struck by magic", "Caster dances like a belly-dancer for 2d6 rounds",
    "Caster declares himself to be the center of the universe",
    "Caster declares that Dwarves are indistinguishable from orcs", "Caster declares that he can redeem the damned",
    "Caster declares that he has the power to absolve sins", "Caster declares that he is the judge of all mankind",
    ...
    "Caster demands that his allies treat him as though he's invisible", "Caster demands that people call him Ishmael",
    ...
    "Caster didn't actually exist prior to this Chaos Burst", "Caster dies if he slays a zombie in the next 1d6 days",
    ...
    "Caster discovers that one of his limbs is a clockwork replica", "Caster disgorges 10d10 feet of rubber tubing",
    "Caster disgorges 1d100 gold pieces", "Caster disgorges 1d100 pounds of wet, coarse sand",
    "Caster disgorges 1d4 apples per hour for the next 3d8 hours",
    "Caster disgorges 1d4 gallons of foul, necrotic mush", "Caster disgorges 1d6 gallons of rusty sludge",
    "Caster disgorges 2d10 pounds of carrots", "Caster disgorges 2d4 full-sized wool blankets",
    "Caster disgorges a 100 foot length of fine silver wire",
    "Caster disgorges a ball of solid bone nine inches in diameter",
    "Caster disgorges a bar of copper four feet in length", "Caster disgorges a bar of soap as large as his spellbook",
    "Caster disgorges a bolt of finely embroidered silk", "Caster disgorges a book about gastrointestinal anomalies",
    "Caster disgorges a book of carpet samples", "Caster disgorges a box of rare botanical samples",
    "Caster disgorges a bushel of ripe peaches", "Caster disgorges a coffin large enough to accommodate his corpse",
    "Caster disgorges a four-course meal for three", "Caster disgorges a full-grown cactus",
    "Caster disgorges a full-sized barrel", "Caster disgorges a glass cube four inches on a side ",
    "Caster disgorges a glass vial containing a mysterious potion", "Caster disgorges a golden birdcage",
    "Caster disgorges a king's long-lost signet ring", "Caster disgorges a large bunch of bananas",
    "Caster disgorges a large chair", "Caster disgorges a large pane of glass",
    "Caster disgorges a length of heavy chain", "Caster disgorges a life-sized ice sculpture of a horse",
    "Caster disgorges a long hunk of driftwood", "Caster disgorges a lump of brass the size of his torso",
    "Caster disgorges a medium-sized astrolabe", "Caster disgorges a mop and a wooden bucket full of suds",
    "Caster disgorges a mysterious and important-looking key", "Caster disgorges a pair of deer antlers",
    "Caster disgorges a pair of smith's fire tongs", "Caster disgorges a pouch full of rare and ancient coins",
    "Caster disgorges a pound of mercury", "Caster disgorges a pound of molten lead",
    "Caster disgorges a ring full of keys that don't fit any lock", "Caster disgorges a ship's anchor",
    "Caster disgorges a small brazier full of burning coals", "Caster disgorges a sort of bowl-shaped porcelain chair",
    "Caster disgorges a weapon that he misplaced 1d12 months ago", "Caster disgorges a whole pumpkin",
    "Caster disgorges a wrought-iron staircase banister",
    "Caster disgorges an airtight canister filled with nitrogen gas", "Caster disgorges an elephant's femur",
    "Caster disgorges an entire beehive", "Caster disgorges an exact copy of the head of someone nearby",
    "Caster disgorges an oil painting of this scene", "Caster disgorges an ostrich egg",
    "Caster disgorges enough snow to blanket an area ten feet square", "Caster disgorges half of a canoe",
    ...
    "Caster displays all the signs of full demonic possession", "Caster distrusts anyone displaying a cut gem or jewel",
    "Caster distrusts anyone taller than he is", "Caster distrusts anyone who doesn't know the caster's name",
    "Caster distrusts anyone who doesn't resemble him", "Caster distrusts anyone who won't let him examine their teeth",
    "Caster distrusts anyone who's wearing armor", "Caster distrusts other members of his race",
    "Caster distrusts other spellcasters", "Caster doesn't need to drink fluids for the next 1d100 weeks",
    "Caster doesn't need to eat during the new moon", "Caster doesn't need to eat for the next 1d100 weeks",
    "Caster doesn't remember anyone now within 10 miles", "Caster donates all of his money to some unlikely charity",
    ...
    "Caster dreams of unicorns and wonders if he's an automaton", "Caster drinks any potions he's now carrying",
    ...
    "Caster engages in a long, heated debate with the nearest tree", "Caster enjoys the taste of fire",
    "Caster enjoys the taste of lamp oil", "Caster erases one randomly-chosen spell from his spellbook",
    "Caster experiences pain if he handles jewels or precious gems", "Caster experiences pain when he spends money",
    "Caster experiences violent, full-body spasms for 2d4 rounds",
    "Caster faces True North and is stuck that way for one turn",
    "Caster falls down the next flight of steps he encounters", "Caster falls from the nearest tree",
    "Caster falls madly in love with someone he's never heard of",
    "Caster falls madly in love with someone who's never existed", "Caster fears densely wooded areas",
    ...
    "Caster fears that his allies are vanishing one by one", "Caster fears that his limbs are vanishing one by one",
    "Caster fears that spiders have lain countless eggs in his brain", "Caster fears the reaper",
    "Caster feels a psychic bond to someone unknown but nearby", "Caster feels as if he's always walking on a slope",
    "Caster feels as though he's trudging through knee-deep snow", "Caster feels as though he's trudging uphill",
    ...
    "Caster finds 1d4 extra spells in his spellbook", "Caster finds 1d4 small rodents living in his spellbook",
    ...
    "Caster finds a barrel full of rancid mayonnaise", "Caster finds a book describing the methods for self-dissection",
    ...
    "Caster finds a mirror that reflects everyone but him ", "Caster finds a mirror that reflects only vampires",
    ...
    "Caster finds a powder that quickly seals open wounds", "Caster finds a powder that repels elementals",
    ...
    "Caster finds a secret passage in the next room he enters", "Caster finds a set of high-quality watchmaker's tools",
    ...
    "Caster finds a trumpet that, if blown, may herald the End Times", "Caster finds a weapon that can kill a god",
    "Caster finds a wooden box whose interior can't be illuminated",
    "Caster finds an amulet that repels Summoned creatures", "Caster finds black meat like a tainted cheese",
    ...
    "Caster finds strong evidence that the planet is artificial", "Caster finds the ruins of a vast magical library",
    ...
    "Caster flickers like a guttering candle for 1d6 turns", "Caster flies into a fury when he removes his shoes",
    "Caster flies into a murderous rage and attacks his nearest ally", "Caster forgets any fire that he lights",
    "Caster forgets any first-level spell he now has memorized", "Caster forgets everyone's name",
    "Caster forgets everything he knows about etiquette", "Caster forgets how to open his spellbook",
    "Caster forgets how to use knives and blades of all kinds", "Caster forgets how to use magic for 1d4 days",
    "Caster forgets how to walk for 1d12 hours", "Caster forgets that his name is a vile expletive in Dwarfish",
    ...
    "Caster gains no benefit from wearing gloves or gauntlets", "Caster gains one pound per level of spells he casts",
    ...
    "Caster gives his party two weeks' notice before resigning", "Caster glows as bright as daylight while he's asleep",
    "Caster goes berserk and attacks the next undead creature he sees",
    "Caster goes berserk in the presence of royalty", "Caster goes berserk whenever he receives magical healing",
    ...
    "Caster gradually becomes more and more angular", "Caster gradually becomes more and more turtle-like",
    "Caster growls in his sleep like a tiger", "Caster grows 1d10 new and mysterious organs in his abdomen",
    "Caster grows an additional finger each week", "Caster grows one inch per day for the next 2d4-1 days",
    "Caster hallucinates wildly the next time he drinks water",
    "Caster hallucinates wildly until he drinks a quart of water", "Caster has 5 Intelligence for 1d6 turns",
    "Caster has 5 Strength for 1d4 turns", "Caster has 1d100 real-looking but useless copies of his spellbook",
    ...
    "Caster has a large but harmless hole at the top of his head", "Caster has a parrot on his shoulder and a peg leg",
    ...
    "Caster has a small keyhole in the palm of his right hand", "Caster has a star-shaped dent at the back of his head",
    "Caster has a violent argument with the next soldier he meets",
    "Caster has an almost paralyzing fear of death and the dead", "Caster has an answer for everything",
    "Caster has an extraordinary sense of balance", "Caster has an identical face on the back of his head",
    ...
    "Caster has an overpowering hatred of artificial light sources", "Caster has an ugly mole just like a nose",
    "Caster has an ugly nose just like a mole", "Caster has been carrying a sack full of manure for 1d4 days",
    ...
    "Caster has no internal organs; he's a homogenous mush inside", "Caster has no scent whatsoever",
    "Caster has ram's horns growing from his hips", "Caster has rings on his fingers and bells on his toes",
    "Caster has scars as if his skeleton had been torn out of his body",
    "Caster has silly and pornographic tattoos over most of his body", "Caster has ten thumbs in his mouth",
    "Caster has ten thumbs instead of fingers", "Caster has ten thumbs somewhere on his body",
    "Caster has tiny mathematical formulae tattooed all over his body",
    "Caster has vivid but false memories of a past life", "Caster has vivid but false memories of the last 24 hours",
    "Caster has vivid dreams of his own death each night", "Caster hasn't eaten during the past 1d100 days",
    ...
    "Caster henceforth needs only one-third the normal amount of food", "Caster hurls his spellbook as far as he can",
    ...
    "Caster is 20% likely to turn to stone while swimming", "Caster is 2X as old as the oldest person within 100 yards",
    "Caster is 50% likely to drown in any water deeper than he is tall",
    "Caster is 60% likely to misplace any money he receives", "Caster is able to see his own eyes",
    "Caster is absolutely convinced that he's a zombie", "Caster is afflicted with severe frostbite in 1d4 limbs",
    ...
    "Caster is attacked by a shark when he next enters a river", "Caster is attacked by countless stinging earthworms",
    ...
    "Caster is blind unless he's carrying at least 4d10 gold coins", "Caster is blind while he's invisible",
    "Caster is blind while his spellbook is open", "Caster is blind while within any artificial structure",
    ...
    "Caster is briefly paralyzed at the sight of his own blood", "Caster is briefly stunned by a shower of hard beans",
    ...
    "Caster is certain that he can breathe underwater", "Caster is certain that he has just killed his guardian angel",
    "Caster is certain that he used to have four arms", "Caster is certain that he'll become immortal if he's beheaded",
    ...
    "Caster is chained to a desk in some high-rise office building", "Caster is chained to an anvil",
    ...
    "Caster is convinced that his allies plan to kill and eat him", "Caster is covered in a shell of frozen slime",
    "Caster is covered in barnacles", "Caster is covered in indelible, jet-black handprints",
    "Caster is covered in ketchup", "Caster is covered in peanut butter",
    "Caster is covered in sucker marks as though hugged by an octopus",
    "Caster is deaf and blind until sunrise tomorrow", "Caster is determined to destroy his staff or spellbook",
    ...
    "Caster is encased up to his neck in a shell of concrete", "Caster is enclosed in a large paper bag",
    "Caster is entirely immune to magic for 1d8 rounds", "Caster is feared and respected by Hill Giants",
    "Caster is fiercely addicted to some astonishingly rare substance", "Caster is filled with Righteous Indignation",
    "Caster is forcibly barred from the next town he attempts to enter", "Caster is full o' the milk of human kindness",
    ...
    "Caster is horribly afraid to use magic weapons in daylight", "Caster is horribly afraid to use metal weapons",
    "Caster is hurled from here into the nearest lake", "Caster is immune to all attempts at telepathy or mind-reading",
    ...
    "Caster is immune to fear while holding a spider in his mouth", "Caster is immune to fire from the waist down",
    ...
    "Caster is immune to gaze attacks while singing", "Caster is immune to liquid-based poisons for one year",
    "Caster is immune to magic for 1d8 days but can't use magic either",
    "Caster is immune to magic until he imbibes any liquid", "Caster is immune to missile-based spells while naked",
    ...
    "Caster is immune to non-magical missiles for 1d8 hours", "Caster is immune to non-magical venom",
    "Caster is immune to non-magical, non-gaseous poisons", "Caster is immune to oil-based fire for 1d12 months",
    "Caster is immune to poison gas while his feet are wet", "Caster is immune to sarcasm",
    "Caster is immune to the effects of dehydration", "Caster is immune to the effects of illusory sound",
    "Caster is immune to the effects of smoke inhalation", "Caster is immune to the effects of the Wish spell",
    ...
    "Caster is invisible from his hips to his sternum", "Caster is invisible to 1d4 people nearby",
    "Caster is invisible to dragons for one year", "Caster is invisible to dragons while in direct sunlight",
    "Caster is invisible to female herbivores", "Caster is invisible to females for 2d6 turns",
    "Caster is invisible to Hill Giants", "Caster is invisible to himself for 1d4 weeks",
    "Caster is invisible to himself from the waist down", "Caster is invisible to horses",
    "Caster is invisible to infravision", "Caster is invisible to inherently invisible creatures",
    "Caster is invisible to males for 2d6 turns", "Caster is invisible to members of his immediate family",
    "Caster is invisible to non-magical reptiles", "Caster is invisible to non-magical reptiles for 1d4 hours",
    "Caster is invisible to the person who most recently wounded him", "Caster is invisible while underwater",
    ...
    "Caster is owed a favor by the local magistrate", "Caster is paralyzed from the neck up for 1d6 rounds",
    ...
    "Caster is punctured as if he'd spent the night in an iron maiden", "Caster is ravenously hungry after each battle",
    "Caster is reduced to first level for 4d6 hours",
    "Caster is reduced to one hit point when he next triggers a Burst",
    "Caster is related by blood to no one who has ever lived", "Caster is reluctant to bring his spellbook indoors",
    ...
    "Caster is rumored to have sold his family into slavery", "Caster is rumored to have the heart of a goblin",
    ...
    "Caster is sealed in a huge but otherwise normal chicken egg", "Caster is sealed in a pine coffin",
    "Caster is sealed in an oak barrel", "Caster is seated on a platform high atop a tall, narrow pole",
    "Caster is skilled in a new weapon but can't use it in daylight", "Caster is Slowed when he becomes invisible",
    "Caster is smeared from head to toe with molasses", "Caster is soaked each time he casts a water-based spell",
    "Caster is somewhere around Barstow, on the edge of the desert",
    "Caster is soon jailed for public lewdness and profanity", "Caster is soon jailed for suspicion of murder",
    "Caster is soon jailed for unlawful use of magical knowledge",
    "Caster is sought by a band of militant vivisectionists", "Caster is sparsely flecked with salt like a pretzel",
    ...
    "Caster is suddenly seated on a throne formed of apple cores", "Caster is suddenly sitting in an elegant bathtub",
    "Caster is suddenly standing at the base of the nearest waterfall",
    "Caster is suddenly standing atop a single stilt", "Caster is suddenly standing atop a very tall ladder",
    "Caster is suddenly standing atop the nearest boulder", "Caster is suddenly standing atop the nearest horse",
    "Caster is suddenly standing in a bucket of butter", "Caster is suddenly standing in a canoe on a rushing river",
    ...
    "Caster is suddenly standing in the nearest brothel", "Caster is suddenly standing in the nearest holy water font",
    "Caster is suddenly standing in the nearest pig sty", "Caster is suddenly standing knee-deep in manure",
    ...
    "Caster is the worst liar in the history of intelligent discourse", "Caster is thickly shrouded in cobwebs",
    "Caster is thoroughly entangled in the tentacles of a man-of-war", "Caster is thoroughly smeared in bacon grease",
    "Caster is thoroughly soaked with egg whites", "Caster is thought to have a huge bounty on his head",
    "Caster is thrown 1d4x1000 years into the future for 1d4 rounds", "Caster is thrown 4d6 feet into the air",
    "Caster is thrown 4d6 hours into the future", "Caster is thrown violently backward from the spell's target point",
    "Caster is tightly bound in strong wire", "Caster is tightly wrapped in a straightjacket",
    "Caster is trampled by a boar", "Caster is trapped in a column of brackish water for 1d4 rounds",
    "Caster is unable to ask questions", "Caster is unable to cross any bridge that spans flowing water",
    "Caster is unable to enter into infernal pacts", "Caster is unaffected by magical wind for 1d4 months",
    "Caster is unaffected by magically-created metal", "Caster is unaffected by natural wind",
    "Caster is unaffected by the spell Remove Curse", "Caster is unharmed by extremes of sound",
    "Caster is unharmed by moldy or rotten food", "Caster is universally treated like a hated criminal for 1d8 days",
    "Caster is unknowingly inducted into a secret society", "Caster is utterly unable to assess his own injuries",
    ...
    "Caster is wearing boxing gloves and can't remove them until dawn", "Caster is wearing bunny fur",
    "Caster is wearing clothes that are 10d10 centuries out of date",
    "Caster is wearing enough clothing for 3d4 people", "Caster is wearing extraordinarily glamorous false eyelashes",
    "Caster is wearing golf shoes", "Caster is wearing his mother's wedding gown", "Caster is wearing horseshoes",
    "Caster is wearing ice skates", "Caster is wearing nothing but a thin loincloth", "Caster is wearing roller skates",
    ...
    "Caster just barely passes for a member of his race", "Caster keeps smelling burnt toast",
    "Caster keeps talking despite everyone's utter lack of interest",
    "Caster knows a method by which gold can be tempered like steel", "Caster knows a new language for 1d4 weeks",
    "Caster knows a spell that will slay him instantly", "Caster knows that he'll go mad if he says his name aloud",
    "Caster knows the location of every mammal now within one mile",
    "Caster knows the secret language of frogs and toads", "Caster laughs heartily when he sees his allies injured",
    "Caster leaps from the next bridge that he crosses", "Caster learns a damaging secret about one of his allies",
    ...
    "Caster learns that his parents were undead on the day he was born", "Caster leaves no footprints in snow",
    ...
    "Caster loses all comprehension of the concept of money", "Caster loses all hair on the left side of his body",
    ...
    "Caster loses one point of Charisma per day for 3d6 weeks", "Caster loses one pound per level of spell he casts",
    ...
    "Caster must carry his spellbook in hand, not in a bag or pouch", "Caster must drink his weight in water by sunset",
    "Caster must drink salt water instead of fresh water", "Caster must eat at least one pound of salt each week",
    ...
    "Caster must Save vs Fortitude or his lungs turn to gold", "Caster must Save vs Fortitude, or his weight doubles",
    ...
    "Caster must state his name to anyone who asks it", "Caster no longer able to share with others",
    "Caster no longer believes that magic really exists",
    "Caster no longer needs to eat but can't heal injuries naturally", "Caster no longer perspires",
    "Caster no longer produces saliva", "Caster now breathes nitrogen instead of oxygen ",
    "Caster obsessively pursues his goal of acquiring a second head",
    "Caster offers to sell his spellbook to the lowest bidder", "Caster only needs to eat during alternating weeks",
    "Caster owes 10d100 gold pieces to the next person he touches",
    "Caster owes 1d4 gold pieces to everyone within 100 yards", "Caster owes a colossal sum of money to a local lender",
    ...
    "Caster perceives mysterious ships to be flying in the air nearby", "Caster permanently gains 1d4-1 hit points",
    "Caster permanently gains an additional 1d4 hit points", "Caster permanently loses 1d4-1 hit points",
    "Caster permanently loses the sense of taste", "Caster prefers not to cast magic indoors",
    ...
    "Caster reacts to hospitality with shocking boorishness", "Caster reacts violently to any perceived insults",
    ...
    "Caster reacts violently to anyone who asks his name", "Caster reacts violently to conspicuous rhymes in speech",
    ...
    "Caster recites that bit from Macbeth whenever he holds a dagger", "Caster refers to his allies by cute nicknames",
    "Caster refers to his spellbook as his \"Booky - Wooky\"", "Caster refuses to carry any gems or jewels",
    ...
    "Caster refuses to speak to anyone who addresses him by name", "Caster refuses to speak with one particular ally",
    "Caster refuses to wield any weapon not engraved with his name",
    "Caster refuses to wield any weapon that has ever drawn blood", "Caster repeats the next round 1d100 times",
    "Caster requires only 1d8 hours of sleep per week", "Caster reveals that he enjoys the taste of roasted Dwarf",
    "Caster reveals that he's a doppelganger", "Caster routinely forgets magical command words",
    ...
    "Caster routinely forgets to eat, even when he's famished", "Caster routinely forgets to lie down before sleeping",
    ...
    "Caster routinely forgets where he is and where he's going", "Caster routinely forgets where he left his spellbook",
    ...
    "Caster runs to and attempts to uproot the nearest tree", "Caster runs to the nearest abattoir",
    "Caster seeks sanctuary in the nearest brothel", "Caster sees as if everything is cloaked in perpetual twilight",
    "Caster sees as if his eyes were hovering one foot to the left",
    "Caster sees as if his eyes were in the back of his head", "Caster sees as if his eyes were where his ears are",
    "Caster sees colorful ribbons swirling in the air around him",
    "Caster sees cryptic messages in the patterns of plant growth", "Caster sees everything as if he's deep underwater",
    "Caster sees everything as through a glass, darkly", "Caster sees geysers of flaming pitch erupting all around him",
    "Caster sees ghostly courtesans all around him", "Caster sees huge bats and manta rays whirling all around him",
    ...
    "Caster seriously considers abandoning magic for all time", "Caster seriously considers entering the clergy",
    ...
    "Caster shrinks by 50% upon losing 50% of his hit points", "Caster shuns the company of other magic users",
    "Caster shuns the use of magic items as being \"amateurish\"",
    "Caster shuns the use of weapons that contain ferrous metal", "Caster sinks like a stone in water but cannot drown",
    "Caster smells faintly of cabbage", "Caster smells strongly burnt toast", "Caster smells strongly of alcohol",
    "Caster smells strongly of blood while he's wet", "Caster smells strongly of boiling tar",
    "Caster smells strongly of exotic perfumes", "Caster smells strongly of fuel oil",
    "Caster smells strongly of fungus while he's near a campfire", "Caster smells strongly of garlic",
    "Caster smells strongly of peppermint", "Caster smells strongly of rose petals",
    "Caster sneezes 1d20 times in each of the next 1d20 rounds", "Caster sneezes repeatedly when he becomes invisible",
    ...
    "Caster spends 1d4 rounds attacking the nearest tree", "Caster spends 1d4 rounds attempting to ignite his shoes",
    ...
    "Caster spreads vicious and embarrassing rumors about himself", "Caster sprouts a dorsal fin",
    "Caster sprouts a ghastly tentacle from the center of his chest",
    "Caster sprouts a large, spongy mass between his shoulder blades", "Caster sprouts a mane like a lion's",
    "Caster sprouts a new ear on the back of one hand", "Caster sprouts a pretty flower from his chin",
    "Caster sprouts a prominent brow ridge", "Caster sprouts a retractable metal antenna from his forehead",
    ...
    "Caster sprouts an eye at the exact top of his head", "Caster sprouts an ugly protuberance from his forearm",
    "Caster sprouts sharp blades along the edges of his forearms",
    "Caster sprouts tiny, useless wings from the bridge of his nose",
    "Caster sprouts wild-looking feathers on his cheeks", "Caster sprouts wires and rubber tubing from his flesh",
    "Caster stands in uffish thought for 3d4 rounds", "Caster stares at the spell's target point for 1d10 rounds",
    ...
    "Caster stumbles into the next campfire that he passes", "Caster suddenly has 2d4+2 toes jutting from his face",
    "Caster suddenly has feet like an elephant", "Caster suddenly has misgivings about his skill as a magic user",
    "Caster suddenly has ten toes on each foot", "Caster suddenly has ten toes on one foot and none on the other",
    ...
    "Caster suffers an intense, debilitating fever for 1d4 days", "Caster suffers bouts of rampant xenophobia",
    "Caster suffers brief pain every time he closes a book",
    "Caster suffers cramps if he uses magic within an hour of eating", "Caster suffers crippling arthritis pain",
    "Caster suffers delusions about the efficacy of the Free Market", "Caster suffers fools gladly",
    ...
    "Caster suffers intense pain whenever he changes shape", "Caster suffers intense pain whenever he eats cooked meat",
    ...
    "Caster suffers the bends as if he surfaced too quickly", "Caster suffers the tortures of the damned for 1d4 hours",
    ...
    "Caster suspects that someone nearby is a mechanical automaton", "Caster takes a big bite out of his spellbook",
    "Caster takes a big bite out of the nearest statue", "Caster takes a big bite out of the nearest tree",
    ...
    "Caster teleports to the site of the most recent state execution", "Caster teleports to the spot where he last ate",
    "Caster tells everyone that he has an eidetic memory", "Caster tells everyone that his bones are made of diamond",
    ...
    "Caster thinks that a violent hailstorm is going on", "Caster thinks that all fire is an illusion",
    ...
    "Caster thinks that elementals pose no threat to him", "Caster thinks that every herbivore in the world hates him",
    ...
    "Caster thinks that he can command dragons to do his bidding", "Caster thinks that he can communicate with ants",
    "Caster thinks that he can communicate with cats", "Caster thinks that he can fly by leaping off of tall buildings",
    ...
    "Caster thinks that he can speak directly to his deity", "Caster thinks that he can speak with birds",
    "Caster thinks that he can survive many hammer blows to the skull", "Caster thinks that he died during his youth",
    "Caster thinks that he has a weakness to green rock", "Caster thinks that he has diplomatic immunity",
    ...
    "Caster thinks that he owns everything now in his line of sight", "Caster thinks that he smells strongly of manure",
    ...
    "Caster thinks that he'll combust if he gets wet", "Caster thinks that he'll combust if he tells a lie",
    ...
    "Caster thinks that he'll melt if he gets too close to a fire", "Caster thinks that he's a master thief",
    ...
    "Caster thinks that he's being consumed by invisible worms", "Caster thinks that he's being held against his will",
    "Caster thinks that he's being savaged by rabid dogs", "Caster thinks that he's being squeezed by a large python",
    ...
    "Caster thinks that he's destined to die in a comical fashion", "Caster thinks that he's died and gone to heaven",
    "Caster thinks that he's fireproof while he's naked", "Caster thinks that he's guilty of sedition and treason",
    "Caster thinks that he's highly combustible", "Caster thinks that he's immune to lycanthropy",
    "Caster thinks that he's immune to necromantic magic", "Caster thinks that he's immune to non-magical diseases",
    "Caster thinks that he's indentured to some nearby landowner",
    "Caster thinks that he's invincible while he's talking", "Caster thinks that he's invulnerable to magical weapons",
    ...
    "Caster thinks that he's raised himself from the dead", "Caster thinks that he's seeing through someone else's eye",
    ...
    "Caster thinks that he's soon to be bronze-plated", "Caster thinks that he's standing at the edge of a cliff",
    ...
    "Caster thinks that he's the lizard king and can do anything", "Caster thinks that he's the man in the moon",
    "Caster thinks that he's the victim of an elaborate practical joke",
    "Caster thinks that he's the victim of circumstance", "Caster thinks that he's water soluble",
    ...
    "Caster thinks that his spellbook belongs to someone else", "Caster thinks that his spellbook is a living entity",
    "Caster thinks that his spellbook is incredibly flammable",
    "Caster thinks that his spellbook is trying to consume his soul",
    "Caster thinks that his spellbook is trying to kill him", "Caster thinks that his teeth will explode if chews meat",
    ...
    "Caster thinks that no non-magical animal can harm him", "Caster thinks that no one really trusts him",
    ...
    "Caster thinks that something valuable's been stolen from him", "Caster thinks that the king owes him a big favor",
    ...
    "Caster thinks that this date will live in infamy", "Caster thinks that this is all just a big misunderstanding",
    ...
    "Caster tries very hard to peel his face from his skull", "Caster tries very hard to twist his nose upside down",
    "Caster turns bright blue while he's bleeding", "Caster turns into a clothing store mannequin for 1d6 rounds",
    "Caster turns into a small, pot-bellied pig", "Caster turns into an elemental of equal hit dice for 1d4 rounds",
    ...
    "Caster vows to commit deicide before the end of the year", "Caster vows to make a little birdhouse in his soul",
    "Caster vows to slay the next person to use magic on him",
    "Caster vows to slay the next person who addresses him by name",
    "Caster wagers all of his money on an improbable contest", "Caster walks with a profound limp except while naked",
    ...
    "Caster wins a magical lamp shaped like a woman's leg", "Caster wishes to divest himself of all worldly goods",
    "Caster won't age for 100 years if he cuts off his thumbs", "Caster won't remember the next 4d6 hours",
    "Caster, his gear, and clothes are translucent for 2d4-1 days", "Caster's age is doubled until sunrise tomorrow",
    "Caster's allies completely ignore him for 1d6 hours", "Caster's allies have never quite trusted him",
    "Caster's allies suspect that he isn't quite housebroken",
    "Caster's allies suspect that he secretly eats mice and rats",
    "Caster's allies treat him like a child for 2d12 hours", "Caster's allies worship him as a god for 1d4 days",
    "Caster's Armor Class is improved by 1d4 until dawn",
    "Caster's Armor Class is worsened by 1d6 until sunset tomorrow",
    "Caster's arms and legs are bound in shackles of gold", "Caster's arms and legs look like chicken's legs",
    "Caster's arms are covered by scars from ritual burns", "Caster's arms are covered in hideous welts and bruises",
    "Caster's arms are tied together in a tight knot", "Caster's arms from shoulder to wrist are unharmed by acid",
    ...
    "Caster's back is scarred with the imprint of a dragon's foot", "Caster's base Armor Class is 8",
    "Caster's base Armor Class is 12", "Caster's big toes become opposable like thumbs",
    "Caster's blood causes metal to become invisible", "Caster's blood combusts violently within his body",
    ...
    "Caster's blood is strongly adhesive after it leaves his body", "Caster's blood is toxic to him, if ingested",
    "Caster's blood is weightless", "Caster's blood is worth more than gold, in the proper market",
    "Caster's blood leaves indelible stains on rock and stone", "Caster's blood radiates intense magic",
    "Caster's body appears to have been shredded and reassembled",
    "Caster's body can act independently if separated from his head", "Caster's body is 40% fireproof",
    "Caster's body is an artificial construct", "Caster's body is covered in festering scabs",
    "Caster's body is covered in ugly, livid bruises", "Caster's body is reset to a 48-hour cycle rather than 24",
    ...
    "Caster's bones can't be broken but are highly combustible", "Caster's bones can't be broken unless he's barefoot",
    "Caster's bones will be powerfully explosive after his death",
    "Caster's boots adhere strongly to stone while he's wearing them", "Caster's boots are worth 10d100 gold pieces",
    "Caster's boots can never move more than ten feet from this spot",
    "Caster's boots have been kidnapped and held for a high ransom", "Caster's boots weigh 100 pounds when wet",
    "Caster's casting times are shortened by 50% for 2d4-1 days", "Caster's center of gravity changes daily",
    "Caster's center of gravity is 1d4 feet to his left", "Caster's center of gravity is at the level of his eyes",
    "Caster's center of gravity is at the level of his feet", "Caster's closest blood relative ascends to godhood",
    ...
    "Caster's clothes are burned to cinders, but he is unharmed", "Caster's clothes are caked with salt",
    "Caster's clothes are drenched with goat's milk ", "Caster's clothes are impervious to Alteration magic",
    "Caster's clothes are impervious to fire when it's not being worn", "Caster's clothes are invisible by firelight",
    "Caster's clothes are invisible in the presence of royalty", "Caster's clothes are soaked with lambs' blood",
    "Caster's clothes are soaked with lamp oil", "Caster's clothes are soaked with molasses",
    "Caster's clothes are stripped of any and all enchantments", "Caster's clothes are water soluble",
    "Caster's clothes clatter like metal when he moves", "Caster's clothes don't leave much to the imagination",
    "Caster's clothes heat by 1° per minute for the next 1d10 hours",
    "Caster's clothes maintain a constant temperature of 70°", "Caster's clothes radiate intense magic",
    "Caster's clothes turn to copper", "Caster's clothes turn to densely-woven spider's web",
    "Caster's clothes turn to living human flesh", "Caster's clothing inflates to the size of a house",
    "Caster's cranium enlarges by 25%", "Caster's cranium reforms into a tall, blunt cone",
    ...
    "Caster's death will inspire weeks of riots and revolution", "Caster's debt increases at a rate of 30% per month",
    "Caster's digestive system becomes independently sentient",
    "Caster's dominant hand becomes as clumsy as his other hand", "Caster's ears are burned from his head",
    "Caster's ears are on the same side of his head", "Caster's ears are unaffected by polymorph magic",
    "Caster's ears bleed harmlessly but copiously for 10d10 rounds", "Caster's ears can't be cut by any metal blade",
    "Caster's ears fall off and regrow every few days", "Caster's ears grow to the size of dinner plates",
    "Caster's ears resemble butterfly's wings", "Caster's elbows can't bend more than 90°",
    "Caster's entire head looks like a huge nose", "Caster's every attempt at music yields the same annoying tune",
    "Caster's eyelids look like lips", "Caster's eyes appear crystalline like diamonds",
    "Caster's eyes are artificial and were installed by demons", "Caster's eyes are invulnerable to heat and fire",
    "Caster's eyes are replaced by new ones every 1d4 days", "Caster's eyes can be safely removed for up to 1d4 hours",
    ...
    "Caster's eyes merge into a single eye at the bridge of his nose", "Caster's eyes migrate to his cheekbones",
    "Caster's eyes migrate two inches higher on his forehead", "Caster's eyes sink 1d4 inches into his skull",
    "Caster's eyes swell shut for 2d12 hours", "Caster's eyeteeth grow into tusks like those of a walrus",
    "Caster's face and head are covered by a tight shell of fetid wax", "Caster's face and head resemble a snowman's",
    "Caster's face appears melted like wax", "Caster's face appears to age backwards at 2X the normal rate",
    "Caster's face appears to be made of chrome", "Caster's face appears to be made of hammered aluminum",
    "Caster's face appears to be upside-down", "Caster's face appears to float 1d4 inches in front of his skull",
    ...
    "Caster's face falls off, leaving a bare skull until sunrise", "Caster's face is a mask",
    "Caster's face is an illusion and can be dispelled as such", "Caster's face is concave",
    "Caster's face is covered with cactus spines", "Caster's face is fireproof",
    "Caster's face is glazed in a thick layer of ice", "Caster's face is pliant like rubber",
    "Caster's face is printed with intricate, dark blue tattoos",
    "Caster's face is scarred as though slashed by an eagle's talons",
    "Caster's face swells enough to be unrecognizable", "Caster's face tingles in the presence of magical animals",
    "Caster's face turns to wood", "Caster's feet are burned as if he's waded through ankle-deep acid",
    "Caster's feet are encased in brick", "Caster's feet can't be burned by magical fire",
    ...
    "Caster's feet vanish, but he can walk comfortably on his ankles", "Caster's fingernails are poisonous to him",
    "Caster's fingernails display otherworldly scenes", "Caster's fingernails each grow 1d20 inches",
    "Caster's fingernails exude a pungent green fluid", "Caster's fingernails grow 1d4 inches per day",
    "Caster's fingers appear to be made of delicate crystal", "Caster's fingers are as flexible as tentacles",
    "Caster's fingers are as rigid as steel while they're wet", "Caster's fingers are threaded like bolts",
    "Caster's fingers can't be severed from his hands", "Caster's fingers glow faintly in the presence of humans",
    "Caster's fingers randomly shuffle their positions",
    "Caster's fingers seem ice cold to anyone other than the caster", "Caster's fist fuses into an clumsy stub",
    "Caster's fist jams itself into his mouth", "Caster's footprints glow with sickly green light for 5d6 rounds",
    "Caster's footprints seem to shimmer and waver in sunlight",
    "Caster's footprints shine brightly while he's invisible", "Caster's hair and clothes become horribly entangled",
    "Caster's hair and clothes constantly stir as if blown by wind",
    "Caster's hair becomes tangled in any hat or helmet he wears",
    "Caster's hair becomes thick and coarse like that of a boar", "Caster's hair can never become invisible",
    "Caster's hair falls out each evening and regrows by morning", "Caster's hair freezes solid",
    "Caster's hair is clear like glass", "Caster's hair is discovered to be a bad toupee", "Caster's hair is fireproof",
    "Caster's hair is perpetually soaked with sea water", "Caster's hair is striped like a tiger's coat",
    ...
    "Caster's hand adheres to the next tree he touches", "Caster's hands and arms are covered with cactus needles",
    "Caster's hands and feet are invisible for 1d4 weeks", "Caster's hands appear to be crude wooden replicas",
    "Caster's hands appear to be made of solid gold", "Caster's hands appear to have been badly gnawed by rodents",
    "Caster's hands are blasted to a crisp but heal in 1d4+1 weeks",
    "Caster's hands are completely insulated against electricity",
    "Caster's hands are impervious to all harm for one week", "Caster's hands are invisible while he clasps them",
    "Caster's hands are totally numb for 10d10 rounds", "Caster's hands are translucent like smoky quartz",
    ...
    "Caster's hands explode but grow back by morning", "Caster's hands feel just like two balloons",
    "Caster's hands reform into lobster-like pincers", "Caster's hands shine like a beacon visible only to goblins",
    "Caster's hands shrink by 50%", "Caster's hands shrink or grow to fit any gloves he wears",
    "Caster's hands sprout coarse scales", "Caster's hands sprout luxuriant feathers",
    ...
    "Caster's head is impervious to non-magical missile fire", "Caster's head is now shaped like a bell",
    "Caster's head is perfectly cylindrical until sunset tomorrow",
    "Caster's head is permanently surrounded by dense fog", "Caster's head is rendered permanently invisible",
    "Caster's head is sealed in a block of ice with breathing holes",
    "Caster's head is split down the middle but he is unharmed",
    "Caster's head once belonged to a great military leader", "Caster's head shines like a beacon visible only to orcs",
    ...
    "Caster's home can't be entered through the front door", "Caster's home drops from the sky to land heavily nearby",
    ...
    "Caster's home is at the center of a huge territorial squabble", "Caster's home is buried in compost",
    "Caster's home is destroyed by a huge magical explosion", "Caster's home is fireproof but water soluble",
    "Caster's home is flattened by a mysterious magical explosion", "Caster's home is infested with bubonic rats",
    "Caster's home is leveraged in a speculative financial scheme", "Caster's home is made of gingerbread",
    "Caster's home is packed completely full of manure", "Caster's home is packed completely full of pigs' ears",
    "Caster's home is packed completely full of salt", "Caster's home is packed completely full of snow",
    ...
    "Caster's home levitates 1d10 yards in the air for that many days", "Caster's home resembles a large toadstool",
    "Caster's home sinks into the ground 1d10 inches per day", "Caster's home stands on a kobold burial mound",
    "Caster's home throbs and pulses like a gigantic heart", "Caster's home will cease to exist in 1d4 days",
    "Caster's image appears on every shield within 100 yards", "Caster's index finger is shaped like a key",
    ...
    "Caster's internal monologue becomes audible to others", "Caster's is unable to digest uncooked foods",
    "Caster's kidneys vanish", "Caster's knees can bend forward and backward with equal ease",
    "Caster's left arm appears to carry a powerful enchantment",
    "Caster's left arm appears to have been made from twine and glue", "Caster's left arm doubles in length 1d4 times",
    ...
    "Caster's left hand can't be cut by any non-magical blade", "Caster's left hand is affected as by the spell Haste",
    "Caster's left hand is hideously warped and mangled", "Caster's left hand strongly resents his right hand",
    "Caster's left leg detaches and starts kicking him really hard", "Caster's left leg is covered by bark",
    "Caster's legs are both encased in a single thick, steel pipe", "Caster's legs are now exactly as long as his arms",
    "Caster's legs can't support his weight for 10d10 rounds",
    "Caster's legs double in length, and his arms shorten by 50%",
    "Caster's legs weigh as much as iron while he's wading", "Caster's limbs are rendered permanently invisible",
    "Caster's limbs each belong to a different species", "Caster's lungs are visible through his flesh and clothing",
    "Caster's lungs begin to function at 2X normal efficiency",
    "Caster's lungs begin to function at half normal efficiency",
    "Caster's lungs sound like bagpipes when he exerts himself", "Caster's lungs stop working for 1d10 rounds",
    "Caster's magic does not affect females for 1d4 days", "Caster's magic does not affect males for 1d4 days",
    ...
    "Caster's nearest ally attacks him for 1d6 rounds", "Caster's nearest ally is invisible to him for 1d4 days",
    "Caster's neck doubles in length", "Caster's neck is invisible",
    ...
    "Caster's next spell functions but knocks him unconscious", "Caster's next spell persists until he's injured",
    ...
    "Caster's next Summoning yields two of whatever he's Summoning", "Caster's nose looks like a noose",
    "Caster's nose looks like an ear", "Caster's nostrils are stuffed full of pimentos", "Caster's palms turn to stone",
    "Caster's pockets are filled with confectioner's sugar", "Caster's pockets are filled with glue",
    "Caster's pockets are filled with greasy candle stubs", "Caster's pockets are filled with live minnows",
    "Caster's pockets are filled with offal", "Caster's pockets are filled with stringy pasta",
    "Caster's pockets are filled with weeks-old goat cheese", "Caster's pockets are fireproof",
    "Caster's pockets are inaccessible for 1d6 days", "Caster's pockets are lined with chain mail",
    "Caster's pockets are lined with sharp, jagged teeth", "Caster's pockets vanish along with anything inside them",
    ...
    "Caster's presence causes undead skeletons to sneeze", "Caster's presence causes worked stone to sweat",
    ...
    "Caster's principal weapon is translucent like smoked glass", "Caster's principal weapon shrinks by 5d10+45%",
    "Caster's principal weapon sprouts luxuriant tresses", "Caster's reflection appears upside down",
    "Caster's reflection chants dire prophecies about him", "Caster's reflection commits suicide when he next sees it",
    "Caster's reflection harbors a deep and obvious resentment of him", "Caster's reflection is not mirror-reversed",
    "Caster's reflection shows him as battered corpse", "Caster's reflection shows him as he was 10 years ago",
    "Caster's reflection shows him beaten nearly to death",
    "Caster's right arm is encased in a cylinder of solid crystal",
    "Caster's right arm is just like his left arm, facing backwards", "Caster's right arm resembles a horse's foreleg",
    ...
    "Caster's right thigh is as long as his entire left leg", "Caster's skin appears cracked like an old oil painting",
    "Caster's skin appears pitted like Swiss cheese", "Caster's skin appears to have been boiled",
    ...
    "Caster's skin can't be punctured by any mammal's teeth", "Caster's skin is blood red for 2d4-1 days",
    "Caster's skin is completely free of moles, scars, and blemishes", "Caster's skin is covered by human bite-marks",
    "Caster's skin is fireproof but tarnishes quickly in sunlight",
    "Caster's skin is infused with countless tiny glass nuggets", "Caster's skin is permanently stained by his blood",
    "Caster's skin is plaid from now on", "Caster's skin is suddenly the color of his hair",
    "Caster's skin ripples like a rain-spattered pond from now on", "Caster's skin varies in opacity from hour to hour",
    "Caster's skull becomes intensely magnetic", "Caster's speech doesn't match the movement of his lips",
    "Caster's speech is clearly audible to all within 50 yards",
    "Caster's speech is utterly unintelligible for 1d4 hours", "Caster's speech is utterly unintelligible to him",
    ...
    "Caster's spellbook can be folded to the size of a deck of cards", "Caster's spellbook can be judged by its cover",
    ...
    "Caster's spellbook can hold 4x the usual number of spells", "Caster's spellbook can only be read by females",
    "Caster's spellbook can only be read by males", "Caster's spellbook can only be read in near-total darkness",
    ...
    "Caster's spellbook contains 1d8 spells he's never seen before", "Caster's spellbook contains a mysterious key",
    ...
    "Caster's spellbook gives faulty warnings about his impending doom", "Caster's spellbook glows in the dark",
    "Caster's spellbook growls ominously when anyone else touches it", "Caster's spellbook has 60% Magic Resistance",
    "Caster's spellbook has a handle and can be used as a shield +1",
    "Caster's spellbook has a hideous face embossed on its cover",
    "Caster's spellbook has a secret, flask-shaped compartment", "Caster's spellbook has a surprise ending",
    "Caster's spellbook has no clear beginning or end", "Caster's spellbook has straps and can be worn as a backpack",
    ...
    "Caster's spellbook is as fragile as glass until sunset", "Caster's spellbook is bound in a sheathe of human skin",
    "Caster's spellbook is bound tightly shut in barbed wire", "Caster's spellbook is breaded and deep-fried",
    "Caster's spellbook is chrome-plated", "Caster's spellbook is covered in a thin shell of clay",
    "Caster's spellbook is coveted by a fire elemental", "Caster's spellbook is coveted by the undead",
    "Caster's spellbook is discovered to be a forgery", "Caster's spellbook is distributed as a mass-market paperback",
    "Caster's spellbook is drenched in goat's milk", "Caster's spellbook is ethereal to everyone except him",
    ...
    "Caster's spellbook is found to be just one part of a trilogy", "Caster's spellbook is glazed like a doughnut",
    "Caster's spellbook is gritty like sandpaper", "Caster's spellbook is impervious to acid",
    "Caster's spellbook is impervious to cold", "Caster's spellbook is indestructible but appears to be decaying",
    "Caster's spellbook is invisible for one hour each day",
    "Caster's spellbook is invisible to everyone except magic users",
    "Caster's spellbook is invisible to him unless his hair is wet", "Caster's spellbook is invisible when wet",
    "Caster's spellbook is laminated", "Caster's spellbook is long overdue at the library",
    ...
    "Caster's spellbook is sealed in a heavy wooden crate", "Caster's spellbook is sealed with a combination lock",
    ...
    "Caster's spellbook is tightly wrapped in cellophane", "Caster's spellbook is transparent while closed",
    "Caster's spellbook is unintelligible for 1d100 hours", "Caster's spellbook is waterproof",
    "Caster's spellbook is weightless while it's open", "Caster's spellbook is wrapped in festive paper and ribbons",
    "Caster's spellbook is written entirely in purple crayon",
    "Caster's spellbook leaves a trail of ash wherever it's carried", "Caster's spellbook randomly shuffles its pages",
    "Caster's spellbook reeks as though drenched in perfume", "Caster's spellbook reeks indelibly of mold and mildew",
    "Caster's spellbook reeks of manure while it's open", "Caster's spellbook reeks of rotting, mildewed cloth",
    ...
    "Caster's spellbook teleports 10d20 yards straight up", "Caster's spellbook teleports 1d4 feet straight down",
    ...
    "Caster's spellbook warms a five foot radius to a comfy 70°", "Caster's spellbook was here just a minute ago",
    "Caster's spellbook was instrumental in the downfall of an empire",
    "Caster's spellbook was stolen from a secret monastery",
    "Caster's spellbook was stolen from a traveler from the future", "Caster's spellbook weighs 1d100+100 pounds",
    "Caster's spellbook weighs as much as he does", "Caster's spellbook will combust if he opens it before dawn",
    ...
    "Caster's Strength increases by 1d6 for a like number of days", "Caster's Strength is halved",
    "Caster's Strength is halved until he's struck by fire-based magic",
    "Caster's Strength is rerolled hourly for the next 24 hours", "Caster's teeth appear shiny and black like obsidian",
    "Caster's teeth appear to drip blood for one week", "Caster's teeth become serrated and triangular like a shark's",
    "Caster's teeth can be broken by any physical force or object", "Caster's teeth can never become invisible",
    "Caster's teeth grow continuously, like a rodent's", "Caster's teeth shatter on contact with unrefined iron",
    "Caster's tongue is bifurcated along half of its length", "Caster's tongue is invisible during daylight hours",
    "Caster's tongue is removable", "Caster's voice becomes increasingly loud",
    "Caster's voice cracks like a teenage boy's voice", "Caster's voice inspires rage in dogs and wolves",
    "Caster's voice is hoarse and strained for 1d4 weeks",
    "Caster's voice issues from his right hand instead of his mouth",
    "Caster's voice makes people feel hostile and aggressive", "Caster's voice resonates in any gems nearby",
    "Caster's voice seems poorly matched to his age and sex",
    "Caster's voice seems to issue from 1d4 people around him", "Caster's voice seems to issue from his pockets",
    ...
    "Caster's voice sounds as if it's coming through a metal tube", "Caster's voice sounds like he's 1d100 years older",
    "Caster's voice sounds like that of each person to whom he speaks",
    "Caster's voice sounds like the braying of donkeys", "Caster's voice sounds like the buzzing of metal bees",
    "Caster's voice sounds like the honking of geese", "Caster's voice sounds like the sputtering of a clogged drain ",
    "Caster's waterskin is filled with mashed potatoes",
    "Caster's waterskin makes its contents taste brackish and foul",
    "Caster's weight increases tenfold while on a ladder", "Caster's weight increases tenfold while walking across ice",
    "Cooked meat is mildly poisonous to the caster", "Countless pine needles adhere tightly to the caster's skin",
    "Countless tiny wood chips swirl about the caster for 2d10 rounds",
    "Countless tiny worms cascade from caster's ears", "Crawling insects pour from caster's nostrils for 1d4 rounds",
    "Cryptic messages are embossed on the caster's chest and back", "Cryptic runes cover the caster's arms and hands",
    ...
    "Domestic cats react to caster with astonishing ferocity", "Each day at noon, caster's age is reduced by 50%",
    ...
    "Each day, caster can cause one foe to miss one attack", "Each day, caster can detach his head for up to one hour",
    "Each day, caster can digest up to half a pound of stone",
    "Each day, caster can magically cause 1d6 people to hate him", "Each day, caster can roar like a dragon one time",
    "Each day, caster can see through one door as if it were glass",
    "Each day, caster can Summon 1d10 minnows up to 1d4 times", "Each day, caster decides to worship a different deity",
    "Each day, caster demands to be called by a different name",
    "Each day, caster displays a new phobia that disappears by sunset",
    "Each day, caster finds 1d10 human eyeballs in his pocket", "Each day, caster finds 1d4 gold pieces in his pocket",
    ...
    "Each day, caster is 40% likely to crave garlic intensely", "Each day, caster is 50% likely to leave no footprints",
    ...
    "Each day, caster is immune to 1d6 hit points of damage", "Each day, caster loses 1d4 gold pieces",
    ...
    "Each day, caster must Save vs Will or his home explodes", "Each day, caster must tell at least one outrageous lie",
    ...
    "Each day, caster tells the same stupid joke about gnomes", "Each day, caster threatens to murder someone nearby",
    ...
    "Each day, caster wakes exhausted as if he just ran a marathon", "Each day, caster wakes in a pile of dry leaves",
    ...
    "Each day, caster wakes wearing a heavily powdered wig", "Each day, caster wakes wearing a straw hat",
    ...
    "Each day, caster's face is unbearably hideous for 1d10 minutes", "Each day, caster's hair grows 10% longer",
    "Each day, caster's height fluctuates plus or minus 1d100 percent",
    "Each day, caster's height fluctuates plus or minus 1d6 inches", "Each day, caster's home shrinks by 1%",
    ...
    "Each day, some part of caster's body falls off and regrows", "Each day, someone accuses the caster of grand theft",
    "Each day, someone accuses the caster of high treason",
    "Each day, someone accuses the caster of unwholesome practices", "Each day, someone accuses the caster or regicide",
    ...
    "Even in darkness, caster is visible as though in full daylight", "Every third tooth falls from caster's mouth",
    ...
    "Everyone thinks that the caster's use of magic is reckless", "Everyone thinks the caster to be vaguely unreliable",
    ...
    "Fine gold wire is visibly threaded through the caster's flesh", "Fire-based magic is invisible to the caster",
    ...
    "Foliage grows to entangle caster's feet if he stands still", "Food turns ethereal while the caster touches it",
    ...
    "Foul-smelling steam issues from the caster's nostrils", "Half of caster's body is as hairy as an ape",
    "Half of caster's body is immune to polymorph magic", "Half of caster's hair is replaced by very fine silver wire",
    "Holy symbols inspire dread in the caster", "Holy water boils on contact with caster's skin",
    "Honey flows through caster's veins instead of blood", "Horrific screams issue from the caster's spellbook",
    "Huge volumes of ectoplasm ooze from the caster's nostrils", "Icy winds buffet the caster for 2d8-1 days",
    ...
    "If caster ingests poison, his blood is corrosive to metal", "If caster ingests poison, his body shrinks by 1d100%",
    "If caster ingests poison, his fingers vanish", "If caster ingests poison, his teeth fall out",
    ...
    "If caster is now at full hit points, he vanishes for 1d12 hours", "If caster is now bleeding, he ages 10d10 years",
    ...
    "If caster is now bleeding, he gains 10,000 Experience Points", "If caster is now bleeding, he gains one level",
    ...
    "If caster is wearing a magic ring, he joins a bizarre cult", "If caster is wearing a magic ring, he misplaces it",
    ...
    "If caster is wearing a magic ring, it shines like the sun", "If caster is wearing a magic ring, it shrinks by 50%",
    ...
    "If caster is wearing a magic ring, that hand has Dexterity",
    ...
    "If caster swallows a hot coal, it's 10% likely to turn to diamond", "If caster tells a lie, he giggles",
    "If caster tells a lie, he's 40% likely to declare it outright",
    "If caster uses Detect Magic, he loses 1d6 hit points", "If caster uses Detect Magic, he's blinded for 1d10 rounds",
    ...
    "If cut open, caster is found to be a mechanical construct", "If cut open, caster is found to be completely hollow",
    "If cut open, caster is found to be filled with gold coins",
    "If cut open, caster is found to be filled with thick red foam", "If cut open, caster is found to be made of soap",
    ...
    "Meteoritic iron is powerfully toxic to the caster", "Mocking, spectral voices taunt the caster incessantly",
    "Money paid by caster appears to be obviously counterfeit", "Money paid by caster rapidly depreciates in value",
    ...
    "Nearest colony of bees identifies the caster as its queen", "Nearest dragon has a vendetta against the caster",
    ...
    "Nearest statue animates and begins stalking the caster", "Nearest tree falls on caster but doesn't make a sound",
    ...
    "Next attack on caster causes him to hallucinate for 1d4 hours", "Next attack on caster has a +10 ToHit bonus",
    ...
    "Next blade to cut the caster will never rust or go dull", "Next bridge that caster crosses turns to chocolate",
    ...
    "Next door opened by caster becomes sentient and animated", "Next door opened by caster can never be closed again",
    ...
    "Next door opened by caster is thereafter as clear as glass", "Next door opened by caster knocks him unconscious",
    ...
    "Next door opened by caster leads to a distant crypt", "Next door opened by caster leads to a distant mountaintop",
    ...
    "Next door opened by caster leads to a magical armory", "Next door opened by caster leads to a meat locker",
    ...
    "Next door opened by caster leads to goblin barracks", "Next door opened by caster leads to his home",
    ...
    "Next door opened by caster leads to this location", "Next door opened by caster leads to tomorrow but not back",
    "Next door opened by caster leads to war between 1d4 nations", "Next door opened by caster locks shut behind him",
    ...
    "Next door opened by caster turns into a vault door of heavy steel ", "Next enemy to wound caster also Charms him",
    "Next enemy to wound caster begins to resemble him",
    "Next enemy to wound caster can't harm him for 1d4 days thereafter",
    "Next enemy to wound caster disarms himself and runs away", "Next enemy to wound caster gains one level or hit die",
    "Next enemy to wound caster heroically defends him for 1d4 turns",
    "Next enemy to wound caster is attacked by vermin", "Next enemy to wound caster is healed of any current damage",
    ...
    "Next enemy to wound caster suffers an equivalent injury", "Next enemy to wound caster then attacks his own allies",
    "Next enemy wounded by caster becomes an ally for 1d6 rounds",
    "Next enemy wounded by caster becomes ethereal for 4d6 hours",
    "Next enemy wounded by caster becomes immune to fire", "Next enemy wounded by caster becomes invisible to caster",
    "Next enemy wounded by caster becomes king", "Next enemy wounded by caster begins to age one year per round",
    ...
    "Next enemy wounded by caster is attacked by feral cats", "Next enemy wounded by caster is Healed",
    ...
    "Next enemy wounded by caster must Save or Disintegrate", "Next enemy wounded by caster teleports 1d100 miles",
    ...
    "Next enemy wounded by caster turns to stone over 1d10 rounds", "Next enemy wounded by caster was never born",
    ...
    "Next horse ridden by caster turns hollow and made of wood", "Next horse ridden by caster turns into a cow",
    ...
    "Next meal prepared by caster tastes strongly of manure", "Next meal prepared by caster tastes strongly of soap",
    ...
    "Next potion imbibed by caster glues his mouth shut ", "Next potion imbibed by caster has no effect whatsoever",
    ...
    "Next potion imbibed by caster induces pacifism", "Next potion imbibed by caster induces phenomenal hallucinations",
    ...
    "Next potion imbibed by caster is actually a living thing", "Next potion imbibed by caster is incredibly addictive",
    "Next potion imbibed by caster is powerfully emetic", "Next potion imbibed by caster is pure human blood",
    ...
    "Next potion imbibed by caster makes him crave raw meat", "Next potion imbibed by caster makes him forget his name",
    ...
    "Next potion imbibed by caster makes his face invisible", "Next potion imbibed by caster makes his flesh invisible",
    ...
    "Next potion imbibed by caster rotates his feet 180°", "Next potion imbibed by caster sets his hair ablaze",
    ...
    "Next potion imbibed by caster strikes him bald for one year", "Next potion imbibed by caster tastes like lamp oil",
    "Next potion imbibed by caster teleports him to his home",
    "Next potion imbibed by caster throws him 1d4 days into the future",
    "Next potion imbibed by caster triggers a Chaos Burst", "Next potion imbibed by caster turns him into 1d100 frogs",
    ...
    "Next potion imbibed by caster turns his hands into feet", "Next potion imbibed by caster turns his head to a cube",
    ...
    "Next puddle stepped in by caster throws him 1d20 yards", "Next puddle stepped in by caster turns to blood",
    ...
    "Next sword that wounds caster then ignites and burns like paper", "Next sword that wounds caster turns to gold",
    "Next sword that wounds caster vanishes for 1d8 days", "Next sword that wounds caster was coated with deadly venom",
    ...
    "Next tree touched by caster crumbles to ash in minutes", "Next wound inflicted by caster can't heal without magic",
    "Next wound inflicted upon caster can't be healed magically", "No animal will allow the caster to ride it",
    ...
    "No one within 100 miles trusts caster enough to lend him money", "Non-humanoid mammals are invisible to caster",
    "Non-humanoid mammals react badly to the caster for 1d10 days",
    "Non-magical blades inflict bludgeoning damage upon caster", "Non-magical rodents are invisible to the caster",
    ...
    "Once per week, caster can strip one tree of all leaves", "Once per week, caster can summon 1d20 cockroaches",
    ...
    "One of caster's arms appears to be stripped of all flesh", "One of caster's arms becomes as limber as a snake",
    "One of caster's arms becomes undead", "One of caster's arms can be removed for up to 1d4 turns per day",
    "One of caster's arms can't be cut by magical blades", "One of caster's arms disappears until sunset tomorrow",
    "One of caster's arms ignites", "One of caster's arms is as pale as an albino's",
    "One of caster's arms is encased in a tight steel sheath", "One of caster's arms is impervious to magical cold",
    "One of caster's arms is only an illusion", "One of caster's arms is scarred as though badly burned by acid",
    "One of caster's arms now juts from the center of his chest", "One of caster's arms oozes fetid slime",
    "One of caster's arms resembles a small, gnarled branch", "One of caster's arms shrivels to a dry husk",
    "One of caster's arms sprouts dozens of tiny, ugly feelers", "One of caster's arms turns to solid silver",
    "One of caster's eyes bulges like a fish eye", "One of caster's eyes doubles in size",
    "One of caster's eyes doubles in size; the other shrinks by 50%",
    "One of caster's eyes glows with infernal radiance", "One of caster's feet disintegrates",
    "One of caster's feet is replaced by an off-balance wheel", "One of caster's feet reforms into a perfect sphere",
    "One of caster's feet refuses to come anywhere near the other",
    "One of caster's hands doubles in size; the other shrinks by 50%", "One of caster's hands is as durable as steel",
    "One of caster's hands is green and scaly like a lizard's claw", "One of caster's hands is susceptible to rust",
    ...
    "One side of caster's body adopts a mirror-bright sheen", "One side of caster's body ages 2X as fast as the other",
    "One side of caster's body appears to be naked by firelight", "One side of caster's body changes color each hour",
    "One side of caster's body is as hairy as an ape", "One side of caster's body is blurred as if seen through ice",
    "One side of caster's body is immune to magic cast by him",
    "One side of caster's body is immune to normal missiles", "One side of caster's body is invulnerable to fire",
    "One side of caster's body is paralyzed for 1d4 rounds",
    "One side of caster's body is rendered invisible for 1d4 weeks",
    "One side of caster's body looks like a photo negative", "One side of caster's body shrinks by 10%",
    ...
    "People not in the caster's presence tend to forget about him ", "Powerful jets of air blow from the caster's ears",
    "Predators react to the caster as if he were a small rabbit",
    "Railroad tracks run straight from here to the caster's home",
    "Rapturous shrieks fill the air when caster removes a hat", "Raw meat is invisible to the caster",
    "Right now, caster can teleport up to 1d10 miles one time",
    "Rocks and boulders express a vague fondness for the caster",
    "Rope breaks 2X as readily while the caster is using it", "Rope is 2X as strong while the caster is using it",
    "Scavengers and carrion birds react to caster as if he were dead",
    "Short, bony spikes sprout from caster's knuckles", "Small objects carried by caster seem 10X as heavy to him",
    "Smoke billows from the caster's head as from a coal chimney",
    "Some deity has a personal vendetta against the caster",
    "Some deity takes a personal interest in the caster's life", "Some subterranean race annexes caster's home",
    ...
    "The next spell used against caster automatically fails", "The pages of caster's spellbook are indestructible",
    ...
    "The rear half of caster's body appears to be made of glass", "The rear half of caster's body is invisible",
    ...
    "To the caster, everyone looks and sounds exactly like him", "To the caster, everyone smells like a rotting corpse",
    "To the caster, the weather always appears overcast and gloomy",
    "To the caster, the weather always appears to be the same", "Tomorrow, caster can speak all languages until noon",
    ...
    "Tomorrow, caster finds a piece of anachronistic technology", "Tomorrow, caster finds a ruby as large as his head",
    "Tomorrow, caster finds a secret Gate to the Astral Plane",
    "Tomorrow, caster finds a small pouch full of counterfeit rubies",
    "Tomorrow, caster finds a small pouch full of diamonds", "Tomorrow, caster finds a small pouch full of scorpions",
    "Tomorrow, caster finds a small pouch full of strong acid", "Tomorrow, caster finds a small pouch full of teeth",
    ...
    "Tomorrow, caster has absolutely no desire to use magic", "Tomorrow, caster is unable to cast magic before noon",
    ...
    "Tomorrow, caster meets someone who claims to be him", "Tomorrow, caster meets someone who claims to be his father",
    ...
    "Tomorrow, caster saves the life of a notorious villain", "Tomorrow, caster saves the life of someone important",
    ...
    "Tomorrow, caster wakes as if he's spent a month in the desert", "Tomorrow, caster wakes at this location",
    ...
    "Tomorrow, caster wakes early and races back to this location", "Tomorrow, caster wakes embarrassingly drunk",
    "Tomorrow, caster wakes in a coil of dried and sinuous vines", "Tomorrow, caster wakes in a full-length body cast",
    "Tomorrow, caster wakes in the branches of a tall tree", "Tomorrow, caster wakes on the bank of the River Styx",
    "Tomorrow, caster wakes reeking of garlic and raw meat",
    "Tomorrow, caster wakes seated in the throne of the nearest king",
    "Tomorrow, caster wakes standing atop a tall pole", "Tomorrow, caster wakes standing in a barrel of chum",
    ...
    "Trees and bushes express open hostility toward the caster", "Ugly thorns sprout from the caster's cheekbones",
    "Undead have commandeered caster's home while he's been away",
    "Undead skeletons react to caster as if he were one of them",
    "Undead tend to ignore the caster until he acts against them", "Undead tend to laugh in the caster's presence",
    "Vile tentacles sprout from the caster's face", "Viscous pus oozes from the caster's orifices until sunset",
    ...
    "When caster dies, his corpse appears riddled by gunfire", "When caster dies, his corpse attacks the nearest Elf",
    ...
    "When caster dies, his corpse is elected to public office", "When caster dies, his corpse melts like a snowman",
    ...
    "When caster dies, his corpse turns to densely packed salt", "When caster dies, his corpse turns to solid bronze",
    "When caster dies, his corpse weighs as much as lead", "When caster dies, his heart assumes a life of its own",
    "When caster dies, his killer is thrown 1d20 days into the future",
    "When caster dies, his last word is \"Rosebud\"",
    "When caster dies, his name becomes synonymous with treachery", "When caster dies, his skeleton turns to glass",
    "When caster dies, his skull turns to wood", "When caster dies, his spellbook burns to cinders in 1d4 rounds",
    ...
    "When caster dies, the nearest town is evacuated", "When caster dies, the nearest tree falls on his corpse",
    ...
    "When caster is angry, he foams at the mouth like a rabid dog", "When caster is angry, he turns bright green",
    ...
    "When caster is surprised, his head briefly doubles in size", "When caster is surprised, his head spins 360°",
    ...
    "When caster next enters a lake, his clothing inflates", "When caster next enters a lake, his clothing vanishes",
    ...
    "When caster next enters a town, it's attacked by goblins", "When caster next enters a town, it's besieged by orcs",
    "When caster next enters a town, it's overrun by feral dogs",
    "When caster next enters a town, it's renamed after him", "When caster next enters a town, its population doubles",
    ...
    "When caster next enters his home, he ages 1d10 years", "When caster next enters his home, he ages 1d10 years",
    ...
    "When caster next teleports, he arrives bound and gagged", "When caster next teleports, he arrives fully Healed",
    ...
    "When caster next uses magic, his clothes turn to paper", "When caster next uses magic, his hands double in size",
    ...
    "When caster teleports, he arrives in an embarrassing posture", "When caster teleports, he arrives invisible",
    "When caster teleports, he arrives ravenously hungry", "When caster teleports, he arrives upside down",
    ...
    "When next struck by magic, caster triggers a Chaos Burst", "When reduced to one hit point, caster ages 2d10 years",
    ...
    "While caster sleeps, he appears to be a perfect cube", "While caster sleeps, he appears to melt like a wax dummy",
    "While caster sleeps, he freezes solid but thaws before waking",
    "While caster sleeps, his allies must Save or forget who he is",
    "While caster sleeps, his arms and legs retract into his torso", "While caster sleeps, his body is translucent",
    "While caster sleeps, his body retracts into his head", "While caster sleeps, his clothing and gear are invisible",
    ...
    "While caster sleeps, thousands of insects swarm over his body", "While indoors, caster appears to be 5% larger",
    ...
    "A second, identical skeleton appears in the target's body", "A small fire blazes harmlessly in the target's mouth",
    "A tall picket fence encircles the target", "A tentacle slithers from a nearby cave to grasp the target",
    ...
    "Ambient temperature always feels 50° colder to target", "Ambient temperature rises 10° when target is angry",
    ...
    "Any clothing or armor now worn by target shrinks by 30%", "Any coins that target is now carrying double in value",
    "Any coins that target is now carrying shrink by 50%", "Any coins that target is now carrying turn to cheese",
    ...
    "Any fire damage suffered by target leaves cryptic scars", "Any gems now carried by target are cursed against him",
    "Any gold now carried by target belongs to a dragon", "Any gold now carried by target combusts like tinder",
    ...
    "Any metal now in target's possession turns to lead", "Any metal now in target's possession turns to mercury",
    ...
    "Any nearby undead now look disturbingly like the target", "Any nearby undead obey the target for 1d8 rounds",
    ...
    "Anyone cutting target with a blade is briefly blinded", "Anyone cutting target with a blade is briefly invisible",
    ...
    "Anyone cutting target with a blade teleports 1d6 feet", "Anyone cutting target with a blade thinks he's an ally",
    ...
    "As target is wounded more severely, he's less likely to sense it", "At any crossroads, target feels utterly lost",
    "At any crossroads, target is inclined to turn back", "At any crossroads, target is inclined to turn left",
    ...
    "At dawn tomorrow, target is abducted by an undead horde", "At dawn tomorrow, target must Save or age 1d1000 years",
    ...
    "Blades are magically blunted while the target wields them", "Blades are unbreakable while the target wields them",
    ...
    "Both of target's arms are now on the same side of his body", "Both of target's arms jut from the same shoulder",
    ...
    "Colored streamers shoot from target's ears for 2d6 rounds", "Colored streamers shoot from target's nostrils",
    ...
    "Creatures Summoned in target's presence worship him as a god", "Dew and condensation inspire fear in the target",
    ...
    "During battle, target quacks like an enormous duck", "During battle, target repeatedly chants a naughty limerick",
    "During battle, target's allies are invisible to him", "During battle, target's allies can't speak to him",
    "During battle, target's allies don't recognize him", "During battle, target's clothes and gear are invisible",
    "During battle, target's clothes appear to burst into flame",
    "During battle, target's clothes billow with foul smoke", "During battle, target's clothes moan like ghosts",
    ...
    "Each day, target can become an illusion for 1d4 rounds", "Each day, target can command 1d4 non-magical bears",
    ...
    "Each day, target can turn into a horse for up to 1d4 hours", "Each day, target can walk on water up to 100 yards",
    "Each day, target is 10% likely to lose one finger or toe", "Each day, target is immune to one electrical attack",
    ...
    "Each day, target's skin is a different vibrant color", "Each of target's feet acquires argumentative intelligence",
    "Each of target's feet is chained to his neck", "Each of target's feet tries to race away in a different direction",
    ...
    "Each time target is injured, he must Save or go blind", "Each time target is injured, howls like a wolf",
    ...
    "Everyone now within 10 yards of target is disarmed", "Everyone now within 10 yards of target is invisible to him",
    "Everyone now within 10 yards of target is knocked down", "Everyone now within 10 yards of target is stricken bald",
    ...
    "Fire is intensely beautiful and attractive to the target", "Fire is invisible to the target",
    ...
    "Half of target's body is indestructible for 2d4 days", "Half of target's body is infected with lycanthropy",
    "Half of target's body polymorphs into some kind of animal",
    "Half of target's body resembles half of the caster's body", "Half of target's body shrinks by 25%",
    "Half of target's body suffers from advanced leprosy",
    "Half of target's body turns invisible while in direct sunlight",
    "Half of target's fingers are permanently invisible", "Half of target's head appears to be made of crystal",
    "Half of target's head appears to be made of metal", "Half of target's head appears to be stripped of flesh",
    "Half of target's head explodes, killing him messily", "Half of target's head is covered in fine gold scales",
    "Half of target's head is covered in fragrant blue moss",
    "Half of target's head vanishes, but he's basically unharmed", "Half of target's limbs become donkey's limbs",
    ...
    "If reduced to five or fewer hit points, target goes berserk", "If reduced to one hit point, target becomes a lich",
    ...
    "If target has a shield, it now weighs 500 pounds", "If target has a shield, it vanishes, taking his arm with it",
    ...
    "If target has any leather, he sprouts horns like a bull", "If target has any leather, he's soaked with lamp oil",
    ...
    "If target is beheaded, his body deflates like a balloon", "If target is beheaded, his body seeks political office",
    "If target is beheaded, his body still lives a long and happy life",
    "If target is beheaded, his body tries to behead his slayer", "If target is beheaded, his head becomes undead",
    ...
    "If target is carrying any wood, it smolders until sunset", "If target is carrying any wood, it turns to sawdust",
    ...
    "If target is now standing, his legs double in length", "If target is now wet, he suffers sudden heat exhaustion",
    ...
    "If target is slain, his soul can't leave his body", "If target is slain, his soul is sent to the wrong plane",
    ...
    "If target is wearing armor, he's soaked with lamp oil", "If target is wearing armor, he's struck by lightning",
    "If target is wearing armor, it clatters noisily in the dark",
    "If target is wearing armor, it constricts painfully about him",
    "If target is wearing armor, it has a +2 AC bonus until sunrise", "If target is wearing armor, it heats to 500°",
    "If target is wearing armor, it rattles violently for 1d10 hours",
    "If target is wearing armor, it teleports 2d6 yards", "If target is wearing armor, it turns invisible",
    ...
    "If target lights a fire, his clothing ignites", "If target loses a finger, he deliberately cuts off another one",
    ...
    "Metal weapons strike sparks against target's body like flint", "Music causes the target to weep tears of blood",
    "Music inspires savage bloodlust in the target", "Nearest horse adopts the target's personality",
    ...
    "Nearest zombie attacks the target until one is destroyed", "Nearest zombie follows the target everywhere",
    ...
    "Next 1d4 creatures slain by target very rapidly decompose", "Next 1d4 hours seem like a dream to the target",
    "Next 1d4 rounds seem to last a full day to the target", "Next 2d4 spells cast at target are invisible in effect",
    ...
    "Next horse touched by target can never again be ridden by mortals", "Next horse touched by target shrinks by 75%",
    ...
    "Next person to wound the target inflicts maximum damage", "Next person to wound the target is attacked by vermin",
    ...
    "Next puddle stepped in by target turns to glass", "Next time target touches a tree, he must Save or turn to wood",
    ...
    "Next weapon to wound target is crushed into a small cube", "Next weapon to wound target is engraved with his name",
    ...
    "Next weapon to wound target is thereafter +1 to hit him", "Next weapon to wound target is thereafter +4 ToHit him",
    ...
    "Next weapon to wound target turns out to be a mighty artifact", "Next weapon to wound target turns to stone",
    "Next weapon to wound target vanishes for 1d10 rounds", "Next weapon to wound target was forged from his own bones",
    "Next weapon to wound target was forged on a distant world", "No one speaks to target for 2d4-1 days",
    ...
    "Non-magical animals react to the target as if he were undead", "Normal voices seem deafeningly loud to the target",
    "Normal voices seem ghostly and haunting to the target", "Normal voices seem to echo imperiously to the target",
    ...
    "Once per day, target can make a sound like a cannon", "Once per day, target can turn all wheels nearby invisible",
    ...
    "One of target's arms is as durable as steel, but only when wet", "One of target's arms is bent like a corkscrew",
    ...
    "One of target's arms turns into a small replica of his leg", "One of target's arms turns to a lion's foreleg",
    "One of target's eyes migrates to the back of his head", "One of target's feet is fused into an anvil",
    ...
    "One of target's hands can pass through solid steel", "One of target's hands can pass through stone",
    ...
    "One of target's hands is impervious to magical cold", "One of target's hands is invisible to undead",
    "One of target's hands is shaped like an orangutan's hand", "One of target's hands migrates to the top of his head",
    "One of target's hands oozes a viscous liquid like sap",
    "One of target's hands shines like a beacon if clenched in a fist", "One of target's hands turns into a hoof",
    "One of target's hands turns into a perfect cube of granite",
    "One of target's hands turns into a replica of a rabbit's head", "One of target's hands turns into sponge",
    ...
    "One of target's legs and one of his arms shrink by 50%", "One of target's legs and one of his arms turn invisible",
    "One of target's limbs acquires intelligence hostile to him",
    "One of target's limbs always seems to be soaked with milk", "One of target's limbs appears to be made of diamond",
    ...
    "One of target's limbs can be Dispelled as an illusion", "One of target's limbs can never be rendered invisible",
    "One of target's limbs can't be armored in combat",
    "One of target's limbs develops an intense hatred for the others",
    "One of target's limbs falls off and tries to escape", "One of target's limbs glows bright blue in the dark",
    "One of target's limbs is affected as by the spell Slow", "One of target's limbs is as hard as steel during combat",
    "One of target's limbs is clearly artificial", "One of target's limbs is controlled by caster for 1d10 rounds",
    "One of target's limbs is covered in feathers", "One of target's limbs is entirely indestructible",
    ...
    "One of target's limbs is paralyzed for 1d6 days", "One of target's limbs is replaced by a hideous tentacle",
    "One of target's limbs is responsible for genocide", "One of target's limbs is wanted for murder",
    ...
    "One of target's limbs seems to belong to a different species", "One of target's limbs shrinks by 1d4% per day",
    "One of target's limbs suffers intense pain if he uses magic", "One of target's limbs turns as green as grass",
    "One of target's limbs turns to a tree limb", "One of target's limbs turns to solid gold",
    ...
    "Ordinary water is incredibly impressive to the target", "People often mistake the target for a hated enemy",
    ...
    "Printed text appears hopelessly garbled while target is nearby", "Rope hisses like a snake while target uses it",
    ...
    "Sparks fly from target's ears as from a grindstone", "Sparks fly from target's eyes when he draws a weapon",
    "Sparks fly from target's fingertips when he's angry", "Sparks fly from target's nostrils as he speaks",
    "Spectral voices echo everything that the target says", "Suddenly 1d4 people appear and attack the target",
    "Suddenly 1d4 people appear and offer trinkets to the target",
    "Suddenly 1d4 people appear and try to lasso the target", "Suddenly 1d4 people appear and worship the target",
    "Suddenly 1d4 people nearby resemble the target", "Suddenly 1d4 people nearby wish to assassinate the target",
    "Sulfurous mud oozes from target's clothes for 1d8 hours", "Summoned creatures are at +2 ToHit the target",
    "Summoned creatures are Hasted in the target's presence", "Summoned creatures are invisible to the target",
    "Summoned creatures are Slowed in the target's presence",
    "Summoned creatures can make no sound in the target's presence",
    "Summoned creatures covet the target's possessions", "Summoned creatures ignore and are unaffected by the target",
    ...
    "Swords can't come within ten feet of the target for 1d4 rounds", "Swords in target's presence drip with his blood",
    ...
    "Target acquires scars to match any wounds he inflicts on others", "Target acts as though he doesn't really exist",
    ...
    "Target acts generally like a jerk toward his friends and allies", "Target acts like a child for 10d10 rounds",
    "Target acts like a horse for 1d4 turns", "Target adds 1d4 to each attribute score for 2d12 hours",
    ...
    "Target ages 1d4 years each time he says his name", "Target ages 1d4 years each time he's cut by a claw or fang",
    ...
    "Target ages one year per round spent in the caster's presence", "Target ages plus or minus 1d10 years each hour",
    "Target always attacks the foe he's least likely to defeat", "Target always fails to consider the consequences",
    ...
    "Target and nearest zombie are often mistaken for each other", "Target and nearest zombie exchange bodies",
    "Target and nearest zombie form an unholy alliance", "Target and the nearest horse exchange bodies",
    ...
    "Target appears to be wearing a cloak of shimmering fire", "Target appears to have been assembled out of bamboo",
    ...
    "Target asserts that a vast conspiracy is out to get him", "Target asserts that all contracts are null and void",
    ...
    "Target asserts that he and the caster have been allies for years", "Target asserts that he can command undead",
    ...
    "Target asserts that he can identify poisons by tasting them", "Target asserts that he can issue divine edicts",
    ...
    "Target asserts that he can travel between planes at will", "Target asserts that he can travel freely through time",
    "Target asserts that he can turn diamonds into coal by eating them", "Target asserts that he died 1d4 rounds ago",
    "Target asserts that he died 1d4 years ago", "Target asserts that he has a key that unlocks his skull",
    "Target asserts that he has any number of non-verifiable maladies",
    "Target asserts that he has only 1d4 hours to live", "Target asserts that he has the power to bestow godhood",
    ...
    "Target asserts that he intends to raze the nearest city", "Target asserts that he is descended from mighty kings",
    "Target asserts that he is the caster's father", "Target asserts that he knows exactly who is destined to kill him",
    ...
    "Target asserts that he'll combust if he gets wet", "Target asserts that he'll combust if he reads a map",
    ...
    "Target asserts that he'll die if he opens his eyes", "Target asserts that he'll die if he sees a rainbow",
    "Target asserts that he'll die if he sees his own blood",
    "Target asserts that he'll die if he speaks his native language",
    "Target asserts that he'll die if he spends any money", "Target asserts that he'll die if he stops dancing",
    "Target asserts that he'll die if he stops talking",
    "Target asserts that he'll die if he touches anyone else's blood",
    "Target asserts that he'll die if he touches gold", "Target asserts that he'll die if he touches ice",
    "Target asserts that he'll die if he touches metal", "Target asserts that he'll die if he uses any magic items",
    "Target asserts that he'll die if he uses the word \"the\"",
    "Target asserts that he'll die if he's cut by a magical blade",
    "Target asserts that he'll die if someone tells him to die", "Target asserts that he'll die in 1d4 rounds ",
    "Target asserts that he'll die of biliousness", "Target asserts that he'll die the next time he eats",
    ...
    "Target asserts that he's an avatar of the caster's deity", "Target asserts that he's been fatally wounded",
    ...
    "Target asserts that he's hunting a monster from the distant past", "Target asserts that he's immune to magic",
    ...
    "Target asserts that he's supernaturally beautiful", "Target asserts that he's the embodiment of a mighty artifact",
    "Target asserts that he's the mightiest warrior in the world",
    "Target asserts that he's the world's most powerful magic user",
    "Target asserts that he's transforming into some kind of beast", "Target asserts that he's unspeakably ugly",
    "Target asserts that he's water soluble", "Target asserts that his actions are in accordance with prophecy",
    ...
    "Target asserts that his flesh is harder than iron", "Target asserts that his god owes him a big favor",
    ...
    "Target asserts that his touch can induce madness", "Target asserts that his worst injuries are just a flesh wound",
    ...
    "Target asserts that the king owes him a huge favor", "Target asserts that the wages of sin aren't really death",
    ...
    "Target attacks anyone he sees using a magic item", "Target attacks anyone who attacks the caster",
    "Target attacks anyone who sees him using a magic item", "Target attacks anyone who speaks ill of the caster",
    ...
    "Target attacks the next person nearby who spends money", "Target attacks the next person who address him by name",
    "Target attacks the next person who draws a weapon nearby",
    "Target attacks the toughest, most dangerous creature he can see",
    "Target attempts to acquire the caster's spellbook", "Target attempts to disembowel himself with his bare hands",
    "Target attempts to ingest any ink he sees", "Target attempts to mimic the caster's every more",
    "Target attempts to strangle all trees within 100 yards", "Target attempts to strangle himself with his bare hands",
    "Target attracts all manner of mutants and abominations", "Target attracts leeches, maggots, slugs, and snails",
    "Target babbles incoherently for 2d10 rounds", "Target barks like a dog when he thinks he sees magic",
    "Target becomes a devoted acolyte of some fringe religion", "Target becomes an albino",
    ...
    "Target befriends a statue and thinks it gives him good advice", "Target befriends one of the caster's allies",
    "Target befriends the toughest, most dangerous creature he can see",
    "Target begs someone to bite off 1d10 of his fingers", "Target begs someone to set him ablaze",
    "Target believes anything the caster says to him", "Target believes everything that he says",
    ...
    "Target believes that his allies are conspiring to rob him", "Target believes that nearly everyone is lying to him",
    ...
    "Target briefly becomes invisible to anyone who wounds him", "Target briefly resembles anyone who wounds him",
    "Target briefly resembles the target each time he's wounded",
    "Target bursts into flame the next time he's totally submerged",
    "Target can appear to be covered in moss and lichens at will", "Target can appear to be twice his true age at will",
    "Target can appear totally nondescript and unremarkable at will",
    "Target can be commanded by the nearest dragon at will", "Target can be injured by arrows, but they can't kill him",
    ...
    "Target can be injured by water, but it can't kill him", "Target can be Summoned by the nearest dragon at will",
    ...
    "Target can change the color of his face 2d4 times per day", "Target can climb like a monkey",
    ...
    "Target can Command one person now nearby to attack", "Target can Command one person now nearby to tell the truth",
    "Target can Command the nearest dragon, just once",
    "Target can control caster like an undead skeleton for 1d6 rounds",
    "Target can delay his voice by 1d4 rounds, 1d4 times per day", "Target can detect counterfeit gems by tasting them",
    "Target can digest soil as readily as meat", "Target can discern magic items by bleeding on them",
    "Target can discern magic items by tasting them", "Target can dismiss a total of 20HD worth of elementals",
    "Target can divine the caster's exact location 1d4 times per day",
    "Target can do nothing but scream for 1d8 rounds", "Target can easily be persuaded to disarm himself",
    ...
    "Target can ingest and digest small quantities of bone", "Target can ingest and digest small quantities of coral",
    "Target can ingest and digest small quantities of glass", "Target can ingest and digest small quantities of gold",
    "Target can ingest and digest small quantities of iron",
    "Target can ingest and digest small quantities of lamp oil",
    "Target can ingest and digest small quantities of lead", "Target can ingest and digest small quantities of poison",
    "Target can ingest and digest small quantities of stone", "Target can ingest and digest small quantities of wood",
    ...
    "Target can leap one yard straight up per point of Charisma", "Target can locate any bear within one mile",
    ...
    "Target can make one of his hands double in size at will", "Target can mask his scent at will",
    "Target can never again address anyone by name", "Target can never again speak or write his own name",
    ...
    "Target can never become invisible to anyone who knows his name", "Target can never become invisible without dying",
    "Target can no longer conceal his astonishing halitosis",
    "Target can no longer conceal his disdain for magic users", "Target can no longer conceal his fear of combat",
    "Target can no longer conceal his hatred of Dwarves ", "Target can no longer conceal his insatiable cannibalism",
    ...
    "Target can readily be convinced that he doesn't really exist", "Target can recognize faces only 10% of the time",
    ...
    "Target can retract his ears into his skull at will", "Target can retract one of his limbs into his body at will",
    ...
    "Target can speak only in rhyme while his weapon is drawn", "Target can speak only in whale song for 1d4 hours",
    "Target can speak the language of bears, but they don't listen", "Target can speak with flies and gnats",
    "Target can speak with livestock but henceforth smells like manure", "Target can speak with monkeys and apes",
    "Target can speak with one corpse per week, but it lies to him", "Target can speak with one tree per week",
    "Target can speak with worms and slugs", "Target can stride unimpeded in knee-deep snow",
    ...
    "Target can teleport 1d4 miles randomly, once per day", "Target can teleport at will but arrives 1d20 days later",
    "Target can teleport at will but arrives with only one hit point",
    "Target can teleport at will but is 50% likely to die on arrival", "Target can teleport half of his body at will",
    "Target can teleport one person nearby to the target's home",
    "Target can teleport to the caster's location once per month",
    "Target can teleport to this location once per month", "Target can track the caster with astonishing accuracy",
    ...
    "Target can write but not speak or read 1d6 additional languages", "Target can't attack anyone for 2d4 rounds",
    "Target can't attack anyone until he wounds himself", "Target can't attack anyone who doesn't know target's name",
    ...
    "Target can't be burned by acid if he cuts off both of his thumbs", "Target can't be burned by molten metal",
    ...
    "Target can't be cut by manufactured stone blades", "Target can't be detected by invisible creatures",
    "Target can't be detected by magical attempts at scrying",
    "Target can't be detected by magical scrying while naked in a tree",
    "Target can't be harmed by bludgeons between dawn and noon", "Target can't be harmed by bludgeons for 2d10 rounds",
    "Target can't be harmed by boiling oil or pitch", "Target can't be harmed by invisible creatures at night",
    ...
    "Target can't be harmed by magical fire while underwater", "Target can't be harmed by natural lightning",
    "Target can't be injured by wooden weapons while naked", "Target can't be injured by wooden weapons while sleeping",
    ...
    "Target can't be killed by any male creature for 1d4 weeks", "Target can't be killed during the next 2d12 hours",
    ...
    "Target can't be magically detected by anyone of the same sex", "Target can't be slain except while sleeping",
    "Target can't be slain if he remains within 10 yards of this spot", "Target can't be slain while sleeping",
    "Target can't be stunned by any blow to the head", "Target can't be surprised if he has a snowball in each hand",
    "Target can't be surprised if he has an eyeball in his mouth",
    "Target can't be surprised if he's wearing a carnation", "Target can't be surprised while at full hit points",
    "Target can't be wounded by metal weapons until sunset tonight",
    "Target can't be wounded by metal weapons while barefoot", "Target can't breathe for 2d10 rounds",
    ...
    "Target can't come within 10 feet of any fire now burning", "Target can't come within 10 yards of the caster",
    "Target can't come within one mile of his home", "Target can't come within one mile of the caster",
    ...
    "Target can't digest anything that's been dead longer than a day", "Target can't digest cooked meat",
    ...
    "Target can't draw his weapon within 100 yards of this spot", "Target can't hear echoes",
    "Target can't hear his own voice", "Target can't hear his own voice except while his eyes are closed",
    ...
    "Target can't hear the voice of anyone within 10 feet of him", "Target can't hear voices for 2d4-1 days",
    "Target can't ignite any fire unless his hair is soaking wet", "Target can't ignite any fire unless it's snowing",
    "Target can't ignite any fire while underground", "Target can't ignite any fire while wearing clothes",
    "Target can't leave this spot until he wounds himself", "Target can't lie, equivocate, or tell half-truths",
    "Target can't move more than 10 yards from the caster",
    "Target can't pass through doorways while at full hit points", "Target can't say anyone's name",
    ...
    "Target can't see or hear magical creatures for 2d6 days", "Target can't see or hear metal objects for 3d8 hours",
    "Target can't see sunlight or reflected sunlight", "Target can't sleep unless he first eats a handful of soil",
    "Target can't sleep unless he has his weapon in hand", "Target can't sleep unless he's standing up",
    "Target can't sleep until he fells the tallest tree in the kingdom",
    "Target can't sleep until he gives away all of his armor",
    "Target can't sleep within 10 feet of another sleeping person", "Target can't speak except while barefoot",
    "Target can't speak except while brandishing a weapon", "Target can't speak for 1d20 turns",
    "Target can't speak to anyone more than 20 feet from him", "Target can't speak to anyone who addresses him by name",
    "Target can't speak unless he wears a cloth over his face", "Target can't speak unless he's brandishing a weapon",
    "Target can't speak unless his hair is wet", "Target can't speak until after he has eaten his next full meal",
    "Target can't speak until his blood is next drawn", "Target can't speak until the caster says his own name",
    "Target can't speak while at full hit points", "Target can't speak while at full hit points",
    "Target can't speak while wielding a weapon", "Target can't use any form of rope or chain longer than he is tall",
    "Target can't use any items containing metal for 2d4-1 days",
    "Target can't use any magic items containing wood for 2d4-1 days", "Target can't use any magic items for 1d4 days",
    "Target can't use any magic items older than he is", "Target can't use his hands or any utensils while eating",
    "Target can't voluntarily pass through doorways unless naked",
    "Target can't walk until the caster says his own name", "Target can't walk while carrying gold",
    "Target can't wield any weapon containing metal for 1d4 days", "Target can't wield any weapon in his dominant hand",
    "Target can't wield any weapon that hasn't drawn his blood",
    "Target can't wield any weapon within 1d4 miles of this spot", "Target can't wound anyone who hasn't wounded him",
    "Target carves a tiny notch in every tree he passes",
    "Target challenges his closest ally to single combat to the death", "Target chants nonsensically for 2d10 rounds",
    "Target clatters when he walks like a barrel full of pots and pans",
    "Target collapses into a fetal position for 1 turn", "Target combusts if he uses magic within the next 1d4 turns",
    "Target combusts if his weapon is thrown into a river", "Target comes into possession of a world-shaking artifact",
    ...
    "Target confesses to genocide but can produce no evidence of it", "Target confesses to rampant kleptomania",
    "Target constantly boasts about his prowess in all things", "Target constantly exudes fragrant soap suds",
    "Target continuously speaks to an imaginary ally", "Target coughs incessantly, but his actions are unimpaired",
    "Target craves hay and has a long tail like a horse", "Target craves twigs and bark after every battle",
    ...
    "Target demands that his friends and allies pay him tribute", "Target develops a pronounced stutter",
    ...
    "Target disgorges 1d10 cubic feet of damp, sticky rice", "Target disgorges 1d10 pounds of feathers",
    "Target disgorges 1d10 pounds of hallucinogenic mushrooms",
    "Target disgorges 1d100 gold coins, half of which are counterfeit", "Target disgorges 1d1000 dragonflies",
    "Target disgorges 1d1000 tiny, phosphorescent worms", "Target disgorges 1d4 cubic yards of humus",
    "Target disgorges 1d4 gallons of boiling pitch", "Target disgorges 1d6 filthy carrion birds",
    "Target disgorges 2d10 pounds of slag", "Target disgorges 3d100 feet of hemp rope",
    "Target disgorges 5d10 sheets of pristine parchment", "Target disgorges 5d10 sheets of rotting parchment",
    "Target disgorges a 50 pound sack of potatoes", "Target disgorges a boulder larger than any within 1d10 miles",
    "Target disgorges a box that he believes to contain his soul", "Target disgorges a brick of solid chlorine",
    "Target disgorges a bucket filled with eyeballs", "Target disgorges a bushel of razor-sharp shards of glass",
    "Target disgorges a bushel of rotten apples", "Target disgorges a corked bottle containing a mysterious note",
    "Target disgorges a corked bottle containing a powerless genie", "Target disgorges a dragon's egg",
    "Target disgorges a full-sized statue of a nearby ally",
    "Target disgorges a gelatinous mass writhing with tentacles",
    "Target disgorges a healthy specimen of some extinct species", "Target disgorges a homunculus",
    "Target disgorges a huge quantity of raisins, dates, and figs",
    "Target disgorges a large hourglass nearly empty of sand", "Target disgorges a large slab of marble",
    "Target disgorges a map to his home ", "Target disgorges a one-half-size clone of the caster",
    ...
    "Target disgorges a small but detailed replica of a nearby castle", "Target disgorges a small trampoline",
    "Target disgorges a stone that explodes on contact with ice",
    "Target disgorges a stone that will kill him if he touches it",
    "Target disgorges a ten foot column of aluminum one foot thick", "Target disgorges a two-foot square pane of glass",
    ...
    "Target disgorges the crown of the nearest king", "Target disgorges the front door of his home",
    "Target doesn't age until he next speaks", "Target doesn't age while bald",
    "Target doesn't age while holding a gold coin in his mouth", "Target doesn't age while in the caster's presence",
    "Target doesn't age while naked", "Target doesn't age while wearing a wet hat", "Target doesn't age while weeping",
    "Target doesn't need to eat, drink, or breathe for 2d4-1 days", "Target doesn't need to sleep for 4d20 days",
    "Target donates 2d10 hit points to the caster", "Target drowns for 1d6 rounds but is fine afterward",
    ...
    "Target exudes a scent reminiscent of the bottom of the ocean", "Target exudes a scent that attracts carnivores",
    ...
    "Target exudes a scent that easily can be tracked for miles", "Target exudes a scent that induces sleep in birds",
    "Target exudes a scent that inspires attracts bats", "Target exudes a scent that inspires fear in earth elementals",
    "Target exudes a scent that inspires intense bloodlust", "Target exudes a scent that inspires loyalty in wolves",
    ...
    "Target exudes a scent that makes people ignore him", "Target exudes a scent that obscures infravision",
    "Target exudes a scent that protects metal from natural rust", "Target exudes a scent that repels gnomes",
    ...
    "Target fanatically defends the caster for 1d10 rounds", "Target fears any subsequent magic used by the caster",
    "Target fears that all of his efforts are for naught", "Target feels as if he's walking on a high tightrope",
    "Target feels as if he's wearing an enormous hat made of lead",
    "Target feels as if his clothes are trying to digest him", "Target feels as if his clothes have turned to steel",
    ...
    "Target feels as though he just ate three pounds of parchment", "Target feels as though he just swallowed a python",
    "Target feels as though he's been splashed with boiling water",
    "Target feels as though he's being swallowed by a python", "Target feels as though he's having a baby",
    "Target feels as though he's having a heart attack", "Target feels as though he's having teeth extracted",
    "Target feels as though his allies have abandoned him", "Target feels as though his internal organs are melting",
    ...
    "Target feels compelled to burn all of his clothing", "Target feels compelled to desecrate a shrine to his deity",
    ...
    "Target feels his bones shake like a bundle of sticks", "Target feels his bones slowly disintegrating",
    "Target feels icy water dripping on him during every battle", "Target feels like he's having the time of his life",
    ...
    "Target finds a cursed vault containing 1d100 bars of gold", "Target finds a foot-long bar of indestructible glass",
    ...
    "Target finds a large diamond and guards it obsessively", "Target finds a large sack filled with powdered bone",
    ...
    "Target finds a pouch containing 1d10 super-intelligent mice", "Target finds a pouch containing curds and whey ",
    "Target finds a pouch containing exact copies of his hands",
    "Target finds a recipe for creating human life in a jar", "Target finds a shield +4 that only he can lift",
    ...
    "Target finds himself imprisoned in a mausoleum far from here", "Target finds the sight of blood intoxicating",
    ...
    "Target finds two doses of a Potion of Resurrection", "Target flees from anyone who addresses him by name",
    "Target flees into the forest if struck by magic in the next turn",
    "Target flies into a panic if anyone sees him eating", "Target flies into a panic if he sees other people eating",
    "Target flies into a rage and attacks the person nearest to him",
    "Target flies into a rage whenever he draws blood", "Target forgets 1d4 of his allies",
    "Target forgets everything said to him in the past 1d6 hours", "Target forgets his family and where he lives",
    "Target forgets his name and doesn't believe that he ever had one",
    "Target forgets how to ascend stairs and ladders", "Target forgets how to feed himself",
    "Target forgets how to sleep", "Target forgets how to use any magic item he's now carrying",
    "Target forgets how to use any weapon containing metal", "Target forgets how to use doors",
    "Target forgets how to walk but not how to run", "Target forgets that his allies know who he is",
    "Target forgets the last 1d12 hours", "Target forgets the last 1d4 years",
    "Target forgets whatever mission or quest he is now undertaking", "Target formally changes his name to \"Target\"",
    ...
    "Target gains 1d100 hit points that then vanish, one per round", "Target gains 1d100 pounds over that many rounds",
    ...
    "Target gains access to an elite secret society", "Target gains benefit from food only if eaten while he's naked",
    ...
    "Target glows bright blue until he's burned by magical fire", "Target glows bright blue until he's struck by magic",
    ...
    "Target goes berserk if any of his allies injure him", "Target goes berserk if he eats meat in the next 24 hours",
    "Target goes berserk if he sees anyone burned by fire", "Target goes berserk if he sees anyone eating meat",
    ...
    "Target goes totally and dangerously insane until sunset", "Target grows an additional 1d8 fingers",
    "Target grows an additional pair of ears atop his head",
    "Target grows an additional pair of eyes somewhere on his face",
    "Target has 1d100 tiny steel spheres embedded in his skin", "Target has 25 Intelligence for 1d4 turns",
    "Target has 25 Strength for 1d4 rounds", "Target has a +1 Armor Class bonus while it's raining",
    "Target has a +2 Armor Class bonus while barefoot", "Target has a +5 Armor Class bonus until sunset tomorrow",
    "Target has a -1 Armor Class penalty while wielding a weapon",
    "Target has a -2 Armor Class penalty while it's raining", "Target has a blowhole in the back of his neck",
    ...
    "Target has a doppelganger slave that looks just like the caster", "Target has a flawless sense of direction",
    "Target has a flawless sense of direction 50% of the time", "Target has a flawless sense of direction while naked",
    "Target has a hole in his forehead as large as his fist",
    "Target has a hole in his torso big enough to accommodate his head", "Target has a key that attracts lightning",
    ...
    "Target has a large and heavy padlock around his neck", "Target has a large apple stuck in his mouth for 1d4 days",
    "Target has a legitimate grievance against the caster", "Target has a mane like a lion",
    ...
    "Target has innumerable feathers stuck to his skin", "Target has inspiring hallucinations about his future career",
    ...
    "Target has ironclad proof that he's a prophesied savior", "Target has ironclad proof that he's dead",
    ...
    "Target has ironclad proof that the caster doesn't exist", "Target has no idea of where he is or what he's doing",
    ...
    "Target has owed the caster 1d10 gold pieces for 2d10 years", "Target has prominent mandibles like an ant",
    ...
    "Target has the caster's name tattooed all over his body", "Target has the head and right arm of a common housefly",
    ...
    "Target has visions of waiting in line for eternity", "Target has waited years for a custom-designed breastplate",
    "Target hasn't slept in 1d100 days", "Target hasn't slept since he last spoke with royalty",
    ...
    "Target hears his own voice whispering words of comfort to him", "Target hears malevolent voices all around him",
    ...
    "Target hoots like a foghorn when struck by magic after sunset", "Target increases in size and mass by 10%",
    ...
    "Target is 80% likely to die if Remove Curse is cast upon him", "Target is a carrier of some magical disease",
    ...
    "Target is arrested for smuggling some illegal substance", "Target is attacked by 1d1000 tiny skeletal bats",
    "Target is attacked by 6d12 housecats", "Target is attacked by a monster that no one else can see or hear ",
    "Target is attacked by dozens of cows", "Target is attacked by dozens of crows",
    "Target is attacked by everyone within 50 yards", "Target is attacked by moths as if he were made of wool",
    "Target is attacked by teeming vermin visible only to him", "Target is attacked by the nearest boulder",
    "Target is blind until he wets his hair", "Target is blind while his hair is wet",
    ...
    "Target is buried up to his knees in burning coals", "Target is buried up to his knees in shiny new gold coins",
    ...
    "Target is certain that he'll become a god if he dies in combat", "Target is certain that he'll die by sunset",
    "Target is certain that he's a plant-based creature", "Target is certain that he's about to become king",
    "Target is certain that he's as fragile as glass", "Target is certain that he's bleeding profusely",
    "Target is certain that he's immortal", "Target is certain that he's invulnerable until sunset",
    ...
    "Target is covered by coarse and musky wool like a yak", "Target is covered by dozens of slugs and snails",
    "Target is covered by thick, ugly scales for an AC bonus of 1",
    "Target is discovered to be a remotely operated machine", "Target is discovered to be an agent of the king",
    ...
    "Target is draped in a gossamer shawl impervious to fire", "Target is draped in filthy funerary dressing",
    "Target is draped in foul-smelling seaweed", "Target is draped in threads that can only be cut under moonlight",
    "Target is dreadfully afraid of the spell's target point",
    "Target is dreadfully homesick for some place he's never been", "Target is dressed like a court jester",
    "Target is dressed like a crazed anchorite", "Target is dressed like a pig at a luau",
    "Target is dressed like one of the royal family", "Target is driven halfway through the nearest tree",
    "Target is driven like a thumbtack into the ground up to his neck",
    "Target is encased in a glass box quickly filling with water", "Target is encased in a large, hollow sphere of ice",
    "Target is encased in a marble sarcophagus", "Target is encased in a sealed wicker basket",
    "Target is encased in a skin-tight plaster cast", "Target is encased in an airtight steel capsule",
    "Target is encircled by a chest-high wall of packed snow",
    "Target is encircled by a waist-high, electrified iron fence", "Target is encircled by a zone of intense cold",
    "Target is encircled by a zone of pure vacuum", "Target is encircled by an electrified fence",
    "Target is encircled by an illusory wall of chattering skulls",
    "Target is encircled by tall icicles, each as thick as his leg",
    "Target is enclosed for one hour in an impenetrable 10-foot sphere", "Target is enclosed in a shrinking steel cage",
    "Target is enraged beyond all rational control", "Target is ensconced in velvet",
    ...
    "Target is forever immune to all non-magical disease", "Target is forever immune to heatstroke",
    "Target is forever immune to hypothermia", "Target is forever immune to lycanthropy",
    "Target is found to be a persecuted victim needing caster's help",
    "Target is fully healed if he's slain while standing in snow", "Target is harassed by skeletal crows",
    ...
    "Target is holding an egg in each hand and must not break them!", "Target is hopelessly lost for 2d10 rounds",
    "Target is horribly afraid of cooked or salted meat",
    "Target is horribly scarred, as though shredded and reassembled",
    "Target is horrified by the sight of female magic users", "Target is horrified by the sound of clattering bones",
    "Target is identified as the leader of some bizarre cult", "Target is immortal and unaging until he next speaks",
    "Target is immortal, but he's sentenced to lifelong imprisonment",
    "Target is immortal, but his arms and legs vanish forever", "Target is immune to air-based magic for 1d4 days",
    "Target is immune to all attacks by non-magical birds", "Target is immune to all injury until he next speaks",
    "Target is immune to all swords now within one mile",
    "Target is immune to any wounds inflicted by humans for 4d6 hours",
    "Target is immune to area-effect magic for 1d4 days", "Target is immune to beneficial magic for 2d4 days",
    "Target is immune to charm-based spells or attacks for 1d4 weeks",
    "Target is immune to Charms and Enchantments for 1d4 weeks",
    "Target is immune to electrical attacks while carrying metal", "Target is immune to his allies' magic",
    "Target is immune to his allies' magic for 10d10 rounds",
    "Target is immune to his own magic and attacks for 1d4 hours", "Target is immune to hostile magic for 1d4 days",
    "Target is immune to illusions until dawn tomorrow", "Target is immune to injuries inflicted by wood in daylight",
    "Target is immune to inorganic poisons for 1d4 months",
    "Target is immune to light-based magic until sunset tomorrow", "Target is immune to lightning",
    "Target is immune to magical cold while naked", "Target is immune to magical diseases for one week ",
    "Target is immune to magical fire while naked", "Target is immune to magical healing",
    "Target is immune to missile weapons for 6d8 hours",
    "Target is immune to necromantic magic until he uses a magic item", "Target is immune to non-magical diseases",
    ...
    "Target is immune to poisons, but meat is highly toxic to him", "Target is immune to polymorph magic",
    ...
    "Target is implicated in numerous treasonous scandals", "Target is in the middle of a typhoon, but no one else is",
    "Target is infected with plague", "Target is instantly consumed by vermin if he dies within 24 hours",
    ...
    "Target is invisible while carrying 1d4 burning torches", "Target is invisible while completely submerged",
    "Target is invisible while he has an apple in each hand", "Target is invisible while shouting",
    "Target is invulnerable and invisible until he speaks or moves", "Target is invulnerable to 80% of normal weapons",
    ...
    "Target is killed outright if struck by a blood relative", "Target is limned by golden light until dawn tomorrow",
    ...
    "Target is liquefied but returns fully healed during the next rain", "Target is lost in the shuffle",
    "Target is mesmerized by the sight of lighted candles", "Target is mesmerized by the sound of clinking metal",
    ...
    "Target is obsessed with ridding himself of his allies", "Target is obsessed with ridding himself of his shadow",
    ...
    "Target is paralyzed by dread when he witnesses magical effects", "Target is pelted by hundreds of acorns",
    "Target is pelted by snowballs for 1d6 rounds", "Target is pelted by tiny, red hot coals for 1d4 rounds",
    "Target is pelted like a mink, otter, or beaver", "Target is permanently bloodstained",
    ...
    "Target is permanently rendered 1d100% transparent", "Target is physically exhausted",
    "Target is poisoned if he touches a book in the next 1d4 days", "Target is pursued by predatory moneylenders",
    "Target is pursued by ravenous wolves", "Target is pursued by rogue shadows that resemble his own",
    ...
    "Target is rendered deaf and blind for 2d10 rounds", "Target is rendered inert for 1d10 turns",
    "Target is rendered like a cow in an abattoir", "Target is rendered mute for 1d100 rounds",
    "Target is scarred as though he were pressed against a hot screen",
    "Target is scarred as though his digestive tract has been removed", "Target is sheathed in a large, living sponge",
    "Target is sheathed in a plant like a huge pea pod", "Target is sheathed in blood-soaked strips of leather",
    "Target is sheathed in wax", "Target is shoved to the ground in each of the next 1d10 rounds",
    "Target is showered by sawdust for 1d10 rounds", "Target is showered by shaved ice for the next 1d10 rounds",
    "Target is shunned by all other members of his species", "Target is shunned by all that is holy",
    "Target is shunned by anyone carrying a magic item", "Target is shunned by anyone nearby who is now wounded",
    "Target is shunned by polite society", "Target is smeared in a coordinated campaign of personal attacks",
    "Target is smeared in a fluid that suppresses his natural scent", "Target is smeared in lard",
    ...
    "Target is standing knee-deep in a bucket full of manure", "Target is stricken completely hairless",
    "Target is stricken deaf, blind, and mute for 1d6 rounds",
    "Target is stricken from any documents that mention him by name", "Target is stricken mute under every full moon",
    "Target is stricken mute while horses are nearby", "Target is stricken mute while under any magical effect",
    ...
    "Target is struck by lightning unless he's currently atop a horse", "Target is stung by a bee as large as an ox",
    "Target is stung by a bee every time he makes a successful attack",
    "Target is suddenly acutely aware of any injuries he now has", "Target is suddenly attacked by ruffians",
    "Target is suddenly holding 1d4 anvils", "Target is suddenly holding a box full of his own bones",
    "Target is suddenly holding a pair of alligator suitcases ", "Target is suddenly holding a pair of magic rings",
    "Target is suddenly holding an enormous bouquet of roses", "Target is suddenly holding the king's severed head",
    "Target is suddenly holding the nearest corpse in his arms", "Target is suddenly lying in a four-poster canopy bed",
    "Target is suddenly lying in his own bed", "Target is suddenly lying on a funeral pyre",
    "Target is suddenly married to 1d8 additional spouses", "Target is suddenly morbidly obese",
    "Target is suddenly naked except for a fig leaf", "Target is suddenly on the verge of an important breakthrough",
    "Target is suddenly on the verge of going berserk", "Target is suddenly on the verge of utter dehydration",
    "Target is suddenly on the verge of utter exhaustion", "Target is suddenly on the verge of utter panic",
    "Target is suddenly on the verge of utter starvation", "Target is suddenly packaged in a large cardboard box",
    ...
    "Target is suddenly sitting in a bucket full of ice water", "Target is suddenly sitting in a large wooden crate",
    "Target is suddenly sitting in the bucket of the nearest catapult",
    "Target is suddenly sitting in the queen's boudoir", "Target is suddenly sitting on an anthill, smeared with honey",
    "Target is suddenly sitting on the corpse of a fallen ally",
    "Target is suddenly standing atop a heap of shattered masonry",
    "Target is suddenly standing atop a rickety and very tall fence", "Target is suddenly standing atop a tall ladder",
    "Target is suddenly standing atop the nearest corpse", "Target is suddenly standing atop the nearest lookout tower",
    "Target is suddenly standing atop the nearest sand dune",
    "Target is suddenly standing in a fetid swamp miles from here", "Target is suddenly standing in the nearest boat",
    ...
    "Target is suddenly standing outside his own front door", "Target is suddenly standing under the nearest bridge",
    ...
    "Target is suddenly wearing an ornate saddle of very high quality", "Target is suddenly wearing fireproof clothing",
    "Target is suddenly wearing whatever the king wore yesterday", "Target is surrounded by pandering sycophants",
    "Target is surrounded by rabid wolves", "Target is surrounded by servitors who want to assassinate him",
    "Target is surrounded by vermin and small pests", "Target is susceptible to rust while carrying gold",
    ...
    "Target is suspended above the tallest tree nearby", "Target is suspended over a flaming pit until sunset",
    "Target is swarmed by countless flies, but they don't bother him",
    "Target is swarmed by undead whenever he uses a magic item", "Target is swept 3d100 yards by a wave of molasses",
    ...
    "Target is thought to be a malefic figure as foretold by prophecy", "Target is thrown 1d4 rounds into the past",
    "Target is thrown 8d6 hours into the future", "Target is thrown 8d6 yards into the air",
    "Target is thrown down the nearest flight of stairs", "Target is thrown into a coma for 1d6 days",
    "Target is thrown into the nearest briar patch", "Target is tied between two trees like a hammock",
    "Target is tied to the ground with rope made of his own hair",
    "Target is tightly bound by strips of adhesive cloth", "Target is tightly chained to the nearest tree",
    "Target is tightly swaddled in a coarse wool blanket", "Target is tightly wrapped in blood-soaked bandages",
    "Target is tightly wrapped in strips of raw and greasy bacon", "Target is tormented by countless demonic voices",
    ...
    "Target is tormented by shrill and discordant music", "Target is tormented by the awareness of his mortality",
    "Target is tormented by visions of his own damnation",
    "Target is tormented by visions of his own descent into madness", "Target is tormented by visions of the damned",
    "Target is tormented by visions of the torture of his allies",
    "Target is tormented by voices telling him to kill his allies",
    "Target is tormented by voices telling him to kill the king", "Target is unable to look directly at the caster",
    "Target is unaffected by natural winds", "Target is unexpectedly thrust into a position of political power",
    ...
    "Target is wearing the leathered skin from his own corpse", "Target is wholly invulnerable for 1d4 rounds",
    "Target is widely famed for his prowess with the scissors",
    "Target is widely recognized as a traitor to his race and species", "Target is, by his very nature, impossible",
    ...
    "Target labors to conceal a humiliating secret from his allies", "Target lacks any concept of personal property",
    "Target laughs like a braying donkey when he injures someone",
    "Target laughs outrageously at the sight of his allies' blood",
    "Target learns that a deranged cult worships him as a god", "Target leaves no scent for 1d4 weeks",
    "Target leeches 2d10 hit points from the caster", "Target levitates 10d10 yards into the air for that many rounds ",
    ...
    "Target looks as though half of his body is made of wood", "Target looks as though he's made entirely of clay",
    "Target looks exactly like the caster for 1d4 days", "Target looks like a photo-negative for 1d4 days",
    ...
    "Target loses 1d100 hit points unless he eats 3lbs of gold by dawn", "Target loses 1d100% of his mass",
    "Target loses 1d4 hit points every time he draws a weapon", "Target loses 1d4 levels/hit dice",
    ...
    "Target loses all hit points gained due to high Constitution", "Target loses all sense of decency and restraint",
    "Target loses half of his remaining hit points", "Target loses one hit point each day for the next 1d100 days",
    ...
    "Target loses one hit point per round until he's struck by magic", "Target loses the sense of object permanence",
    "Target makes a spirited effort to detach one of his legs", "Target makes a spirited effort to disarm his allies",
    "Target makes a spirited effort to eat his own foot", "Target makes a spirited effort to extract his own heart",
    ...
    "Target makes a spirited effort to swallow his weapon", "Target makes a spirited effort to tear off his ears",
    ...
    "Target mimics the caster's actions for 1d10 rounds", "Target mistakes himself for someone else",
    "Target moos like a cow each time he draws a weapon",
    "Target must carry a blade at all times that has never drawn blood",
    "Target must carry a burning candle at all times", "Target must carry a fifty pound wheel of cheese until sunset",
    ...
    "Target must carry at least 30 feet of rope at all times", "Target must carry at least 4d6 gold coins at all times",
    ...
    "Target must draw his weapon every time he says his name", "Target must drink 2d4 gallons of water before sunset",
    "Target must eat 3d6 pounds of food before dawn tomorrow", "Target must eat a pound of grass or leaves before dawn",
    "Target must eat a pound of ice by sunset tonight", "Target must give his name whenever he's asked for it",
    "Target must lie whenever he's asked his name", "Target must re-roll any attribute scores that are higher than 15",
    ...
    "Target must Save each morning or be ethereal until dusk", "Target must Save each morning or shrink by 10%",
    ...
    "Target must Save each night or else sleep for 6d8+24 hours", "Target must Save or 1d100 of his bones explode",
    "Target must Save or 1d100 of his bones turn to glass", "Target must Save or 1d100 of his bones turn to steel",
    "Target must Save or be dragged to the bottom of the nearest lake",
    "Target must Save or be struck dead by a meteor", "Target must Save or each of his bones teleports 1d4 miles",
    "Target must Save or forfeit ownership of all of his possessions",
    "Target must Save or he beheads himself with his next attack", "Target must Save or he will never have existed",
    "Target must Save or his hands and weapons vanish until sunset",
    "Target must Save or his temperature rises 1° per round", "Target must Save or lose 1d4 from each attribute score",
    ...
    "Target must say his name every time he draws a weapon", "Target must scale the tallest mountain within 100 miles",
    "Target must take 1d10 steps backward each time he draws a weapon",
    "Target now has 1d12 x 10% of his full hit points", "Target now has an odd number of limbs",
    ...
    "Target offered his legs as collateral on a high-interest loan", "Target only needs to blink once every 4d6 hours",
    "Target only needs to eat one normal-sized meal per week", "Target opens a chain of big-box retail stores",
    ...
    "Target perceives aggressive creditors to be hunting him endlessly", "Target perceives all foliage to be ablaze",
    "Target perceives constant rainfall from now on", "Target perceives everyone nearby to be sheathed in golden flame",
    ...
    "Target perceives hints of prophecy in any music he hears", "Target perceives menacing waterfowl all around him",
    ...
    "Target perceives worms to be wriggling from his every orifice", "Target permanently abandons his principal weapon",
    "Target permanently ages one year for each hit point he loses", "Target permanently gains 1d4 hit points",
    "Target permanently loses 1d10 toes", "Target permanently loses 1d4 hit points",
    ...
    "Target races headlong toward any magic user he encounters", "Target races to the nearest cave and hides there",
    "Target races to the nearest cave entrance", "Target races to the nearest library and tries to burn it down",
    "Target races to the nearest temple and messily desecrates it", "Target races toward his home at top speed",
    "Target races toward the caster and begs to be killed",
    "Target races toward the caster, embraces him, & vanishes with him",
    "Target races toward the nearest lake and jumps into it", "Target races toward the nearest monarch and attacks him",
    ...
    "Target reacts violently to anyone bearing a tattoo", "Target reacts violently to anyone displaying a holy symbol",
    ...
    "Target reacts violently to anyone nearby when he awakens", "Target reacts violently to anyone not of his race",
    "Target reacts violently to anyone not wearing a hat",
    "Target reacts violently to anyone refusing to address him as sire",
    "Target reacts violently to anyone representing a deity", "Target reacts violently to anyone taller than he is",
    "Target reacts violently to anyone wearing a cloak", "Target reacts violently to anyone wearing a gold ring",
    "Target reacts violently to anyone wearing a hat or helmet", "Target reacts violently to anyone wearing leather",
    "Target reacts violently to anyone who addresses him by name",
    "Target reacts violently to anyone who addresses the caster", "Target reacts violently to anyone who asks his name",
    "Target reacts violently to anyone who attacks the caster", "Target reacts violently to anyone who carries an axe",
    ...
    "Target reacts violently to anyone who gives him an order", "Target reacts violently to anyone who has a beard",
    "Target reacts violently to anyone who has long hair", "Target reacts violently to anyone who has no beard",
    ...
    "Target reacts violently to anyone who touches him", "Target reacts violently to anyone who uses magic",
    ...
    "Target realizes that he murdered 1d10 people closest to him", "Target realizes that he's a mechanical simulacrum",
    ...
    "Target receives a sign that he should reject all magic", "Target receives a sign that his murder is imminent",
    "Target reeks of carrion when he's angry", "Target reeks of cheap perfume between sunset and dawn",
    "Target reeks of chlorine while he speaks", "Target reeks of gasoline for the rest of his life",
    "Target reeks of manure while in polite company", "Target reflection appears in every mirror within 10 miles",
    "Target refuses any offers of first aid or magical healing",
    "Target refuses to believe that metal weapons can harm him", "Target refuses to believe that poisons are poisonous",
    "Target refuses to believe that the caster exists", "Target refuses to eat any cooked meat",
    "Target refuses to eat or sleep for 2d4-1 days", "Target refuses to eat until his magical sword is returned",
    "Target refuses to eat within 6d10 miles of this spot", "Target refuses to give medical aid to his allies",
    "Target refuses to share food or water with his allies", "Target refuses to speak his native tongue while outdoors",
    "Target refuses to speak to anyone at all for 1d8 days", "Target refuses to speak to anyone not of his race",
    "Target refuses to speak to anyone of his race", "Target refuses to speak to anyone who addresses him by name",
    ...
    "Target re-rolls 1d4 of his attribute scores, using 2d10", "Target re-rolls his hit points",
    "Target retains a perfect memory of the next 4d12 hours",
    "Target rightly believes that everyone is trying to kill him", "Target roars like a lion whenever he sees food",
    "Target runs 1d4 miles at top speed in a random direction", "Target runs completely around the nearest lake",
    "Target salivates heavily during battle ", "Target screams as though in agony for 1d4 hours",
    ...
    "Target shakes violently when attempting to use magic items", "Target shakes violently while touching magic items",
    ...
    "Target sinks halfway to the center of the world", "Target smells like 1,000 roses whenever he uses a magic item",
    "Target smells like 10 corpses whenever he uses a magic item",
    "Target smells like fungus for 1d4 hours after every battle",
    "Target smells like roses for one hour after every battle", "Target smells rotting flesh everywhere for 1d4 weeks",
    ...
    "Target smells strongly of vanilla for 2d4 days", "Target sneezes and 10d10 angry wasps spew from his nose",
    ...
    "Target spins a cocoon & emerges in 1d4 days with butterfly wings", "Target spins like a top for 1d8 rounds",
    "Target spits out small lumps of coal after any melee", "Target sprays a gallon of milk from his nose",
    "Target sprays a huge gout of jet-black ink from his nose",
    "Target sprouts 1d10 additional noses all over his body", "Target sprouts 1d10 fingers from his cheeks",
    "Target sprouts 1d10 pairs of delicate antennae", "Target sprouts 1d100 additional ears on his body",
    ...
    "Target sprouts a pair of retractable fangs in each palm", "Target sprouts a pig's tail from between his eyes",
    "Target sprouts a small foot from the top of his head", "Target sprouts a torch sconce between his shoulder blades",
    "Target sprouts a vulture's wing between his shoulder blades", "Target sprouts an additional foot from each knee",
    "Target sprouts an additional foot from each shoulder",
    "Target sprouts an additional forearm and hand from one elbow",
    "Target sprouts an additional hand from each shoulder", "Target sprouts an additional hand from one of his arms",
    "Target sprouts an additional hand from the palm of one hand",
    "Target sprouts an additional head beside the existing one", "Target sprouts an additional limb",
    ...
    "Target sprouts an additional thumb from the back of each hand", "Target sprouts an iguana's tail from his chin",
    "Target sprouts an intelligent fungus atop his head", "Target sprouts an ox horn from his chin",
    "Target sprouts an ox horn from one side of his head",
    "Target sprouts countless leaves, each bearing a mysterious rune",
    "Target sprouts deer antlers from his shoulder blades", "Target sprouts enormous fangs from his lower jaw",
    "Target sprouts harmless but acrid blue mold all over his body",
    "Target sprouts retractable iron claws from his fingers", "Target sprouts small, flashing lights along his spine",
    "Target sprouts wool like a sheep", "Target stalks the caster, always at least one mile distant",
    ...
    "Target suddenly has 2d10 carpenter's nails in his mouth", "Target suddenly has a horseshoe in his mouth",
    ...
    "Target suddenly owns an exact replica of the caster's skeleton", "Target suddenly realizes that fire can harm him",
    "Target suddenly realizes that he doesn't know how to use weapons",
    "Target suddenly realizes that he has a conjoined twin", "Target suddenly realizes that he's terrified of spiders",
    "Target suddenly realizes that he's undead", "Target suddenly realizes that magic doesn't really exist",
    ...
    "Target suffers a fit of crippling paranoia for 1d4 turns", "Target suffers a seizure lasting 1d10 rounds",
    "Target suffers burns if he touches water hotter than 80°",
    "Target suffers double damage from injuries while he's wet", "Target suffers extreme hypothermia",
    "Target suffers from a disfiguring pox, but his teeth are radiant", "Target suffers from hysterical pregnancy",
    ...
    "Target suffers no damage from wounds inflicted by orcs", "Target suffers only half damage from acid for 1d4 days",
    "Target suffers only half damage from fire for 1d8 days", "Target suffers only half damage from now until midnight",
    ...
    "Target swears undying loyalty to the next person to say his name", "Target sweats viscous and fragrant oil",
    ...
    "Target teleports 8d10 miles when he next attacks the caster", "Target teleports into the nearest convent",
    "Target teleports into the nearest grain silo", "Target teleports into the nearest leper colony",
    "Target teleports into the nearest monastery", "Target teleports into the nearest oubliette",
    ...
    "Target thinks he'll die if he sees a shooting star", "Target thinks he'll die if he wields a magical weapon",
    "Target thinks he'll die if struck again by the caster's magic",
    "Target thinks he'll die unless the caster saves him", "Target thinks he's an elephant until he's next injured",
    "Target thinks that 1d100 years have passed", "Target thinks that a mighty artifact is hidden in a nearby lake",
    ...
    "Target thinks that his clothing is on fire for 1d10 rounds", "Target thinks that his enemies are only illusions",
    "Target thinks that his left arm has turned to stone", "Target thinks that his skin is trying to suffocate him",
    "Target thinks that his sweat is flammable", "Target thinks that his weapon is intelligent and powerful",
    ...
    "Target trusts no one who's visibly carrying a weapon", "Target trusts the caster absolutely and unquestioningly",
    ...
    "Target vanishes until 1d4 different people say his name", "Target vanishes until the caster dies or gains a level",
    ...
    "Target vows to eat only raw meat starting tomorrow", "Target vows to eat only rotting meat starting tomorrow",
    "Target vows to forego all magical healing for one full year",
    "Target vows to return to this exact spot once per week", "Target vows to slay anyone who uses magic on him",
    "Target vows to slay every necromancer he meets", "Target vows to smite those who take his name in vain",
    "Target vows to tithe 90% of his income", "Target wails inconsolably for 1d10 rounds",
    ...
    "Target wakes each day certain that he's gone blind", "Target wakes each day certain that he's immortal",
    "Target wakes each day certain that he's spent a month in the snow",
    "Target wakes each day certain that he's still dreaming", "Target wakes each day certain that he's the king",
    ...
    "Target wakes tomorrow within 1d10 yards of the caster", "Target was assembled from portions of corpses",
    "Target was just released after decades of solitary confinement", "Target was the caster in a past life",
    ...
    "Target whistles like a teapot when struck by magic", "Target will be devoured by a dragon within 24 hours",
    "Target will befriend a dragon within 24 hours", "Target will betray himself at the most inopportune time",
    "Target will betray his closest ally in his time of greatest need",
    "Target will combust in 1d10 rounds unless he eats 2d10 gold coins", "Target will combust violently in 2d10 rounds",
    ...
    "Target's AC is re-rolled on 1d10 in each of the next 2d10 rounds", "Target's age doubles twice ",
    ...
    "Target's age is re-rolled on 10d10 each morning", "Target's age varies by 1d10 years each time he's wounded",
    "Target's allies all attack him for 1d4 rounds", "Target's allies all sound just like him",
    ...
    "Target's allies can't communicate with him until he spills blood", "Target's allies can't defend him in a fight",
    ...
    "Target's allies conspire to sell him into slavery", "Target's allies conspire to sell his soul to a demon",
    "Target's allies each carry a small vial filled with his blood", "Target's allies each find 1d10 gold pieces",
    "Target's allies each give him 1d100 gold pieces",
    "Target's allies fear that he's about to go on a homicidal rampage", "Target's allies go berserk if he is slain",
    "Target's allies have never liked or respected him", "Target's allies look just like him for 4d6 hours",
    "Target's allies look just like him until sunset", "Target's allies mock and ridicule him mercilessly until sunset",
    ...
    "Target's allies suspect that he's plotting to betray them", "Target's allies suspect that he's really the caster",
    ...
    "Target's allies think that he plans to sacrifice them to his god", "Target's allies think that he's ablaze",
    ...
    "Target's allies think that he's dead, and they try to bury him", "Target's allies think that he's drowning",
    ...
    "Target's allies think that he's under the caster's control", "Target's allies think that his name is \"Fungus\"",
    "Target's allies think that his touch is poisonous to them", "Target's allies trust him implicitly",
    "Target's allies utterly terrify him for 1d8 hours", "Target's allies worship him as a god for 1d8 days",
    "Target's ankle is tightly chained to his neck", "Target's ankles are bound by a large and heavy padlock",
    "Target's apparent physical age fluctuates by 1d100 years daily",
    "Target's arms appear to be stricken with advanced leprosy", "Target's arms are as limp as rope for 4d6 rounds",
    "Target's arms are encased in straight, tight-fitting steel tubes",
    "Target's arms are henceforth as limber as snakes", "Target's arms are replaced by inert duplicates of his head",
    "Target's arms can't be bound by cloth, rope, or vines", "Target's arms can't be broken by any natural means",
    "Target's arms can't be harmed by claws or teeth", "Target's arms can't be harmed by non-magical weapons",
    "Target's arms flap like a hummingbird's wings for 3d6 rounds",
    "Target's arms have been repeatedly severed and reattached", "Target's arms reflect light like a mirror",
    ...
    "Target's arms wheeze like hydraulics when he moves them", "Target's arms wriggle like angry snakes",
    ...
    "Target's attempts at tracking invariably lead to his own trail", "Target's blood burn as bright as magnesium",
    "Target's blood can eat through steel and iron like acid", "Target's blood hold the secret to eternal life",
    "Target's blood induces wild hallucinations in any who spill it",
    "Target's blood is highly flammable for 2d10 rounds", "Target's blood is invisible",
    "Target's blood is widely believed to be a panacea", "Target's blood smells powerfully of sulfur",
    "Target's body appears to be full of holes like Swiss cheese", "Target's body appears to be made entirely of cork",
    "Target's body appears to be made of porous wax", "Target's body can absorb twice its weight in water",
    "Target's body climbs into a tree each night as he sleeps", "Target's body inflates to twice its normal volume",
    "Target's body is covered with sores and blisters", "Target's body is infested with an enormous colony of termites",
    "Target's body is scarred as if he'd been pushed through a screen", "Target's body is scoured with steel wool",
    "Target's body rings like an enormous church bell 1d12 times", "Target's body slowly absorbs any clothing he wears",
    "Target's body, clothing, and gear are uniformly bright orange",
    "Target's bones are as brittle as chalk until sunset tomorrow", "Target's bones are discovered to have been stolen",
    "Target's bones are intensely magnetic", "Target's bones are sought by poachers",
    "Target's bones are visible through his skin while he sleeps",
    "Target's bones are visible through his skin while he's wet", "Target's bones are weightless",
    "Target's bones can never be rendered invisible", "Target's bones can't be broken by any natural physical force",
    "Target's bones chime like bells when he's struck", "Target's bones clatter inside his body like a bare skeleton",
    "Target's bones combust if exposed to direct sunlight", "Target's bones fuse into a single, inflexible mass",
    "Target's bones turn to ice", "Target's bones turn to muscle ",
    "Target's boots are discovered to be living organisms",
    "Target's boots can never sink underwater while he wears them",
    "Target's boots fuse to the ground where he's now standing", "Target's boots turn to glass",
    "Target's Charisma is raised to 25 for 1d6 rounds", "Target's closest ally attacks him for 1d10 rounds",
    "Target's closest ally is permanently invisible to him", "Target's closest ally turns out to be his clone",
    "Target's closest ally will betray him in his hour of need", "Target's clothes always appear to be filthy",
    "Target's clothes always resemble the clothes he's now wearing",
    "Target's clothes and gear are affected by Reverse Gravity", "Target's clothes and gear are highly flammable",
    "Target's clothes and gear are insulated against electricity",
    "Target's clothes appear 10d10 centuries out of date", "Target's clothes appear to be made of ice",
    "Target's clothes are 90% transparent while in mixed company", "Target's clothes are as delicate as cobweb",
    "Target's clothes are as rigid as boiled leather", "Target's clothes are as susceptible to rust as iron",
    "Target's clothes are chilled nearly to absolute zero", "Target's clothes are consumed by fire, but he is unharmed",
    "Target's clothes are devoured by vermin over the next 4d6 rounds", "Target's clothes are extraordinarily elastic",
    "Target's clothes are seized by the local authorities",
    "Target's clothes are soaked with a fetid and viscous slime", "Target's clothes are soaked with a powerful acid",
    "Target's clothes are soaked with beer", "Target's clothes are soaked with butterscotch pudding",
    "Target's clothes are soaked with deer musk", "Target's clothes are soaked with icy water once every 1d12 hours",
    "Target's clothes are soaked with strong perfume", "Target's clothes are stuffed full of snow",
    ...
    "Target's clothes billow with foul smoke when he's underground", "Target's clothes billow with scalding steam",
    ...
    "Target's clothes exactly match the caster's clothes", "Target's clothes exude fragrant smoke for 1d4 weeks",
    "Target's clothes glow in the dark", "Target's clothes have been buried for weeks in a midden",
    "Target's clothes heat to 500°", "Target's clothes ignite each time he uses a magic item",
    "Target's clothes inflate to the size of a house", "Target's clothes make him appear to suffer from leprosy",
    ...
    "Target's clothes smolder from now until dawn, but he is unharmed", "Target's clothes teleport 1d10 yards",
    ...
    "Target's death will inflict a plague upon the surrounding area", "Target's death will lead to mass rioting",
    "Target's death will reveal him to be a horrific, demonic entity", "Target's ears are indestructible",
    "Target's ears are prehensile", "Target's ears are the size of dinner plates", "Target's ears explode if removed",
    "Target's ears melt like wax", "Target's ears migrate about his head as the days wear on",
    "Target's ears migrate to his shoulders", "Target's ears shrivel and fall off over the next 1d8 days",
    "Target's ears turn slowly counter-clockwise", "Target's ears, nose, and lips are invisible for 1d4 days",
    "Target's ears, nose, and lips double in size", "Target's ears, nose, and lips fall off",
    "Target's ears, nose, and lips turn bright blue", "Target's entire family is arrested by royal decree",
    "Target's explodes if any attempt is made at resurrection",
    "Target's expression is permanently locked into a manic smile",
    "Target's eyes appear to be bundles of writhing worms", "Target's eyes appear to be tiny fireballs",
    "Target's eyes automatically filter out harmfully bright light",
    "Target's eyes bulge from the top of his head like a frog's eyes", "Target's eyes bulge to the size of hen's eggs",
    "Target's eyes burst, blinding him, but they grow back in 1d4 days",
    "Target's eyes can move independently, like a chameleon's", "Target's eyes each have 1d4 irises and pupils",
    "Target's eyes glow with malevolent fire when he faces true north",
    "Target's eyes merge into a single eye somewhere on his face", "Target's eyes migrate to just above his ears",
    ...
    "Target's face appears to have been welded to his skull", "Target's face begins to look more and more bat-like",
    "Target's face can't be harmed by acid", "Target's face glows pale green when he tells a lie",
    "Target's face is badly sunburned in a checkerboard pattern", "Target's face is flattened to his skull",
    "Target's face is scarred as by acid or flame", "Target's face is scarred as though horribly slashed years ago",
    "Target's face is tattooed with cryptic runes and sigils",
    "Target's face looks as though he's been pounded with hammers",
    "Target's face looks as though something exploded in his nose", "Target's face looks like badly melted wax",
    "Target's face migrates to the top of his head", "Target's family disowns him and places a bounty on his head",
    "Target's family includes at least one demonic abomination",
    "Target's family relocates to a distant land without telling him", "Target's feet appear to be made of clay",
    "Target's feet are fused to the ground beneath him", "Target's feet are henceforth clear like glass",
    ...
    "Target's fingernails begin to grow 1d4 inches per round ", "Target's fingernails glow like burning coals",
    ...
    "Target's fingers and thumbs connect directly to his wrists", "Target's fingers and thumbs shuffle positions",
    "Target's fingers merge into a single digit like a mitten",
    "Target's fists are attracted to each other like strong magnets", "Target's fists are each as large as his head",
    "Target's fists can't come within five feet of the ground",
    "Target's fists retract into his forearms when not in use",
    "Target's flesh is utterly transparent to artificial light", "Target's footfalls strike sparks on the ground",
    "Target's footprints are perfectly rectangular", "Target's footprints completely vanish after 1d10 rounds",
    "Target's footprints look like arrows pointing which way he went",
    "Target's footprints look like he's executing complex dance steps", "Target's forearms are invisible",
    "Target's hair can't be cut by non-magical metal", "Target's hair falls out and is replaced by lush feathers",
    "Target's hair falls out and is replaced by thick grass",
    "Target's hair falls out and tiny spikes sprout all over his head", "Target's hair floats as though underwater",
    "Target's hair grows 1d12 inches each time he's struck by magic",
    "Target's hair is severely tangled in the nearest tree or bush", "Target's hair is styled into a tall bouffant",
    "Target's hair moves from his head to somewhere else on his body",
    "Target's hair noticeably changes color every six hours", "Target's hands and feet are abnormally spongy",
    ...
    "Target's hands and feet give off unsettling vapors", "Target's hands and feet reform into perfect cubes",
    "Target's hands and feet shuffle their locations", "Target's hands and feet turn to pig's hooves for 1d4 days",
    "Target's hands applaud despite his wishes for 3d10 rounds", "Target's hands are bound in adamantite shackles",
    "Target's hands are encased in thick blobs of candle wax", "Target's hands are invisible while he wields a weapon",
    "Target's hands are magically slicked with butter for 1d4 hours", "Target's hands are nailed to the nearest tree",
    ...
    "Target's hands attempt to strangle him for 3d10 rounds", "Target's hands become ethereal while he wields a weapon",
    "Target's hands can never be severed from his arms", "Target's hands can't be burned by acid, fire, or electricity",
    "Target's hands can't be burned by magical fire", "Target's hands can't be cut by any blade forged by a mortal",
    "Target's hands can't be cut by non-magical blades", "Target's hands can't come within 18 inches of his mouth",
    "Target's hands change color each hour", "Target's hands combust if he tries to wear gloves",
    ...
    "Target's hands fuse to the next metal object he handles", "Target's hands fuse together behind his back",
    ...
    "Target's hands melt like wax if exposed to magical fire", "Target's hands rotate 180° at the wrists",
    "Target's hands shrink by 50%", "Target's hands steam vigorously when he's struck by magic",
    ...
    "Target's hat animates and attempts to eat his head", "Target's hat bleeds profusely until sunset tomorrow",
    "Target's hat is replaced by a spittoon or chamber pot",
    "Target's hat is replaced by half of a hollowed-out coconut", "Target's head always appear to face true north",
    "Target's head appears as a photo-negative", "Target's head appears to age at a rate of one year per day",
    "Target's head appears to be a naked brain", "Target's head appears to be made of delicate porcelain",
    "Target's head appears to be made of fire", "Target's head appears to be made of ice",
    "Target's head appears to be made of pure gold", "Target's head appears to be made of sand",
    "Target's head appears to be made of the finest crystal", "Target's head appears to be made of wood",
    ...
    "Target's head can't be harmed by magical electricity", "Target's head considers itself separate from his body",
    "Target's head deflates like a balloon while he sleeps",
    "Target's head explodes but regrows over the next 1d10 rounds", "Target's head explodes if he's decapitated",
    "Target's head glows like a jack-o-lantern", "Target's head goes on a murderous rampage if he's decapitated",
    "Target's head has a chunk missing as though hacked by an axe",
    "Target's head has a large hole through it like a doughnut",
    "Target's head has an arrow running harmlessly through it", "Target's head increases in size by a factor of 1d4+1",
    "Target's head is artificial", "Target's head is claimed as a sacred relic by orcs or goblins",
    "Target's head is clear like glass for 1d4 weeks", "Target's head is covered in coarse and ugly scales",
    "Target's head is covered with numerous disc-shaped scars",
    "Target's head is encased in a durable, transparent globe", "Target's head is enclosed in an indestructible helmet",
    "Target's head is enwrapped in delicate gold filigree",
    "Target's head is flattened on top like a pounded wooden stake", "Target's head is immune to extremes of pressure",
    "Target's head is impervious to magical fire", "Target's head is impervious to missile weapons",
    "Target's head is impervious to non-magical bludgeons", "Target's head is impervious to polymorph magic",
    "Target's head is invisible from the chin to the ears",
    "Target's head is of no particular physiological importance", "Target's head is prehensile",
    "Target's head is protected as though he's wearing a steel helmet",
    "Target's head is scarred as though split down the middle", "Target's head is shaped like a light bulb",
    "Target's head is Slowed for 1d4 hours", "Target's head is stuck in a huge conch shell",
    "Target's head is vestigial", "Target's head no longer ages", "Target's head seems on the verge of bursting",
    "Target's head shrinks to the size of his closed fist", "Target's head spins rapidly at the neck for 2d10 rounds",
    "Target's head splits in half, revealing his real head inside", "Target's head strongly resembles a foot",
    "Target's head throbs visibly when he's angry", "Target's head vanishes and his face appears on his chest",
    ...
    "Target's highest attribute score is halved for 1d4 days", "Target's highest attribute score is re-rolled daily",
    "Target's hindquarters resemble those of a donkey", "Target's hit points are doubled for the next 24 hours",
    ...
    "Target's internal organs murmur and chant inside him", "Target's internal organs shuffle positions",
    "Target's internal organs turn into infernal oranges", "Target's intestines are more intelligent than he is",
    "Target's intestines are replaced by a length of noisy chain", "Target's jawbone becomes that of an ass",
    "Target's knees and elbows become ball-joints like his shoulders",
    "Target's knees and elbows can't straighten to more than 120°", "Target's knees and elbows creak like rusty metal",
    "Target's knees and elbows vanish", "Target's large intestine explodes", "Target's left arm has Strength 18/00",
    "Target's left arm is fused into a nearby boulder", "Target's left arm is permanently invisible",
    "Target's left arm moves to his right shoulder", "Target's left foot appears to be that of a large duck",
    ...
    "Target's left foot sinks six inches into the ground at each step", "Target's left foot sprouts a pair of thumbs",
    "Target's left foot takes root", "Target's legs are covered in bark", "Target's legs are fireproof",
    "Target's legs are invisible in direct sunlight", "Target's legs are shaped like springs and twang when he walks",
    "Target's legs can't be cut by non-magical weapons", "Target's legs exactly resemble his arms",
    "Target's legs exchange positions", "Target's legs fuse together, and his arms fuse to his sides",
    "Target's legs shrink by 1d10 x 10% for 1d12 hours", "Target's level is halved",
    "Target's limbs change proportion to match those of an infant",
    "Target's limbs shrink to the size of an infant's limbs", "Target's lips are sewn shut with fine gold wire",
    "Target's lips move constantly as though he's singing to himself", "Target's lips vanish",
    "Target's loses 1d10 levels but regains one per day", "Target's maximum natural lifespan doubles",
    ...
    "Target's most valuable possession becomes brittle as glass", "Target's most valuable possession bursts into flame",
    "Target's most valuable possession can't be affected by magic", "Target's most valuable possession doubles in size",
    ...
    "Target's most valuable possession is encased in glass", "Target's most valuable possession is indestructible",
    ...
    "Target's most valuable possession turns permanently invisible", "Target's most valuable possession turns to lead",
    "Target's mouth and each nostril is plugged by a cork", "Target's mouth and one of his eyes exchange places",
    "Target's mouth appears to be full of angry hornets", "Target's mouth can speak with a mind of its own",
    "Target's mouth can't be opened while he's wearing a hat", "Target's mouth glows as though he's eating fireflies",
    "Target's mouth glows like a forge", "Target's mouth is full of moths",
    "Target's mouth is now located on the back of his head", "Target's mouth is packed completely full of leaves",
    "Target's mouth is replaced by a duck's bill", "Target's mouth is replaced by a hideous scolex",
    "Target's mouth is replaced by a toucan's beak", "Target's mouth opens to a span of 4d4 inches",
    "Target's mouth vanishes for 1d6 hours", "Target's neck and head shift 1d4+4 inches to the left",
    "Target's neck attempts to devour his head", "Target's neck can extend an additional 1d4 feet at will",
    "Target's neck can retract into his torso like a turtle's", "Target's neck can't be broken",
    "Target's neck doubles in length", "Target's neck flares like a lizard's frill when he's angry",
    "Target's neck has a frill like a triceratops", "Target's neck is as thin as a spear-shaft",
    "Target's neck is encircled by a tight steel collar", "Target's neck is impervious to blades",
    "Target's neck is scarred and twisted as if he survived a hanging", "Target's next 1d10 attacks affect him as well",
    ...
    "Target's next missile attack turns its victim invisible", "Target's nose looks like a small, clenched fist",
    "Target's nose turns into a wolf's snout under the full moon", "Target's nose turns to flint",
    "Target's nostrils are each as large as his mouth", "Target's nostrils glow with an unholy radiance",
    "Target's nostrils migrate to the top of his head",
    "Target's own corpse appears from the future as a powerful undead", "Target's physical age is now 1d100",
    "Target's pockets and mouth are full of sand", "Target's possessions are hidden beneath a nearby boulder",
    "Target's possessions are possessed by a powerful demon", "Target's possessions turn to solid aluminum",
    "Target's possessions, if enchanted, acquire hostile intelligence",
    "Target's possessions, if enchanted, swap their enchantments", "Target's presence causes birds to fall silent",
    ...
    "Target's presence makes foliage appear sickly and blighted", "Target's presence makes hoofed animals nervous",
    "Target's presence makes impassable trails seem passable",
    "Target's presence makes merchants hostile to bargaining", "Target's presence makes mind-reading impossible",
    ...
    "Target's presence renders maps temporarily illegible", "Target's principal weapon sprouts 10d10 roses",
    "Target's scent causes hallucinations in animals used to track him",
    "Target's shadow appears to flicker like a shadowy flame",
    "Target's shadow can travel up to 1d4 miles away from him", "Target's shadow races around him in a tight circle",
    "Target's shadow rises up and tries to strangle him", "Target's skin acquires 1d100 blasphemous tattoos",
    "Target's skin ages 10X as fast as the rest of his body", "Target's skin appears permanently stained with blood",
    "Target's skin appears slightly inflated after each battle", "Target's skin appears to be the texture of pumice",
    ...
    "Target's skin appears to have been turned inside-out", "Target's skin appears uniformly smooth and waxy",
    "Target's skin appears weathered like an ancient statue", "Target's skin attracts scavengers as if it were carrion",
    "Target's skin can't be burned, but fire still causes him pain", "Target's skin can't be cut",
    "Target's skin can't be cut by magical weapons under moonlight",
    "Target's skin can't be cut, and his mouth and nose seal shut", "Target's skin can't be pierced by carved wood",
    "Target's skin can't be pierced by stone weapons", "Target's skin can't be pierced by teeth or claws",
    "Target's skin cracks painfully like a dried-up riverbed", "Target's skin develops an intricate patchwork of scars",
    "Target's skin displays a series of concentric rings like a target",
    "Target's skin displays cryptic and constantly-changing runes", "Target's skin doubles in size",
    "Target's skin erupts into countless weeping boils", "Target's skin erupts with 3d10 acrid fungal outgrowths",
    "Target's skin freezes to his weapon each time he wields it",
    "Target's skin gives him a natural AC of 3, but only while naked",
    "Target's skin glistens as though soaked with lamp oil", "Target's skin glows cherry red during melee",
    "Target's skin glows pale green in moonlight", "Target's skin has the texture of rough bark",
    "Target's skin is 10% likely to be fireproof during any given day", "Target's skin is a widely coveted delicacy",
    "Target's skin is actually an intricate pattern of tiny tiles", "Target's skin is as combustible as paper",
    "Target's skin is as hard as bronze", "Target's skin is as white as snow until the next vernal equinox",
    "Target's skin is charred and blackened, but he is unharmed", "Target's skin is covered in scales like a fish",
    "Target's skin is flayed from his limbs, but it regrows by dawn",
    "Target's skin is forever the color of the next stone he touches", "Target's skin is invisible by firelight",
    "Target's skin is invisible in the presence of undead", "Target's skin is invisible while he's standing in water",
    "Target's skin is magically delicious", "Target's skin is mildly magnetic while wet",
    "Target's skin is patterned like a checkerboard", "Target's skin is patterned like a Holstein",
    "Target's skin is patterned like modern camouflage gear", "Target's skin is permanently and disturbingly moist",
    "Target's skin is permanently crisscrossed with fine lines",
    "Target's skin is repeatedly tattooed with caster's name", "Target's skin is repeatedly tattooed with his own name",
    "Target's skin is repeatedly tattooed with slurs against the king",
    "Target's skin is rumored to produce the world's finest leather", "Target's skin reeks of mold and mildew",
    "Target's skin reflects torchlight perfectly, but not sunlight",
    "Target's skin ripples in the wind like a cloth sheet", "Target's skin rotates 180°",
    "Target's skin shimmers like mother-of-pearl from now on", "Target's skin sizzles harmlessly on contact with water",
    "Target's skin smolders during combat", "Target's skin turns as black as pitch while in sunlight",
    "Target's skin will melt if he gets too close to a campfire", "Target's skin writhes and pulses while he's eating",
    "Target's skull is inscribed with a mysterious rune of power", "Target's skull sprouts numerous knobby projections",
    "Target's speech is intelligible to anyone, regardless of language",
    "Target's speech is reversed while his weapon is drawn", "Target's speech seems unaccountably rude and aggressive",
    "Target's speech sounds like the buzzing of innumerable bees", "Target's spine bends 90° halfway along its length",
    "Target's spine can twist 360° without harming him", "Target's spine doubles in length",
    "Target's spine is fused into a single bone for 1d8 hours", "Target's spine is indestructible",
    "Target's spine is reconfigured like a quadruped's", "Target's spine juts from his flesh along his entire back",
    "Target's spine sprouts needle-sharp projections", "Target's spine twists like a corkscrew",
    "Target's sternum sprouts 2d4 inch-long spikes", "Target's sternum turns to glass",
    "Target's sternum turns to steel", "Target's sternum vanishes",
    "Target's sweat is brightly phosphorescent by firelight",
    "Target's teeth and tongue fall out when he next opens his mouth", "Target's teeth and tongue turn invisible",
    "Target's teeth are etched with cryptic runes", "Target's teeth are perfectly reflective of natural light",
    "Target's teeth are so beautiful that they're painful to look at", "Target's teeth can never be rendered invisible",
    "Target's teeth glow brightly while his mouth is open", "Target's teeth glow like coals in a forge",
    "Target's teeth glow like torches when he's struck by magic",
    "Target's teeth resonate in his jaw when he uses a magic item", "Target's teeth shoot from his mouth like bullets",
    "Target's teeth teleport into the mouth of someone nearby", "Target's teeth turn as black as coal",
    "Target's teeth turn to diamonds 1d4 hours after being extracted", "Target's teeth turn to soap",
    "Target's teeth turn to steel", "Target's teeth were cut from diamonds by a Gnome master lapidary",
    "Target's toes are each as large as his big toe", "Target's toes become gangrenous",
    ...
    "Target's torso and arms are invisible for 1d4 months", "Target's torso does not age and will not decay upon death",
    "Target's torso inspires fear and dread in all who touch it", "Target's torso is artificial",
    "Target's torso is hollow and can store up to 2d4 cubic feet", "Target's torso is pierced by 4d10 long needles",
    ...
    "Target's torso regenerates his limbs and head as needed", "Target's torso shines like a beacon for 1d4 days",
    "Target's torso shines like a beacon when he uses a magic item", "Target's torso shrinks by 50%",
    "Target's torso sprouts a face with malign intelligence and power", "Target's torso teleports 1d4 feet to the left",
    "Target's torso unzips and dumps out all of his organs", "Target's vertebrae are replaced by titanium replicas",
    "Target's vision is unimpaired by non-magical rain", "Target's voice causes metal to resonate lightly",
    "Target's voice crackles with static until sunrise tomorrow", "Target's voice induces fear in herbivores",
    ...
    "Target's voice is nearly unintelligible when he wields his weapon", "Target's voice issues from his navel",
    "Target's voice issues from his weapon for the next few weeks",
    "Target's voice issues from the nearest wooden object", "Target's voice issues from this spot for 2d10 days",
    "Target's voice seems to issue from whomever he's addressing",
    "Target's voice sounds as though he's shouting from a distance", "Target's voice sounds like a muted trumpet",
    "Target's voice sounds like someone of the opposite sex", "Target's voice sounds like the barking of feral dogs",
    "Target's voice sounds like the braying of donkeys",
    "Target's voice sounds like the chirping of crickets for 3d8 hours",
    "Target's voice sounds like the honking of geese", "Target's voice sounds oddly artificial and disturbing",
    "Target's waterskin is filled with his own blood", "Target's waterskin is filled with hot pepper sauce",
    "Target's waterskin is filled with liquid soap", "Target's waterskin is filled with mercury",
    "Target's waterskin is filled with molten gold", "Target's waterskin is filled with water from the River Styx",
    ...
    "Target's weapon appears to be made of cheese for 1d6 days", "Target's weapon appears to be made of diamond",
    "Target's weapon appears to be made of ice", "Target's weapon appears to be made of solid water",
    ...
    "Target's weapon attracts the attention of the authorities", "Target's weapon attracts undead while it's drawn",
    ...
    "Target's weapon can injure anyone now within 1d10 feet of it", "Target's weapon can injure but not kill anyone",
    ...
    "Target's weapon can't be altered by any non-magical means", "Target's weapon can't be harmed by magical fire",
    "Target's weapon can't be teleported", "Target's weapon can't be wielded unless the wielder is naked",
    "Target's weapon can't cut flesh for 1d12 hours", "Target's weapon can't harm non-humanoid mammals",
    "Target's weapon can't harm undead", "Target's weapon can't injure anyone of his sex",
    "Target's weapon can't injure anyone of the opposite sex", "Target's weapon can't pass through doorways",
    ...
    "Target's weapon clangs like a bell when used in melee", "Target's weapon coils about his arm for 1d4 rounds",
    ...
    "Target's weapon disintegrates if ever it wounds him", "Target's weapon disintegrates if it's hit by magic",
    ...
    "Target's weapon drips with blood until it next draws blood", "Target's weapon drips with molasses during battle",
    "Target's weapon enables him to breathe underwater for 3d8 rounds",
    "Target's weapon explodes if ever it inflicts maximum damage", "Target's weapon floats on water as readily as wood",
    "Target's weapon giggles menacingly upon contact with blood",
    "Target's weapon glows as bright as the sun, but only to him",
    "Target's weapon glows blue except in the presence of orcs", "Target's weapon glows blue in his presence",
    ...
    "Target's weapon glows red hot during battle but doesn't harm him", "Target's weapon grows to 10x its normal size",
    ...
    "Target's weapon has a -4 ToHit penalty while in direct sunlight", "Target's weapon has a constant sheath of frost",
    "Target's weapon has been broken and reforged many times", "Target's weapon has been prophesied to kill the king",
    "Target's weapon has never been tempered or hardened",
    "Target's weapon heats to 1,000° the next time it draws blood",
    "Target's weapon hisses during battle like quenched steel", "Target's weapon hums audibly during battle",
    ...
    "Target's weapon induces vertigo in anyone wielding it", "Target's weapon induces vertigo in anyone wounded by it",
    "Target's weapon inflates like a balloon ", "Target's weapon inspires him to embark on a murderous rampage",
    "Target's weapon instills Fear in any who've been wounded by it",
    "Target's weapon instills Fear in goblins and kobolds", "Target's weapon instills Fear in him after each battle",
    ...
    "Target's weapon is as pliant as soft clay for 1d4 rounds", "Target's weapon is as supple as silk for 1d4 turns",
    "Target's weapon is bent into a torc around his neck", "Target's weapon is bent into the shape of a paperclip",
    ...
    "Target's weapon is clear like glass but is all but unbreakable", "Target's weapon is cloned",
    "Target's weapon is edible, but only to him", "Target's weapon is embarrassed to be seen with him",
    "Target's weapon is etched with his likeness", "Target's weapon is guilty of numerous capital crimes",
    ...
    "Target's weapon is invisible to everyone else during battle", "Target's weapon is invisible to him in daylight",
    ...
    "Target's weapon is perfectly balanced for a non-magical +2 ToHit", "Target's weapon is permanently -2 ToHit",
    ...
    "Target's weapon is riddled with holes but functions normally", "Target's weapon is sheathed in a scab-like shell",
    "Target's weapon is sheathed in a shell of chocolate", "Target's weapon is sheathed in a soft wool tube",
    "Target's weapon is stuck high in the branches of a nearby tree", "Target's weapon is suddenly 10d100 years older",
    "Target's weapon is thrown 1d1000 years into the past", "Target's weapon is tied to both of the target's hands",
    "Target's weapon is translucent like smoked glass", "Target's weapon is twisted like a corkscrew",
    "Target's weapon is vulnerable to magical fire while he wields it", "Target's weapon is weightless when not in use",
    ...
    "Target's weapon melts if ever it's immersed in sea water", "Target's weapon melts like a candle",
    "Target's weapon must be fed one mouse or rat per day, or it dies",
    "Target's weapon passes through armor unimpeded", "Target's weapon passes through flesh unimpeded",
    ...
    "Target's weapon repels his allies while it's drawn", "Target's weapon repels non-magical vermin",
    "Target's weapon repels normal flame to a distance of one foot", "Target's weapon repels oxygen while it's drawn",
    "Target's weapon ridicules him in front of his allies", "Target's weapon rings like a bell to mark the hours",
    "Target's weapon shatters the next time he's burned by fire",
    "Target's weapon shatters the next time it strikes metal", "Target's weapon shrieks until sunset tomorrow",
    "Target's weapon shrinks by 75% upon contact with blood", "Target's weapon shrinks to 10% of its normal size",
    "Target's weapon spins rapidly around its axis for 10d10 rounds",
    "Target's weapon sprouts 1d100 teeth along its length", "Target's weapon sprouts leaves",
    "Target's weapon starts bleeding profusely", "Target's weapon teleports exactly 1d10 yards due north",
    "Target's weapon teleports to the caster's home",
    "Target's weapon teleports to the target, 1d4 weeks in the future", "Target's weapon thinks that he's its mother",
    "Target's weapon turns ethereal in the presence of other weapons", "Target's weapon turns inside-out",
    "Target's weapon turns into a rattan simulation", "Target's weapon turns into a replica of the caster's weapon",
    ...
    "Target's weapon turns into an umbrella under each full moon", "Target's weapon turns to lightweight plastic",
    "Target's weapon turns to sodium during the next rainstorm",
    "Target's weapon urges him to leap from the nearest bridge", "Target's weapon vanishes until he dies",
    "Target's weapon vanishes when he dies", "Target's weapon was forged by his descendent years in the future",
    ...
    "Target's weapon was stolen from the gods, and they want it back", "Target's weapon weighs as much as he does",
    ...
    "The ground beneath target's feet contains an unquiet spirit", "The ground now at target's feet acquires sentience",
    ...
    "The ground now at target's feet is dangerously slick with ice", "The ground now at target's feet is edible",
    "The ground now at target's feet is forever barren of vegetation",
    "The ground now at target's feet is fused into glass", "The ground now at target's feet is intensely magnetic",
    "The ground now at target's feet is invisible to him", "The ground now at target's feet is obviously artificial",
    ...
    "The ground now at target's feet turns to cobblestone", "The ground now at target's feet turns to molten glass",
    "The ground now at target's feet turns to quicksand", "The ground now at target's feet turns to warm butter",
    "The ground now at target's feet whispers horrific threats to him",
    "The left half of target's skeleton rebels against the right", "The left half of target's skeleton vanishes",
    ...
    "Thousands of snails rain down harmlessly upon the target", "To the target, all liquids taste like acrid poison",
    "To the target, all liquids taste like his own blood", "To the target, all liquids taste like strong vinegar",
    ...
    "To the target, everyone appears to be plated in gold", "To the target, the previous 1d4 rounds were only a dream",
    "Undead are attracted to the target as though he can help them", "Undead are invisible to the target",
    "Undead can't speak in the target's presence", "Undead declare a coordinated war against the target",
    "Undead ignore target and can't be harmed by him", "Undead recognize the target as one of their own",
    ...
    "Vines bind the target tightly to a nearby tree", "Vines sprout from any open wounds the target now has",
    "Vines sprout from the ground at target's feet and attack him",
    "Vines sprout from the target's weapon and bind his limbs",
    "Viscous slime drips from the target's mouth from now on", "Water always feels 50° colder to the target",
    "Water boils on contact with the target's flesh", "Water gives no benefit to target if imbibed while indoors",
    "Water has no weight when carried by the target",
    "Water induces amnesia in target if ingested between dawn and noon",
    "Water is a deadly poison to target for 2d12 hours", "Water is invisible while within 10 feet of the target",
    "Water is toxic to target if ingested between noon and dusk", "Water spews from target's ears during battle",
    "Waterfowl attack the target on sight", "Waterfowl swear eternal loyalty to the target",
    "Weapons are invisible to the target while he wields them", "Whatever is now in target's hand heats to 500°",
    ...
    "Whatever is now in target's hand now belongs to the caster", "Whatever is now in target's hand turns to gold",
    ...
    "When target dies, he is posthumously crowned king", "When target dies, he is rumored never to have existed",
    ...
    "When target dies, his killer is hailed as a national hero", "When target dies, his killer is named his executor",
    ...
    "When target dies, his soul is trapped in his weapon", "When target draws a weapon, a nearby tree drops its leaves",
    ...
    "When target says his name, he can't tell a lie for one hour", "When target says his name, his age doubles",
    ...
    "While target sleeps, he dreams that he's in hell", "While target sleeps, he dreams that he's undergoing surgery",
    ...
    "Yesterday, target ate 1d10 pounds of baked beans", "Yesterday, target had dark premonitions of this exact moment",
    ...
    "Yesterday, target learned that he had 36 hours left to live", "Yesterday, target stole a magic ruby from a dragon",
    ...
    "Yesterday, target's feet were burned to a crisp", "Yesterday, target's head was removed and shoddily reattached",
    "1,000 cubic feet of dirt and rock rise as a 16HD earth elemental",
    "1d10 nearby trees uproot and race to the nearest town square", "1d10 nearby trees uproot and vanish into the sky",
    ...
    "1d100% of a major continent sinks beneath the sea", "1d1000 clay bricks fall from the sky",
    "1d1000 skeletons rise from the ground and march to the sea",
    "1d20 skeletons rise from the ground and attack anyone nearby", "1d4 creatures nearby are suddenly gold-plated",
    "1d4 creatures nearby double in size", "1d4 gallons of molten gold pour from the target point",
    "1d4 magical golden apples appear nearby", "1d6 aggressive, human-sized pigeons appear in the area",
    "1d6 horses nearby are turned into carousel horses", "1d6 people nearby adopt entirely new personalities",
    "1d6 people nearby are 50% likely to gain a level or die outright", "1d6 people nearby are chained together",
    "1d6 people nearby are duplicated exactly", "1d6 people nearby are hurled high into the air",
    "1d6 people nearby are identified as harbingers of vile pestilence",
    "1d6 people nearby are pulled into the target point and destroyed", "1d6 people nearby are tarred and feathered",
    "1d6 people nearby are teleported 1d4 miles", "1d6 people nearby are unable to wield weapons for 1d8 hours",
    "1d6 people nearby can breathe water as readily as air", "1d6 people nearby feel like they're drowning",
    "1d6 people nearby flee from the area at top speed", "1d6 people nearby grow feathers like peacocks",
    "1d6 people nearby grow wool like sheep", "1d6 people nearby join forces against all others nearby",
    "1d6 people nearby look exactly alike", "1d6 people nearby look like children for 1d4 years",
    "1d6 people nearby must Save or be Disintegrated", "1d6 people nearby shrink by 5d10+50%",
    "1d6 people nearby will become zombies in 3d6 days", "2d100 spectators appear in the area",
    "2d100 wild bulls appear in the area", "4d10 duplicates of someone nearby appear in the area",
    ...
    "A 100 yard radius is covered by ankle-deep fetid mud", "A 100 yard radius is covered by ankle-deep white sand",
    ...
    "A 100 yard radius is encircled by a ring of raised earth", "A 100 yard radius is encircled by a wall of hay bales",
    ...
    "A 100 yard radius is strewn with blood-soaked rags", "A 100 yard radius is strewn with decaying marine life",
    ...
    "A 1d10 mile radius becomes a dense and temperate forest", "A 1d10 mile radius becomes a pastoral idyll",
    "A 1d10 mile radius becomes a peaceful lake", "A 1d10 mile radius becomes an arid and desolate desert",
    ...
    "A baby born in a nearby town is the spawn of a powerful demon", "A blasphemous tome appears at the target point",
    ...
    "A deity has died, and someone nearby is blamed for his death", "A dense tangle of thorny vines fills the area",
    ...
    "A flock of 5d20 human-sized geese lands in the area", "A four-dimensional cube appears at the target point",
    "A fully outfitted galleon appears nearby", "A gargantuan, tentacled monstrosity rises from the nearest ocean",
    ...
    "A local ruler is known to kill and eat 1d4 people each week", "A local ruler is revealed to be an illusion",
    ...
    "A mighty hailstorm pummels the area for 1d4 hours", "A mysterious gold sarcophagus appears at the target point",
    ...
    "A one mile radius is rotates 360° every 24 hours", "A one mile radius is shrouded by an eclipse for 2d8-1 days",
    ...
    "A powerful and radical religious sect usurps the throne", "A powerful demon takes up residence in a nearby house",
    "A powerful earthquake shifts this whole area one mile north", "A sandstorm sweeps through the area for 2d6 turns",
    ...
    "A terrible fire occurred on this site 4d6 hours ago", "A terrible fire will occur on this site 4d6 hours from now",
    ...
    "A volcano erupts at the center of the nearest town", "A volley of 10d20 arrows rains down on the area",
    ...
    "All air within one mile is totally opaque but otherwise normal", "All armor removed in this area shrinks by 25%",
    "All armor within 50 yards becomes clear like glass", "All armor within 50 yards is as heavy as lead",
    "All armor within 50 yards is weightless for 1d12 months", "All armor within one mile is ethereal until sunset",
    ...
    "All birds within 50 yards explode, 1d6 hit points per bird", "All birds within one mile are completely plucked",
    ...
    "All blades within 50 yards must Save or crumble into rust", "All blades within one mile are blunted until sunset",
    ...
    "All chain mail within 50 yards is slicked with ice", "All chain mail within 50 yards is strongly magnetic",
    "All cloth within 50 yards begins to digest itself", "All cloth within 50 yards can never be rendered invisible",
    "All cloth within 50 yards is as shiny and lustrous as gold",
    "All cloth within 50 yards is rendered as brittle as eggshell",
    "All cloth within 50 yards is rendered as stiff as wood", "All cloth within 50 yards is scrubbed clean",
    "All cloth within 50 yards is soaked with gasoline", "All cloth within 50 yards seems unusually heavy",
    ...
    "All coins within 50 yards are invisible under moonlight", "All coins within 50 yards become flexible as rubber",
    "All coins within 50 yards double in value", "All coins within 50 yards explode, 1d4-1 hit points per coin",
    "All coins within 50 yards heat to 1,000°", "All coins within 50 yards turn to mercury",
    "All coins within one mile are easily recognized as counterfeit",
    "All curses now in effect within 100 yards are negated",
    "All dragons within 1d10 miles are enraged beyond all reason", "All dragons within 1d10 miles shrink by 10d10%",
    ...
    "All Elves within 10 miles forget how to speak Elvish", "All Elves within 10 miles sprout jagged fangs",
    "All Elves within 50 yards are allergic to wood", "All ferrous metal within 50 yards doubles in weight",
    ...
    "All ferrous metal within 50 yards is magnetized", "All ferrous metal within 50 yards is rustproof for one year",
    ...
    "All fires lit in this area flare up wildly for 1d4 rounds", "All fires lit in this area reek of brimstone",
    ...
    "All food consumed within one mile is unpalatably bitter", "All food within 50 yards completely spoils by sunset",
    "All food within 50 yards freezes solid", "All food within 50 yards is crawling with illusory maggots",
    "All food within 50 yards is poisonous for the next 1d4 hours",
    "All food within 50 yards is stripped of all nutritive value", "All food within one mile turns to salt",
    "All footprints within one mile fossilize by dawn tomorrow", "All forged steel within 100 yards turns to aluminum",
    "All forged steel within 100 yards turns to slate", "All gems within 50 yards are duplicated exactly",
    "All gems within 50 yards become spherical", "All gems within 50 yards turn to sodium when placed in water",
    "All gems within 50 yards vibrate in the presence of gold",
    "All Gnomes within 10 miles develop a dislike of gems and jewels", "All Gnomes within 10 miles grow 1d20 inches",
    "All goblins within 10 miles appear in the immediate area", "All goblins within 10 miles are afraid of the dark",
    "All goblins within 10 miles are exterminated", "All goblins within 10 miles are transformed into Elves",
    ...
    "All gold within 50 yards always seems to be 200°", "All gold within 50 yards becomes transparent when submerged",
    "All gold within 50 yards begins to rust like damp steel", "All gold within 50 yards induces extreme covetousness",
    ...
    "All gold within 50 yards is drawn to the target point", "All gold within 50 yards is indestructible for one year",
    "All gold within 50 yards is irresistibly attractive to undead", "All gold within 50 yards is severely tarnished",
    ...
    "All hats or hoods within 50 yards burst into flame", "All herbivores within 100 yards are panic-stricken",
    "All horses within 100 yards have built-in saddles", "All horses within 100 yards shrink by 1% per round",
    "All horses within one mile become bipedal for 1d4 weeks", "All horses within one mile become clear like glass",
    ...
    "All ink within 50 yards is powerfully hallucinogenic", "All ink within one mile is invisible for 2d4-1 days",
    "All ink within one mile is invisible in sunlight",
    "All inorganic matter within 10 miles appears blurry until sunset",
    "All inorganic matter within 10 yards disappears", "All inorganic matter within 10 yards turns to ice",
    ...
    "All invisible matter within one mile is clear like glass", "All leather within 50 yards begins sweating profusely",
    "All leather within 50 yards is as rigid as steel", "All leather within 50 yards shatters like glass",
    "All leather within 50 yards turns to silk", "All living creatures nearby are driven away for 1d4 months",
    ...
    "All magic items within 50 yards hum softly for 1d4 days", "All magic potions within 50 yards are 10X as powerful",
    "All magic potions within 50 yards are powerfully toxic", "All magic potions within 50 yards are rendered inert",
    ...
    "All magic rings within 50 yards are unharmed by fire or heat", "All magic rings within 50 yards attract lightning",
    ...
    "All magic rings within 50 yards shrink by 10% with each use", "All magic rings within 50 yards turn to crystal",
    "All magic rings within 50 yards turn to lead while not being worn",
    "All magic rings within 50 yards whistle softly while in use", "All magic weapons nearby are ethereal until sunset",
    ...
    "All mechanical locks within one mile spring open", "All members of a major race are discovered to be artificial",
    "All members of a major race are rendered sterile", "All metal armor nearby has been soaking in vinegar",
    "All metal armor nearby is chilled to freezing", "All metal gauntlets within 50 yards are non-removable until dawn",
    "All metal gauntlets within 50 yards are rustproof", "All metal gauntlets within 50 yards cause terrible chafing",
    "All metal gauntlets within 50 yards close into fists", "All metal gauntlets within 50 yards heat to 400°",
    "All metal gauntlets within 50 yards insulate against electricity",
    "All metal gauntlets within 50 yards shrink by 25%", "All metal gauntlets within 50 yards turn to silk",
    "All metal weapons wielded nearby seem to be 500°", "All metal within 50 yards appears to be made of solid shadow",
    "All metal within 50 yards induces frostbite while in daylight",
    "All metal within 50 yards is entirely non-reflective", "All metal within 50 yards is flammable for 2d10 rounds",
    ...
    "All non-magical animals nearby are restored to full hit points", "All non-magical animals nearby shrink by 40%",
    "All non-magical books within 50 yards are duplicated",
    "All non-magical books within 50 yards must Save or combust", "All non-sentient animals nearby are 1d100 years",
    ...
    "All paper now nearby glows in the dark permanently", "All paper now nearby is fireproof",
    "All plant life within 10 miles is sky-blue from now on",
    "All plant-based fabric within 50 yards becomes dull brown", "All plant-based fabric within 50 yards combusts",
    ...
    "All right arms within 50 yards are paralyzed until dawn", "All rope within 50 yards can't be cut or broken",
    "All rope within 50 yards ignites along its entire length", "All rope within 50 yards is as rigid as wood",
    "All rope within 50 yards is as strong as steel wire", "All rope within 50 yards is forever unable to hold a knot",
    "All rope within 50 yards is permanently invisible", "All rope within 50 yards shortens by 80%",
    "All rope within 50 yards straightens and becomes hard as stone", "All rope within 50 yards stretches like elastic",
    "All rope within 50 yards turns to flesh", "All saddles within 50 yards are as durable as tempered steel",
    "All saddles within 50 yards disappear", "All shields within 50 yards are fragile like glass for 1d4 rounds",
    ...
    "All shields within 50 yards gain a +1 bonus lasting 1d10 battles", "All soil and rock within 100 yards vanishes",
    "All soil within 50 yards is seeded with an aggressive vegetable", "All soil within 50 yards turns invisible ",
    ...
    "All spells cast in this area are delayed by 2d10 rounds", "All Summoned creatures within 10 miles are dismissed",
    ...
    "All thumbs within 50 yards are immune to polymorph magic", "All thumbs within 50 yards vanish for 1d4 hours",
    ...
    "All trees within 10 miles drop their leaves until next spring", "All trees within 50 yards are glazed with ice",
    "All trees within 50 yards are impervious to saws and axes",
    "All trees within 50 yards bear watermelons for 1d4 months", "All trees within 50 yards become ambulatory",
    "All trees within 50 yards become omnivorous", "All trees within 50 yards chant dirges at every sunset",
    "All trees within 50 yards gain a semblance of sentience", "All trees within 50 yards turn permanently invisible",
    "All trees within a one mile vanish", "All trees within one mile are cut down and stacked as cordwood",
    "All trees within one mile are hollow", "All trees within one mile crumble to dust within 1d4 days",
    "All trees within one mile double in height", "All trees within one mile drip with blood",
    ...
    "All trolls within 10 miles lose their ability to regenerate", "All undead skeletons within 10 miles turn to wood",
    "All undead within 1d100 miles vanish until sunset tomorrow",
    "All undead within 50 yards are restored to full hit points", "All undead within 50 yards are teleported 1d4 miles",
    ...
    "All vegetation within 50 yards becomes incredibly lush", "All vegetation within 50 yards dies within 1d4 rounds",
    "All vegetation within 50 yards grows 100X as fast for 2d4 days", "All vegetation within 50 yards is frozen solid",
    ...
    "All voices within 50 yards seem to issue from the same person", "All voices within 50 yards sound identical",
    "All water within 10 miles is chilled to just above freezing", "All water within 50 yards becomes invisible",
    "All water within 50 yards becomes thick like gelatin", "All water within 50 yards does nothing to mitigate thirst",
    ...
    "All water within 50 yards turns to for over the next 1d4 rounds", "All water within 50 yards turns to glass",
    "All water within 50 yards turns to milk", "All water within one mile vanishes",
    ...
    "All weapons within 50 yards are cleaned, polished, and sterilized", "All weapons within 50 yards are edible",
    ...
    "All weapons within 50 yards are sealed in candle wax", "All weapons within 50 yards are stuck in their sheathes",
    ...
    "All weapons within one mile vanish until dawn tomorrow", "All wheeled vehicles within one mile burst into flame",
    "All wheeled vehicles within one mile sink 1d4 feet into the mud", "All wheels within one mile are chrome-plated",
    "All wheels within one mile become perfectly square", "All who saw this casting are 10% likely to be driven insane",
    "All who saw this casting are healed for 1d4 hit points", "All who saw this casting are soaked with cold gravy",
    ...
    "All who saw this casting lose 1d20 points of Wisdom until sunset", "All who saw this casting lose 1d4 hit points",
    ...
    "All who saw this casting undertake a pilgrimage to a distant town", "All within 10 feet are wrapped like mummies",
    "All within 10 feet feel like they've just run a marathon",
    "All within 10 feet must Save or be teleported 1d100 miles", "All within 10 feet point loses 1d100 hit points",
    ...
    "All within 50 miles realize that thieves' cant is fictitious", "All within 50 miles rise up against the king",
    "All within 50 yards acquire a distinctive accent", "All within 50 yards adopt new names and answer only to them",
    "All within 50 yards age 1d12 months", "All within 50 yards and in armor are paralyzed for 2d6 rounds",
    ...
    "All within 50 yards appear to have advanced leprosy", "All within 50 yards appear to have bubonic plague",
    "All within 50 yards are 5% likely to be turned inside out",
    "All within 50 yards are 5% likely to become amphibious",
    "All within 50 yards are 5% likely to die at dawn tomorrow", "All within 50 yards are 5% likely to freeze solid",
    "All within 50 yards are 5% likely to inherit a small keep",
    "All within 50 yards are 5% likely to suffer total amnesia",
    "All within 50 yards are 10% likely to age 1d100 years", "All within 50 yards are 10% likely to be closely related",
    "All within 50 yards are 10% likely to be stricken bald forever",
    "All within 50 yards are 10% likely to wake tomorrow as undead", "All within 50 yards are -2 ToHit for 2d10 rounds",
    ...
    "All within 50 yards are attacked by countless magpies", "All within 50 yards are attacked by locusts",
    ...
    "All within 50 yards are claimed as slaves by the nearest tyrant", "All within 50 yards are considered pariahs",
    "All within 50 yards are covered in creosote", "All within 50 yards are covered in powdered sugar like doughnuts",
    "All within 50 yards are covered with honey and feathers", "All within 50 yards are disarmed",
    "All within 50 yards are discovered to be clones", "All within 50 yards are doused with molasses",
    ...
    "All within 50 yards are drenched with cold, soapy water", "All within 50 yards are drenched with olive oil",
    "All within 50 yards are dressed and painted like clowns",
    "All within 50 yards are dressed in black and have jet-black hair",
    "All within 50 yards are dressed in high quality fur", "All within 50 yards are dressed in illusory formal wear",
    "All within 50 yards are dressed in illusory full plate armor",
    "All within 50 yards are dressed in wildly inappropriate attire", "All within 50 yards are dressed like pirates",
    "All within 50 yards are enraged beyond thought or reason",
    "All within 50 yards are extremely short-tempered for 1d12 hours",
    "All within 50 yards are filthy as though they've never bathed", "All within 50 yards are glazed with yellow ice",
    "All within 50 yards are Held for 6d10 rounds", "All within 50 yards are holding tiny stone carvings of themselves",
    ...
    "All within 50 yards are individually shrouded in fog", "All within 50 yards are invisible for 1d4 rounds",
    "All within 50 yards are invisible to a single person nearby",
    "All within 50 yards are invisible to all others within 50 yards", "All within 50 yards are invisible to birds",
    ...
    "All within 50 yards are now standing in the nearest building", "All within 50 yards are now wearing tap-shoes",
    "All within 50 yards are offered for sale on the open market", "All within 50 yards are overpoweringly thirsty",
    "All within 50 yards are painted with woad", "All within 50 yards are paralyzed by indecision for 1d4 rounds",
    ...
    "All within 50 yards are pushed 1d10 yards from the target point", "All within 50 yards are ravenously hungry",
    "All within 50 yards are restored to full hit points", "All within 50 yards are rumored to be undead",
    "All within 50 yards are rumored to belong to some bizarre cult", "All within 50 yards are showered in maggots",
    "All within 50 yards are smeared with a foul-smelling gelatin", "All within 50 yards are sprayed with skunk musk",
    "All within 50 yards are standing on three-foot cast iron discs", "All within 50 yards are sterile for 2d12 months",
    "All within 50 yards are stricken mute for 1d6 rounds",
    "All within 50 yards are strongly addicted to some kind of poison",
    "All within 50 yards are suddenly arranged in a big circle", "All within 50 yards are suddenly barefoot",
    "All within 50 yards are suddenly extremely drunk", "All within 50 yards are suddenly seated in the lotus position",
    "All within 50 yards are tempted to dabble in cannibalism", "All within 50 yards are thoroughly cleansed",
    ...
    "All within 50 yards are wearing ostrich feathers in their hair", "All within 50 yards are wearing wooden shoes",
    "All within 50 yards become hopelessly lost for 1d4 hours", "All within 50 yards believe that they're dreaming",
    "All within 50 yards can see just fine in normal darkness",
    "All within 50 yards covet the possessions of one person nearby",
    "All within 50 yards crackle with ozone for 6d6 rounds ", "All within 50 yards dance lasciviously for 1d6 rounds",
    ...
    "All within 50 yards find that their clothes are torn and bloody", "All within 50 yards forget everyone's name",
    "All within 50 yards forget how to use weapons or magic until dawn",
    "All within 50 yards gain 1d1000 Experience Points", "All within 50 yards grow 1d4 inches",
    ...
    "All within 50 yards have horrifying visions of future tragedy", "All within 50 yards have just run 1d10 miles",
    "All within 50 yards have the exact same voice", "All within 50 yards laugh like lunatics for 4d6 rounds",
    ...
    "All within 50 yards mount an attack upon the nearest castle", "All within 50 yards move as if they're underwater",
    ...
    "All within 50 yards must Save or be burned for 1d10 hit points", "All within 50 yards must Save or be Slowed",
    ...
    "All within 50 yards must Save or be tightly bound in wire", "All within 50 yards must Save or feel 1d100° colder",
    ...
    "All within 50 yards must Save, or their wounds will never heal", "All within 50 yards now have bright blue hair",
    ...
    "All within 50 yards see illusory animals flitting about the area", "All within 50 yards shrink 1d4 inches",
    "All within 50 yards smell like carrion until sunset tomorrow", "All within 50 yards smell strongly of alcohol",
    "All within 50 yards smell strongly of brimstone until sunrise",
    "All within 50 yards smell strongly of manure for 1d4 days",
    "All within 50 yards suddenly have perfectly groomed hair", "All within 50 yards talk like 1930's movie gangsters",
    "All within 50 yards think that a deity is in their midst",
    "All within 50 yards think that all others nearby are lying",
    "All within 50 yards think that all others nearby are on fire", "All within 50 yards think that fire is edible",
    ...
    "All within 50 yards think they've shrunk by 90%", "All within 50 yards throw their weapons as far as they can",
    "All within 50 yards vanish for 3d10 rounds", "All within 50 yards weep hysterically but can act normally",
    ...
    "All worked stone within 50 yards is now 3d100° colder", "All worked stone within 50 yards is water soluble",
    "All worked stone within 50 yards oozes blood for 1d4 hours",
    "All worked stone within 50 yards returns to its natural state", "All worked stone within 50 yards turns to ice",
    ...
    "All written text within 50 yards hums audibly while being read", "All written text within 50 yards is reversed",
    ...
    "An enormous cache of D-Cell batteries is found nearby", "An enormous castle formed entirely of ice appears nearby",
    "An enormous fishing net settles over a 100 yard radius",
    "An enormous head of sculpted stone bursts from the ground ", "An enormous oak tree appears at the target point",
    ...
    "An ingot of metallic hydrogen appears at the target point", "An ingot of neutronium appears at the target point",
    ...
    "Any blood spilled in this area discolors the ground", "Any charged magical items nearby are fully recharged",
    ...
    "Any charged magical items nearby lose 1d10 charges", "Any exposed rock nearby is polished as smooth as glass",
    ...
    "Any fires now burning within 10 miles provide no heat", "Any fires now burning within 10 miles provide no light",
    ...
    "Any food now in this area tastes strongly of blood", "Any food now within 50 yards induces bacchanalia when eaten",
    "Any food now within 50 yards induces drowsiness when eaten",
    "Any food now within 50 yards induces madness when eaten", "Any food now within 50 yards turns to iron",
    "Any food now within 50 yards will turn to lead when consumed", "Any gold nearby is invisible in sunlight",
    "Any gold within 50 yards liquefies", "Any ice or snow within 10 miles can't melt for 1d12 months",
    "Any ice or snow within 10 miles feels painfully hot to the touch",
    "Any magical protections now in place nearby are negated", "Any magical seals or locks within one mile are negated",
    ...
    "Any magical traps within one mile are triggered", "Any meat eaten nearby in the last 24 hours was human flesh",
    "Any nearby outcroppings of rock burst into flame", "Any nearby water in a container becomes carbonated",
    ...
    "Any pack animals within one mile race away at top speed", "Any priest nearby is 10% likely to think he's his god",
    "Any ranged spells cast nearby are delayed for 3d10 rounds", "Any ranged spells cast nearby have a range of zero",
    ...
    "Any spells currently in effect within 100 yards are negated", "Any standing water within 50 yards boils violently",
    ...
    "Anyone in armor within 10 yards is thrown 1d10 yards", "Anyone in armor within 10 yards loses 1d4 hit points",
    ...
    "Anyone nearby can never be teleported while wearing clothes", "Anyone nearby can never drown while barefoot",
    ...
    "Anyone slain nearby is revealed to be a doppelganger", "Anyone slain nearby issues cryptic prophecy before dying",
    "Anyone slain nearby turns instantly to stone", "Anyone slain nearby turns to coal over 1d4 rounds",
    ...
    "Blinding smoke swirls about the area for 1d4 hours", "Blood sprays from the target point like water from a hose",
    ...
    "Countless sharpened stakes jut from the ground in the area", "Countless slugs and snails litter the ground",
    "Countless small lumps of cheese rain down on the area",
    "Countless tiny carvings of wooden ducks rain down on the area", "Diabolical voices issue from the target point",
    ...
    "Distances in this area are very difficult to judge accurately", "Divination magic is impossible for 1d4 days",
    ...
    "Every tree within one mile has cryptic runes carved in its bark", "Every tree within one mile hums sonorously",
    "Everyone nearby gains a language known only to those in this area", "Everyone within 10 yards is chained together",
    ...
    "Everyone within 50 yards has a 1% chance to become a god", "Everyone within 50 yards has a 2% chance to explode",
    ...
    "Everyone within 50 yards is standing in a small bucket", "Everyone within 50 yards is suddenly exhausted",
    ...
    "Everything with one foot of the target point ceases to exist", "Everything within 5 feet ceases to exist",
    ...
    "Fire belches forth from the target point for 10d10 hours", "Fires in this area are drawn toward the target point",
    ...
    "For 1d4 days, fires lit nearby aren't warm enough to melt ice", "For 1d6 months, all flame in the world is blue",
    ...
    "For one year, spells cast in this area last only one round", "From now on, all within 50 yards are left-handed",
    "From now on, all within 50 yards look as wounded as they are now",
    "Genocidal war breaks out between two or more major races",
    "Gravity is skewed by 45° in this area until sunrise tomorrow", "Gravity within 100 yards has no effect on wood",
    ...
    "Hundreds of highly venomous snakes emerge from the ground", "Hundreds of hungry dogs appear in the vicinity",
    "Hundreds of thousands of acorns fall from the sky", "Hurricane-strength winds swirl around the target point",
    "Ice cold water sprays from the ground beneath the target point",
    "Ice suddenly covers the ground nearby to a depth of 1d6 inches", "Icy mist issues from the target for 1d4 days",
    ...
    "In this region, Dwarves consider clothing to be unnecessary", "In this region, gold is invulnerable to magic",
    "In this region, hail has been falling for 2d4 days", "In this region, it's been snowing for two weeks straight",
    ...
    "Magic users are persecuted throughout this country", "Magical healing is not possible within 10 miles",
    ...
    "Missiles fired nearby all fly toward the same creature", "Missiles fired nearby are 5% likely to induce True Love",
    "Missiles fired nearby can induce paralysis on a successful hit",
    "Missiles fired nearby crash like thunder when they hit", "Missiles fired nearby disintegrate while in flight",
    ...
    "Missiles fired nearby invariably miss their targets", "Missiles fired nearby leave colorful trails of light",
    "Missiles fired nearby travel an additional 1d10 miles", "Moonlight in this area induces extreme covetousness",
    "Moonlight in this area induces extreme melancholy in Elves", "Moonlight in this area induces furious bloodlust",
    "Moonlight in this area induces pain in lycanthropes",
    "Moonlight in this area induces panic in those of INT 14 or above",
    "Moonlight in this area induces unrestrained lecherousness", "Moonlight in this area is blood red",
    "Natural animals in this area can readily detect magic",
    "Natural animals respond badly to anyone now within 50 yards", "Nearest bridge appears in the immediate area",
    "Nearest bridge appears to be a rainbow", "Nearest bridge appears to be made of thick fog",
    "Nearest bridge can't be crossed by anyone wearing footwear",
    "Nearest bridge collapses after the next 1d6 people cross it", "Nearest bridge is as pliant as rubber",
    "Nearest bridge is burned", "Nearest bridge is clear like glass", "Nearest bridge is made of teeth",
    "Nearest bridge is suddenly over troubled waters", "Nearest bridge is takes 2d4 hours to cross",
    "Nearest bridge opens like a drawbridge", "Nearest bridge turns permanently invisible",
    "Nearest building can only be entered by walking backwards",
    "Nearest building is exactly duplicated at the target point", "Nearest door appears at the target point",
    "Nearest door is a jar", "Nearest door is a portal to an ancient temple of a powerful deity",
    "Nearest door opens to a point 1d10 days in the future", "Nearest door opens to a point 1d10 miles in the air",
    "Nearest door opens to the target point", "Nearest doorway can't be traversed by anyone at full hit points ",
    ...
    "Nearest forest acquires malevolent sentience and intelligence", "Nearest forest is set ablaze",
    "Nearest government collapses amid rumors of infernal pacts",
    "Nearest government switches to a manure-based economic system", "Nearest horse becomes bipedal",
    ...
    "Nearest lake contains a sunken armada from some long-lost navy", "Nearest lake contains an ice berg",
    ...
    "Nearest lake heats to 200° over the next 1d4 rounds", "Nearest lake is covered by a tarp",
    "Nearest lake is encircled by a moat of flaming pitch",
    "Nearest lake is home to a colony of unaging amphibious humanoids", "Nearest lake is perpetually fog-shrouded",
    ...
    "Nearest lake undergoes massive tidal surges for one week", "Nearest monastery conceals a gate to hell",
    "Nearest monastery holds the only copies of many priceless books",
    "Nearest monastery often engages in dangerous and abhorrent rites", "Nearest mountain slides 1d10 miles north",
    "Nearest oak tree grows to 20X its current size", "Nearest oak tree is older than the entire world",
    "Nearest oak tree periodically shoots poisonous thorns", "Nearest oak tree turns to bronze",
    "Nearest oak tree turns to solid gold", "Nearest oak tree uproots and goes on a rampage",
    "Nearest priest becomes fearless in the face of death", "Nearest priest believes he's been excommunicated",
    ...
    "Nearest priest is implicated in a scandal involving livestock", "Nearest priest is summoned by his deity",
    ...
    "Nearest river freezes solid over the next 1d10 rounds", "Nearest river is dammed", "Nearest river is damned",
    "Nearest river is discovered to be artificial", "Nearest river is now 1d4X as deep as it was this morning",
    "Nearest river is permanently blood red but is otherwise unchanged",
    "Nearest river now runs directly through the nearest town", "Nearest river now runs directly through this area",
    ...
    "Nearest town descends into weeks of mindless debauchery", "Nearest town erupts into riots and turf wars",
    "Nearest town is actually hidden within a modern wildlife preserve",
    "Nearest town is annexed by a warring neighbor nation", "Nearest town is completely deserted",
    "Nearest town is completely overrun by marauding orcs", "Nearest town is inaccessible by land",
    "Nearest town is populated entirely by a brutal and dangerous cult",
    "Nearest town is populated entirely by anthropomorphic pigs", "Nearest town is populated entirely by illusions",
    "Nearest town is populated entirely by undead", "Nearest town is razed",
    "Nearest town is the site of an ancient magical battle", "Nearest town is totally forgotten by the outside world",
    "Nearest town secedes from the kingdom", "Nearest town signs a secret pact with an invading horde of orcs",
    ...
    "Nearest wizard is exposed as a fraud and a charlatan", "Nearest wizard is unable to cast magic upon himself",
    ...
    "Next person nearby to draw blood never needs to sleep again", "Next person nearby to draw blood shrinks by 8d10%",
    ...
    "Next person nearby to draw blood thinks that on fire", "Next person nearby to draw blood vanishes for 1d4 days",
    ...
    "Next person nearby to say his name goes berserk", "Next person nearby to say his name is attacked by rabbits",
    ...
    "Next person nearby to speak is thrown into a deep well", "Next person nearby to use magic becomes two dimensional",
    ...
    "Next person nearby to use magic is turned to wood", "Next person nearby to use magic is wrapped in a cocoon",
    "Next person nearby to use magic loses the ability to feel pain", "Next person nearby to use magic rises one level",
    ...
    "Next person slain nearby crumbles into a heap of toxic ash", "Next person slain nearby disappears without a trace",
    "Next person slain nearby explodes messily", "Next person slain nearby flies into the air and vanishes",
    ...
    "Next person slain nearby is welcomed into his deity's pantheon", "Next person slain nearby never really existed",
    ...
    "Next person slain nearby was the offspring of a god", "Next person struck by magic nearby thinks he's a toddler",
    ...
    "Next polymorph magic used nearby can't be undone", "Next polymorph magic used nearby completely heals its caster",
    ...
    "Next polymorph magic used nearby lapses after one round", "Next polymorph magic used nearby lasts for 1d100 days",
    ...
    "Next spell cast in this area has a permanent duration", "Next weapon drawn nearby attacks its wielder",
    ...
    "Next weapon drawn nearby causes its wielder to distrust magic", "Next weapon drawn nearby chills to -200°",
    ...
    "Next weapon drawn nearby hurls itself into the sky", "Next weapon drawn nearby ignites and burns like magnesium",
    ...
    "Next weapon nearby to draw blood has been used to murder a king", "Next weapon nearby to draw blood heats to 800°",
    ...
    "No one in the world can die or be slain for 3d8 hours", "No one in the world can sleep for 1d6 days",
    "No one in the world can speak for 10d10 rounds", "No one in the world can tell a lie for the next 24 hours",
    "No one nearby can eat food for 1d8 days", "No one nearby can teleport or be teleported for 1d4 years",
    ...
    "No one within 50 yards can see artificial light sources", "No one within 50 yards can speak until dawn",
    "No one within 50 yards can use rope or the like for 2d4 days",
    "No one within 50 yards can wear armor for 1d6 days", "No one within 50 yards ever again feels hunger",
    "No one within 50 yards has eaten in 3d4 days", "No one within 50 yards has slept in 4d6 days",
    ...
    "No one within 50 yards needs to eat for the next month", "No one within 50 yards trusts anyone else for 1d6 hours",
    "No plants can ever grow again within 50 yards of the target point",
    "No precipitation falls within 10 miles for 4d6 months", "Non-magical gold is toxic to all within 50 yards",
    "Non-sentient animals shun this area forever", "Numerous fires erupt in the nearest town",
    "One magic potion nearby is instantly lethal", "One magic potion nearby will trigger a Chaos Burst when consumed",
    "One random sword nearby is 40% likely to heal instead of wound",
    "One random sword nearby is bent like a horseshoe", "One random sword nearby is duplicated under every full moon",
    "One random sword nearby is permanently blunted", "One random sword nearby is razor-sharp and indestructible",
    "One random sword nearby leaves faint rainbow streaks in the air", "One random sword nearby opens like an umbrella",
    ...
    "One suit of armor nearby heats to 600° the next time it's struck", "One suit of armor nearby is burned to slag",
    ...
    "Scalding steam sprays violently from the spell's target point", "Seawater is highly toxic to all within 50 yards",
    ...
    "Some magic item nearby gives off highly toxic light", "Some major race dies out in the next 2d4 years",
    "Some major race splits into two incompatible sub-species", "Some non-magical animal nearby becomes immortal",
    "Some non-magical animal nearby suddenly has 25 Intelligence", "Someone nearby acquires 10% magic resistance",
    "Someone nearby adopts a new mentor each day", "Someone nearby always thinks that it's raining",
    "Someone nearby attacks nobles on sight", "Someone nearby attracts 2d10 followers who think he's a prophet",
    ...
    "Someone nearby can leap across streams or rivers with ease", "Someone nearby can never sit or lie down again",
    ...
    "Someone nearby can shrink to half his height at will", "Someone nearby can speak only in a whisper ",
    "Someone nearby can subsist on twigs and grasses", "Someone nearby can survive 1d4 beheadings",
    ...
    "Someone nearby can't be harmed by any nonferrous metal", "Someone nearby can't be harmed by smoke",
    "Someone nearby can't be physically harmed by demons",
    "Someone nearby can't be strangled by non-magical rope or cord", "Someone nearby can't move his arms in daylight",
    ...
    "Someone nearby discovers solid proof that no deities really exist", "Someone nearby disgorges 1d6 large housecats",
    "Someone nearby disgorges 1d6 severed hands", "Someone nearby disgorges a tin bucket of hot coals",
    "Someone nearby disgorges himself", "Someone nearby doubles in weight in each of the next 1d8 rounds",
    ...
    "Someone nearby fosters rumors that he's a demigod", "Someone nearby gains 10d100 experience points",
    ...
    "Someone nearby habitually makes utterly improbable boasts", "Someone nearby has a legitimate claim to the throne",
    "Someone nearby has a potion that turns half of his body invisible",
    "Someone nearby has a transcendent religious experience", "Someone nearby has a treasure map carved into his back",
    "Someone nearby has deeply offended the ruling family", "Someone nearby has produced a child with a powerful demon",
    ...
    "Someone nearby is 3% likely to explode whenever he draws a weapon", "Someone nearby is about to go totally insane",
    "Someone nearby is accused of assassinating the king", "Someone nearby is attended by 1d4 skeletal servants",
    "Someone nearby is blamed for looting the nearest magical library",
    "Someone nearby is blamed for some recent magical disaster", "Someone nearby is blown all out of proportion",
    "Someone nearby is bound in red-hot iron chains", "Someone nearby is bound to this area and can never leave it",
    ...
    "Someone nearby is carrying an incredibly virulent plague", "Someone nearby is certain that he's immune to poison",
    "Someone nearby is chained high in the branches of a nearby tree",
    "Someone nearby is completely fireproof for one year", "Someone nearby is completely immune to non-magical poisons",
    ...
    "Someone nearby is crushed as though at the bottom of the ocean", "Someone nearby is discovered to be a spy",
    "Someone nearby is discovered to be dangerously sociopathic",
    "Someone nearby is doomed to die in a horribly embarrassing manner", "Someone nearby is dragged bodily to hell",
    "Someone nearby is dragged into the sea by hideous fish-people", "Someone nearby is drawn and quartered",
    ...
    "Someone nearby is known to have destroyed one hundred dragon eggs", "Someone nearby is peeled like a banana",
    "Someone nearby is possessed by 1d8 demons", "Someone nearby is revealed to be a colony of intelligent insects",
    "Someone nearby is revealed to be many centuries old", "Someone nearby is revealed to be of demonic heritage",
    "Someone nearby is said to be the last prophet of a dying religion",
    "Someone nearby is savaged by vicious, invisible dogs", "Someone nearby is sentenced to be executed for heresy",
    "Someone nearby is sheathed in candle wax", "Someone nearby is stung by 1d1000 bees",
    "Someone nearby is suddenly dressed in provocative leather attire", "Someone nearby is suddenly hideously deformed",
    ...
    "Someone nearby must Save vs Death or his teeth turn to glass", "Someone nearby no longer heals naturally",
    "Someone nearby no longer needs to breathe", "Someone nearby no longer needs to eat",
    "Someone nearby now has a blowhole but no nose", "Someone nearby now has baleen instead of conventional teeth",
    ...
    "Someone nearby refers to some noble as 'Lord of Excrement'",
    ...
    "Someone nearby shrieks in horror until sunrise tomorrow", "Someone nearby shrinks by 1d100%",
    "Someone nearby shrinks by 50% from the waist up", "Someone nearby smells like a corpse in the presence of magic",
    ...
    "Someone nearby sprouts a turtle's shell atop his head", "Someone nearby sprouts hideous, non-functional bat wings",
    ...
    "Someone nearby suddenly has a neck like a giraffe", "Someone nearby suddenly has eight eyes like a spider",
    "Someone nearby suddenly has eight legs", "Someone nearby suddenly has feet like a chicken",
    ...
    "Someone nearby tries to cut himself in half lengthwise", "Someone nearby tries to eat his own hands",
    "Someone nearby tries to kill every cow he sees", "Someone nearby tries to scalp himself",
    ...
    "Someone nearby truly believes that he's a prophesized redeemer", "Someone nearby turns to a heap of gold dust",
    "Someone nearby turns to a heap of moist sand", "Someone nearby turns to salt over the next 1d8 days",
    "Someone nearby turns to stone over the next 5d6 days", "Someone nearby turns to water",
    ...
    "Someone nearby wakes tomorrow in a roc's nest", "Someone nearby wakes tomorrow in the king's torture chamber",
    ...
    "The entire area is a dumping ground for dangerous magical waste", "The entire area is a haven for zombies",
    ...
    "The entire area is claimed as a sacred goblin burial ground", "The entire area is dark as midnight for 1d4 weeks",
    ...
    "The entire area is located over the lair of an enormous dragon", "The entire area is mirror-reversed",
    ...
    "The entire area suffers an intense blizzard for 2d6 rounds", "The entire area swirls with fine white powder",
    ...
    "The entire planet experiences full daylight for 5d10+24 hours", "The gates of hell open for 4d6 hours ",
    ...
    "The ground nearby harbors enormous, carnivorous earthworms", "The ground nearby is highly susceptible to erosion",
    "The ground nearby splits open to a depth of 1d10 miles",
    "The ground within 50 yards has never been trod by a human foot",
    "The ground within 50 yards heaves like a bubble on a pond", "The ground within 50 yards is carpeted",
    "The ground within 50 yards is covered by terra cotta tile",
    "The ground within 50 yards is found to be completely artificial",
    "The ground within 50 yards is incredibly sticky", "The ground within 50 yards is now perfectly smooth steel",
    ...
    "The high priest of some deity appears at the target point", "The largest creature nearby doubles in size",
    "The largest creature nearby turns invisible for 4d6 hours",
    "The moon appears to blaze with cool blue fire for 1d12 months", "The moon came into existence only 1d4 days ago",
    "The moon doubles in size", "The moon explodes", "The moon has a huge bite taken out of it",
    "The moon has a large hole all the way through it", "The moon is full every night for the next year",
    "The moon is no moon; it's a space station", "The moon is now a cube", "The moon is now geostationary",
    "The moon is now solid gold except for a thin cover of dust", "The moon moves 50% closer to the Earth",
    "The moon resembles the face of someone nearby", "The moon revolves around the planet at 1d4X its current rate",
    "The moon suddenly holds untold riches and unimaginable dangers", "The moon vanishes for 1d12 months",
    "The moon whirls wildly through the sky for 7d4 days", "The most powerful wizard nearby vanishes for 3d8 hours",
    ...
    "The most valuable sword within 50 yards turns to mercury", "The nearest town's entire population appears nearby",
    "The nearest town's entire population is linked into a hive-mind", "The past 1d10 rounds were only an illusion",
    "The Philosopher's Stone appears at the target point", "The planet breaks loose from the Sun's gravity",
    "The planet no longer rotates", "The planet now has a ring around it", "The planet now rotates half as fast",
    "The planet now rotates in the opposite direction", "The planet now rotates north-to-south",
    "The planet now rotates twice as fast", "The planet splits into two stable hemispheres 10 yards apart",
    "The planet tumbles into another ice age", "The planet's atmosphere leaks into space over the next 1d6 months",
    "The planet's average temperature rises 1° per week for 4d6 weeks",
    "The planet's hemispheres rotate at slightly different rates", "The planet's oceans are becalmed",
    "The planet's orbital radius shrinks by 1d8 x 10,000 miles", "The royal family appears in the vicinity",
    ...
    "The sky appears to be ablaze as far as the eye can see", "The sky appears to teem with a vast host of angels",
    "The sky overhead swirls with dark colors for 1d4 turns",
    "The sky whirls with dazzling colors until sunset tomorrow", "The sound of hundreds of barking dogs fills the air",
    "The sound of mighty winds fills the air, but the air is calm",
    "The spell discharges randomly in each of the next 4d4 rounds",
    "The spell discharges upon the next person nearby to draw blood", "The sun appears pale blue from now on",
    "The sun splits into a stable binary pair", "The Burst is delayed until blood is drawn nearby; roll for effect",
    ...
    "The tallest person in the area develops an acute fear of heights", "The tallest person in the area grows by 50%",
    "The tallest person in the area is attacked by beavers", "The tallest person in the area shrinks by 50%",
    "The tallest tree nearby burns to the ground in 1d4 rounds", "The target point acquires intelligence and free will",
    "The target point becomes a window for seeing into other worlds",
    "The target point becomes an open gateway to hell", "The target point is a conduit to interstellar space",
    "The target point is a tiny gateway to some distant world", "The target point is direct conduit to Elemental Air",
    "The target point is encircled by bright red plastic cones", "The target point is intensely magnetic for 4d6 hours",
    "The target point is rumored to be a site of healing", "The target point is sealed in a 10 foot globe of force",
    "The target point is the center of a zone of anti-magic",
    "The target point is the site of some powerful deity's murder",
    "The target point makes a noise like an air raid siren", "The target point radiates intense cold for 4d6 hours",
    "The target point radiates intense heat for 4d6 hours", "The target point scrambles any effort to teleport near it",
    ...
    "Thousands of carpenter's nails fall from the sky", "Thousands of teeth rain down from the sky",
    "Thousands of tiny glass ovoids fall from the sky", "Time no longer passes within 1d4 yards of the target point",
    "Time passes 10X as fast within 1d4 yards of the target point",
    "Tomorrow's high tide crests at the spell's target point",
    "Townspeople nearby are easily cowed by a charismatic speaker", "Triumphant fanfare fills the air for 1d6 turns",
    "Undead lobby the local ruler for legislative representation", "Very salty rain falls for 1d4 hours",
    ...
    "Water consumed in this area tastes like the finest wine", "Water consumed in this area tastes strongly of manure",
    "Water flows from the target point to fill a 100-yard hemisphere", "Water in this area boils at 70° Fahrenheit",
    "Water in this area freezes at 70° Fahrenheit", "Weather in this area changes drastically each hour for one week",
